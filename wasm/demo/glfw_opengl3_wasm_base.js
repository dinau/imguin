...
// include: C:\Users\mimi\AppData\Local\Temp\tmpowmwxw4y.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'glfw_opengl3_wasm_base.data';
      var REMOTE_PACKAGE_BASE = 'glfw_opengl3_wasm_base.data';
...
Module['FS_createPath']("/utils", "fonticon", true, true);
Module['FS_createPath']("/utils/fonticon", "fa6", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_glfw_opengl3_wasm_base.data');
      }
      Module['addRunDependency']('datafile_glfw_opengl3_wasm_base.data');
...
function findWasmBinary() {
  return locateFile('glfw_opengl3_wasm_base.wasm');
}
