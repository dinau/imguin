...
type
  enum_ImGuiTreeNodeFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_TreeNodeFlags_NavLeftJumpsToParent = 131072,
    ImGui_TreeNodeFlags_DrawLinesNone = 262144,
    ImGui_TreeNodeFlags_DrawLinesFull = 524288,
...
type
  enum_ImGuiTabBarFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_TabBarFlags_FittingPolicyMixed = 128,
    ImGui_TabBarFlags_FittingPolicyShrink = 256,
    ImGui_TabBarFlags_FittingPolicyScroll = 512,
    ImGui_TabBarFlags_FittingPolicyMask_private = 896
const
  ImGuiTabBarFlags_FittingPolicyDefault_private* = enum_ImGuiTabBarFlags_private.ImGuiTabBarFlags_FittingPolicyMixed
type
...
type
  enum_ImGuiKey* {.size: sizeof(cuint).} = enum
    ImGui_Key_None = 0, ImGui_Key_NamedKey_COUNT = 155,
    ...
    ImGui_Key_AppForward = 630, ImGui_Key_Oem102 = 631,
    ImGui_Key_GamepadStart = 632, ImGui_Key_GamepadBack = 633,
    ImGui_Key_GamepadFaceLeft = 634, ImGui_Key_GamepadFaceRight = 635,
    ImGui_Key_GamepadFaceUp = 636, ImGui_Key_GamepadFaceDown = 637,
    ImGui_Key_GamepadDpadLeft = 638, ImGui_Key_GamepadDpadRight = 639,
    ImGui_Key_GamepadDpadUp = 640, ImGui_Key_GamepadDpadDown = 641,
    ImGui_Key_GamepadL1 = 642, ImGui_Key_GamepadR1 = 643,
    ImGui_Key_GamepadL2 = 644, ImGui_Key_GamepadR2 = 645,
    ImGui_Key_GamepadL3 = 646, ImGui_Key_GamepadR3 = 647,
    ImGui_Key_GamepadLStickLeft = 648, ImGui_Key_GamepadLStickRight = 649,
    ImGui_Key_GamepadLStickUp = 650, ImGui_Key_GamepadLStickDown = 651,
    ImGui_Key_GamepadRStickLeft = 652, ImGui_Key_GamepadRStickRight = 653,
    ImGui_Key_GamepadRStickUp = 654, ImGui_Key_GamepadRStickDown = 655,
    ImGui_Key_MouseLeft = 656, ImGui_Key_MouseRight = 657,
    ImGui_Key_MouseMiddle = 658, ImGui_Key_MouseX1 = 659, ImGui_Key_MouseX2 = 660,
    ImGui_Key_MouseWheelX = 661, ImGui_Key_MouseWheelY = 662,
    ImGui_Key_ReservedForModCtrl = 663, ImGui_Key_ReservedForModShift = 664,
    ImGui_Key_ReservedForModAlt = 665, ImGui_Key_ReservedForModSuper = 666,
    ImGui_Key_NamedKey_END = 667, ImGui_Mod_Ctrl = 4096, ImGui_Mod_Shift = 8192,
    ImGui_Mod_Alt = 16384, ImGui_Mod_Super = 32768, ImGui_Mod_Mask_private = 61440
const
...
type
  enum_ImGuiConfigFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_ConfigFlags_ViewportsEnable = 1024, ImGui_ConfigFlags_IsSRGB = 1048576,
    ImGui_ConfigFlags_IsTouchScreen = 2097152
type
...
type
  enum_ImGuiCol_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_Col_CheckMark = 18, ImGui_Col_CheckboxSelectedBg = 19,
    ImGui_Col_SliderGrab = 20, ImGui_Col_SliderGrabActive = 21,
    ImGui_Col_Button = 22, ImGui_Col_ButtonHovered = 23,
    ImGui_Col_ButtonActive = 24, ImGui_Col_Header = 25,
    ImGui_Col_HeaderHovered = 26, ImGui_Col_HeaderActive = 27,
    ImGui_Col_Separator = 28, ImGui_Col_SeparatorHovered = 29,
    ImGui_Col_SeparatorActive = 30, ImGui_Col_ResizeGrip = 31,
    ImGui_Col_ResizeGripHovered = 32, ImGui_Col_ResizeGripActive = 33,
    ImGui_Col_InputTextCursor = 34, ImGui_Col_TabHovered = 35, ImGui_Col_Tab = 36,
    ImGui_Col_TabSelected = 37, ImGui_Col_TabSelectedOverline = 38,
    ImGui_Col_TabDimmed = 39, ImGui_Col_TabDimmedSelected = 40,
    ImGui_Col_TabDimmedSelectedOverline = 41, ImGui_Col_DockingPreview = 42,
    ImGui_Col_DockingEmptyBg = 43, ImGui_Col_PlotLines = 44,
    ImGui_Col_PlotLinesHovered = 45, ImGui_Col_PlotHistogram = 46,
    ImGui_Col_PlotHistogramHovered = 47, ImGui_Col_TableHeaderBg = 48,
    ImGui_Col_TableBorderStrong = 49, ImGui_Col_TableBorderLight = 50,
    ImGui_Col_TableRowBg = 51, ImGui_Col_TableRowBgAlt = 52,
    ImGui_Col_TextLink = 53, ImGui_Col_TextSelectedBg = 54,
    ImGui_Col_TreeLines = 55, ImGui_Col_DragDropTarget = 56,
    ImGui_Col_DragDropTargetBg = 57, ImGui_Col_UnsavedMarker = 58,
    ImGui_Col_NavCursor = 59, ImGui_Col_NavWindowingHighlight = 60,
    ImGui_Col_NavWindowingDimBg = 61, ImGui_Col_ModalWindowDimBg = 62,
    ImGui_Col_COUNT = 63
type
...
type
  enum_ImGuiButtonFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_ButtonFlags_EnableNav = 8, ImGui_ButtonFlags_AllowOverlap = 4096
type
...
type
  enum_ImGuiMouseCursor_private* {.size: sizeof(cint).} = enum
    ...
    ImGui_MouseCursor_Hand = 7, ImGui_MouseCursor_Wait = 8,
    ImGui_MouseCursor_Progress = 9, ImGui_MouseCursor_NotAllowed = 10,
    ImGui_MouseCursor_COUNT = 11
type
...
type
  enum_ImGuiMultiSelectFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_MultiSelectFlags_SelectOnAuto = 8192,
    ImGui_MultiSelectFlags_SelectOnClickAlways = 16384,
...
type
  enum_ImDrawFlags_private* {.size: sizeof(cint).} = enum
    ImDrawFlags_InvalidMask_private = -2147483633, ImDrawFlags_None = 0,
    ...
    ImDrawFlags_RoundCornersMask_private = 496, ImDrawFlags_Closed = 512
const
...
type
  enum_ImTextureStatus* {.size: sizeof(cuint).} = enum
    ImTextureStatus_OK = 0, ImTextureStatus_Destroyed = 1,
    ImTextureStatus_WantCreate = 2, ImTextureStatus_WantUpdates = 3,
...
type
  enum_ImFontFlags_private* {.size: sizeof(cuint).} = enum
    ImFontFlags_None = 0, ImFontFlags_NoLoadError = 2,
    ImFontFlags_NoLoadGlyphs = 4, ImFontFlags_LockBakedSizes = 8,
...
type
  enum_ImGuiItemFlagsPrivate_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_ItemFlags_NoMarkEdited = 65536, ImGui_ItemFlags_NoFocus = 131072,
    ImGui_ItemFlags_Inputable = 1048576,
...
type
  enum_ImGuiItemStatusFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_ItemStatusFlags_EditedInternal = 2048
type
...
type
  enum_ImGuiInputTextFlagsPrivate_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_InputTextFlags_TempInput = 134217728,
...
type
  enum_ImGuiButtonFlagsPrivate_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_ButtonFlags_NoFocus = 4194304
const
...
type
  enum_ImGuiTreeNodeFlagsPrivate_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_TreeNodeFlags_DrawLinesMask_private = 1835008,
    ImGui_TreeNodeFlags_NoNavFocus = 134217728,
...
type
  enum_ImGuiNextWindowDataFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImGui_NextWindowDataFlags_HasWindowFlags = 256,
    ImGui_NextWindowDataFlags_HasChildFlags = 512,
    ImGui_NextWindowDataFlags_HasRefreshPolicy = 1024,
    ImGui_NextWindowDataFlags_HasViewport = 2048,
    ImGui_NextWindowDataFlags_HasDock = 4096,
    ImGui_NextWindowDataFlags_HasWindowClass = 8192
type
...
type
  enum_ImPlot3DTriangleFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImPlot3DTriangleFlags_NoFit = 2, ImPlot3DTriangleFlags_NoLines = 1024,
    ImPlot3DTriangleFlags_NoFill = 2048, ImPlot3DTriangleFlags_NoMarkers = 4096
type
  enum_ImPlot3DQuadFlags_private* {.size: sizeof(cuint).} = enum
    ImPlot3DQuadFlags_None = 0, ImPlot3DQuadFlags_NoLegend = 1,
    ImPlot3DQuadFlags_NoFit = 2, ImPlot3DQuadFlags_NoLines = 1024,
    ImPlot3DQuadFlags_NoFill = 2048, ImPlot3DQuadFlags_NoMarkers = 4096
type
  enum_ImPlot3DSurfaceFlags_private* {.size: sizeof(cuint).} = enum
    ImPlot3DSurfaceFlags_None = 0, ImPlot3DSurfaceFlags_NoLegend = 1,
    ImPlot3DSurfaceFlags_NoFit = 2, ImPlot3DSurfaceFlags_NoLines = 1024,
    ImPlot3DSurfaceFlags_NoFill = 2048, ImPlot3DSurfaceFlags_NoMarkers = 4096
type
  enum_ImPlot3DMeshFlags_private* {.size: sizeof(cuint).} = enum
    ImPlot3DMeshFlags_None = 0, ImPlot3DMeshFlags_NoLegend = 1,
    ImPlot3DMeshFlags_NoFit = 2, ImPlot3DMeshFlags_NoLines = 1024,
    ImPlot3DMeshFlags_NoFill = 2048, ImPlot3DMeshFlags_NoMarkers = 4096
type
  enum_ImPlot3DImageFlags_private* {.size: sizeof(cuint).} = enum
...
type
  enum_ImPlot3DAxisFlags_private* {.size: sizeof(cuint).} = enum
    ...
    ImPlot3DAxisFlags_Invert = 128, ImPlot3DAxisFlags_PanStretch = 256
type
...
type
  enum_Scroll* {.size: sizeof(cuint).} = enum
    alignTop = 0, alignMiddle = 1, alignBottom = 2
type
...
type
  enum_MODE* {.size: sizeof(cuint).} = enum
    LOCAL = 0, WORLD = 1
type
  enum_MOVETYPE* {.size: sizeof(cuint).} = enum
    MT_NONE = 0, MT_MOVE_X = 1, MT_MOVE_Y = 2, MT_MOVE_Z = 3, MT_MOVE_YZ = 4,
    MT_MOVE_ZX = 5, MT_MOVE_XY = 6, MT_MOVE_SCREEN = 7, MT_ROTATE_X = 8,
    MT_ROTATE_Y = 9, MT_ROTATE_Z = 10, MT_ROTATE_SCREEN = 11, MT_SCALE_X = 12,
    MT_SCALE_Y = 13, MT_SCALE_Z = 14, MT_SCALE_XYZ = 15
type
  enum_COLOR_enum* {.size: sizeof(cuint).} = enum
...
type
  struct_Change* = object
type
  struct_ImNodesContext* = object
type
  struct_AutoCompleteState* = object
type
  CIMGUI_API* = object
type
...
type
  ...
  struct_ImDrawList* {.pure, inheritable, bycopy.} = object
    ...
    internal_TextureStack*: ImVector_ImTextureRef
  ...
  struct_ImFontAtlas* {.pure, inheritable, bycopy.} = object
    ...
    RefCount*: cint
    OwnerContext*: ptr ImGuiContext
  ImFontAtlasBuilder* = struct_ImFontAtlasBuilder
  struct_ImFontAtlasBuilder* {.pure, inheritable, bycopy.} = object
  ...
  ImFontAtlasRect* = struct_ImFontAtlasRect
  struct_ImFontAtlasRect* {.pure, inheritable, bycopy.} = object
    x*: cushort
    y*: cushort
    w*: cushort
    h*: cushort
  ...
  struct_ImFontBaked* {.pure, inheritable, bycopy.} = object
    ...
    Ascent*: cfloat
    Descent*: cfloat
    MetricsTotalSurface* {.bitsize: 26'i64.}: cuint
    WantDestroy* {.bitsize: 1'i64.}: cuint
    LoadNoFallback* {.bitsize: 1'i64.}: cuint
  ...
  struct_ImFontGlyph* {.pure, inheritable, bycopy.} = object
    ...
    SourceIdx* {.bitsize: 4'i64.}: cuint
    Codepoint* {.bitsize: 26'i64.}: cuint
    AdvanceX*: cfloat
    X0*: cfloat
    Y0*: cfloat
    X1*: cfloat
  ...
  ImFontLoader* = struct_ImFontLoader
  struct_ImFontLoader* {.pure, inheritable, bycopy.} = object
    Name*: cstring
    LoaderInit*: proc (a0: ptr ImFontAtlas): bool {.cdecl.}
    LoaderShutdown*: proc (a0: ptr ImFontAtlas): void {.cdecl.}
    FontSrcInit*: proc (a0: ptr ImFontAtlas; a1: ptr ImFontConfig): bool {.cdecl.}
    FontSrcDestroy*: proc (a0: ptr ImFontAtlas; a1: ptr ImFontConfig): void {.cdecl.}
    FontSrcContainsGlyph*: proc (a0: ptr ImFontAtlas; a1: ptr ImFontConfig; a2: ImWchar): bool {.cdecl.}
    FontBakedInit*: proc (a0: ptr ImFontAtlas; a1: ptr ImFontConfig; a2: ptr ImFontBaked; a3: pointer): bool {.cdecl.}
    FontBakedDestroy*: proc (a0: ptr ImFontAtlas; a1: ptr ImFontConfig; a2: ptr ImFontBaked; a3: pointer): void {.cdecl.}
    FontBakedLoadGlyph*: proc (a0: ptr ImFontAtlas; a1: ptr ImFontConfig; a2: ptr ImFontBaked; a3: pointer; a4: ImWchar; a5: ptr ImFontGlyph; a6: ptr cfloat): bool {.cdecl.}
    FontBakedSrcLoaderDataSize*: csize_t
  ImTextureData* = struct_ImTextureData
  struct_ImTextureData* {.pure, inheritable, bycopy.} = object
    UniqueID*: cint
  ...
  ImTextureRect* = struct_ImTextureRect
  struct_ImTextureRect* {.pure, inheritable, bycopy.} = object
    x*: cushort
    y*: cushort
    w*: cushort
    h*: cushort
  ...
  struct_ImGuiContext* {.pure, inheritable, bycopy.} = object
    ...
    KeysOwnerData*: array[155'i64, ImGuiKeyOwnerData]
  ...
  struct_ImGuiPlatformIO* {.pure, inheritable, bycopy.} = object
    ...
    Platform_SetClipboardTextFn*: proc (a0: ptr ImGuiContext; a1: cstring): void {.cdecl.}
    Platform_ClipboardUserData*: pointer
    Platform_OpenInShellFn*: proc (a0: ptr ImGuiContext; a1: cstring): bool {.cdecl.}
    ...
    Platform_SetWindowTitle*: proc (a0: ptr ImGuiViewport; a1: cstring): void {.cdecl.}
    Platform_SetWindowAlpha*: proc (a0: ptr ImGuiViewport; a1: cfloat): void {.cdecl.}
    Platform_UpdateWindow*: proc (a0: ptr ImGuiViewport): void {.cdecl.}
    Platform_RenderWindow*: proc (a0: ptr ImGuiViewport; a1: pointer): void {.cdecl.}
  ...
  struct_ImGuiSelectionBasicStorage* {.pure, inheritable, bycopy.} = object
    ...
    PreserveOrder*: bool
    UserData*: pointer
    AdapterIndexToStorageId*: proc (a0: ptr ImGuiSelectionBasicStorage; a1: cint): ImGuiID {.cdecl.}
  ...
  struct_ImGuiSelectionExternalStorage* {.pure, inheritable, bycopy.} = object
    UserData*: pointer
    AdapterSetItemSelected*: proc (a0: ptr ImGuiSelectionExternalStorage; a1: cint; a2: bool): void {.cdecl.}
  ...
  struct_ImGuiStyle* {.pure, inheritable, bycopy.} = object
    ...
    TabMinWidthBase*: cfloat
    TabMinWidthShrink*: cfloat
    ...
    internal_MainScale*: cfloat
    internal_NextFrameFontSizeBase*: cfloat
  ...
  ImFontAtlasPostProcessData* = struct_ImFontAtlasPostProcessData
  struct_ImFontAtlasPostProcessData* {.pure, inheritable, bycopy.} = object
    FontAtlas*: ptr ImFontAtlas
    Font*: ptr ImFont
  ...
  struct_ImGuiBoxSelectState* {.pure, inheritable, bycopy.} = object
    ...
    UnclipMode*: bool
    UnclipRect*: ImRect_c
    UnclipRects*: array[2'i64, ImRect_c]
  ...
  struct_ImGuiSettingsHandler* {.pure, inheritable, bycopy.} = object
    TypeName*: cstring
    TypeHash*: ImGuiID
    ClearAllFn*: proc (a0: ptr ImGuiContext; a1: ptr ImGuiSettingsHandler): void {.cdecl.}
    ReadInitFn*: proc (a0: ptr ImGuiContext; a1: ptr ImGuiSettingsHandler): void {.cdecl.}
    ReadOpenFn*: proc (a0: ptr ImGuiContext; a1: ptr ImGuiSettingsHandler; a2: cstring): pointer {.cdecl.}
    ReadLineFn*: proc (a0: ptr ImGuiContext; a1: ptr ImGuiSettingsHandler; a2: pointer; a3: cstring): void {.cdecl.}
    ApplyAllFn*: proc (a0: ptr ImGuiContext; a1: ptr ImGuiSettingsHandler): void {.cdecl.}
    WriteAllFn*: proc (a0: ptr ImGuiContext; a1: ptr ImGuiSettingsHandler; a2: ptr ImGuiTextBuffer): void {.cdecl.}
    UserData*: pointer
  ...
  ImGuiStyleVarInfo* = struct_ImGuiStyleVarInfo
  struct_ImGuiStyleVarInfo* {.pure, inheritable, bycopy.} = object
    Count* {.bitsize: 8'i64.}: ImU32
    DataType* {.bitsize: 8'i64.}: ImGuiDataType
    Offset* {.bitsize: 16'i64.}: ImU32
  ...
  struct_ImGuiTable* {.pure, inheritable, bycopy.} = object
    ...
    LastHeldHeaderColumn*: ImGuiTableColumnIdx
  ...
  ImGuiInputTextCallback* = proc (a0: ptr ImGuiInputTextCallbackData): cint {.cdecl.}
  ...
  struct_ImVector_ImTextureDataPtr* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ptr ImTextureData
  ImVector_ImTextureDataPtr* = struct_ImVector_ImTextureDataPtr
  ImTextureFormat* = enum_ImTextureFormat
  ImTextureStatus* = enum_ImTextureStatus
  struct_ImVector_ImTextureRect* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ImTextureRect
  ImVector_ImTextureRect* = struct_ImVector_ImTextureRect
  struct_ImVector_ImU32* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ImU32
  ImVector_ImU32* = struct_ImVector_ImU32
  ImFontAtlasRectId* = cint
  ...
  struct_ImVector_ImDrawListSharedDataPtr* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ptr ImDrawListSharedData
  ImVector_ImDrawListSharedDataPtr* = struct_ImVector_ImDrawListSharedDataPtr
  ...
  ImFontFlags_private* = enum_ImFontFlags_private
  struct_ImVector_ImFontConfigPtr* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ptr ImFontConfig
  ImVector_ImFontConfigPtr* = struct_ImVector_ImFontConfigPtr
  ...
  ImFontStackData* = struct_ImFontStackData
  struct_ImFontStackData* {.pure, inheritable, bycopy.} = object
    Font*: ptr ImFont
  ...
  struct_ImGuiKeyRoutingTable* {.pure, inheritable, bycopy.} = object
    Index*: array[155'i64, ImGuiKeyRoutingIndex]
  ...
  struct_ImGuiViewportP* {.pure, inheritable, bycopy.} = object
    ...
    BgFgDrawListsLastTimeActive*: array[2'i64, cfloat]
  ...
  ImGuiDemoMarkerCallback* = proc (a0: cstring; a1: cint; a2: cstring): void {.cdecl.}
  struct_ImVector_ImFontAtlasPtr* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ptr ImFontAtlas
  ImVector_ImFontAtlasPtr* = struct_ImVector_ImFontAtlasPtr
  ...
  struct_ImVector_ImFontStackData* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ImFontStackData
  ImVector_ImFontStackData* = struct_ImVector_ImFontStackData
  ...
  struct_stbrp_context_opaque* {.pure, inheritable, bycopy.} = object
    data*: array[80'i64, cschar]
  struct_ImVector_stbrp_node_im* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr stbrp_node_im
  ImVector_stbrp_node_im* = struct_ImVector_stbrp_node_im
  struct_ImVector_ImFontAtlasRectEntry* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ImFontAtlasRectEntry
  ImVector_ImFontAtlasRectEntry* = struct_ImVector_ImFontAtlasRectEntry
  struct_ImVector_ImFontBakedPtr* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
    Data*: ptr ptr ImFontBaked
  ImVector_ImFontBakedPtr* = struct_ImVector_ImFontBakedPtr
  struct_ImStableVector_ImFontBaked_32* {.pure, inheritable, bycopy.} = object
    Size*: cint
    Capacity*: cint
...
proc ImVec2_ImVec2_Float*(internal_x: cfloat; internal_y: cfloat): ptr ImVec2 {.cdecl, importc: "ImVec2_ImVec2_Float".}
...
proc ImVec4_ImVec4_Float*(internal_x: cfloat; internal_y: cfloat; internal_z: cfloat; internal_w: cfloat): ptr ImVec4 {.cdecl, importc: "ImVec4_ImVec4_Float".}
proc ImTextureRef_ImTextureRef_Nil*(): ptr ImTextureRef {.cdecl, importc: "ImTextureRef_ImTextureRef_Nil".}
proc ImTextureRef_destroy*(self: ptr ImTextureRef): void {.cdecl, importc: "ImTextureRef_destroy".}
proc ImTextureRef_ImTextureRef_TextureID*(tex_id: ImTextureID): ptr ImTextureRef {.cdecl, importc: "ImTextureRef_ImTextureRef_TextureID".}
proc ImTextureRef_GetTexID*(self: ptr ImTextureRef): ImTextureID {.cdecl, importc: "ImTextureRef_GetTexID".}
proc igCreateContext*(shared_font_atlas: ptr ImFontAtlas): ptr ImGuiContext {.cdecl, importc: "igCreateContext".}
proc igDestroyContext*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igDestroyContext".}
proc igGetCurrentContext*(): ptr ImGuiContext {.cdecl, importc: "igGetCurrentContext".}
proc igSetCurrentContext*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igSetCurrentContext".}
proc igGetIO_Nil*(): ptr ImGuiIO {.cdecl, importc: "igGetIO_Nil".}
proc igGetPlatformIO_Nil*(): ptr ImGuiPlatformIO {.cdecl, importc: "igGetPlatformIO_Nil".}
...
proc igShowDemoWindow*(p_open: ptr bool): void {.cdecl, importc: "igShowDemoWindow".}
proc igShowMetricsWindow*(p_open: ptr bool): void {.cdecl, importc: "igShowMetricsWindow".}
proc igShowDebugLogWindow*(p_open: ptr bool): void {.cdecl, importc: "igShowDebugLogWindow".}
proc igShowIDStackToolWindow*(p_open: ptr bool): void {.cdecl, importc: "igShowIDStackToolWindow".}
proc igShowAboutWindow*(p_open: ptr bool): void {.cdecl, importc: "igShowAboutWindow".}
proc igShowStyleEditor*(ref_arg: ptr ImGuiStyle): void {.cdecl, importc: "igShowStyleEditor".}
proc igShowStyleSelector*(label: cstring): bool {.cdecl, importc: "igShowStyleSelector".}
proc igShowFontSelector*(label: cstring): void {.cdecl, importc: "igShowFontSelector".}
proc igShowUserGuide*(): void {.cdecl, importc: "igShowUserGuide".}
proc igGetVersion*(): cstring {.cdecl, importc: "igGetVersion".}
proc igStyleColorsDark*(dst: ptr ImGuiStyle): void {.cdecl, importc: "igStyleColorsDark".}
proc igStyleColorsLight*(dst: ptr ImGuiStyle): void {.cdecl, importc: "igStyleColorsLight".}
...
proc igIsWindowFocused*(flags: ImGuiFocusedFlags): bool {.cdecl, importc: "igIsWindowFocused".}
...
proc igSetScrollX_Float*(scroll_x: cfloat): void {.cdecl, importc: "igSetScrollX_Float".}
proc igSetScrollY_Float*(scroll_y: cfloat): void {.cdecl, importc: "igSetScrollY_Float".}
proc igGetScrollMaxX*(): cfloat {.cdecl, importc: "igGetScrollMaxX".}
proc igGetScrollMaxY*(): cfloat {.cdecl, importc: "igGetScrollMaxY".}
proc igSetScrollHereX*(center_x_ratio: cfloat): void {.cdecl, importc: "igSetScrollHereX".}
proc igSetScrollHereY*(center_y_ratio: cfloat): void {.cdecl, importc: "igSetScrollHereY".}
proc igSetScrollFromPosX_Float*(local_x: cfloat; center_x_ratio: cfloat): void {.cdecl, importc: "igSetScrollFromPosX_Float".}
proc igSetScrollFromPosY_Float*(local_y: cfloat; center_y_ratio: cfloat): void {.cdecl, importc: "igSetScrollFromPosY_Float".}
proc igPushFont*(font: ptr ImFont; font_size_base_unscaled: cfloat): void {.cdecl, importc: "igPushFont".}
...
proc igPushItemFlag*(option: ImGuiItemFlags; enabled: bool): void {.cdecl, importc: "igPushItemFlag".}
proc igPopItemFlag*(): void {.cdecl, importc: "igPopItemFlag".}
proc igPushItemWidth*(item_width: cfloat): void {.cdecl, importc: "igPushItemWidth".}
proc igPopItemWidth*(): void {.cdecl, importc: "igPopItemWidth".}
proc igSetNextItemWidth*(item_width: cfloat): void {.cdecl, importc: "igSetNextItemWidth".}
...
proc igAlignTextToFramePadding*(): void {.cdecl, importc: "igAlignTextToFramePadding".}
proc igGetTextLineHeight*(): cfloat {.cdecl, importc: "igGetTextLineHeight".}
proc igGetTextLineHeightWithSpacing*(): cfloat {.cdecl, importc: "igGetTextLineHeightWithSpacing".}
proc igGetFrameHeight*(): cfloat {.cdecl, importc: "igGetFrameHeight".}
proc igGetFrameHeightWithSpacing*(): cfloat {.cdecl, importc: "igGetFrameHeightWithSpacing".}
proc igPushID_Str*(str_id: cstring): void {.cdecl, importc: "igPushID_Str".}
proc igPushID_StrStr*(str_id_begin: cstring; str_id_end: cstring): void {.cdecl, importc: "igPushID_StrStr".}
...
proc igGetID_StrStr*(str_id_begin: cstring; str_id_end: cstring): ImGuiID {.cdecl, importc: "igGetID_StrStr".}
...
proc igTextWrappedV*(fmt: cstring): void {.cdecl, varargs, importc: "igTextWrappedV".}
proc igLabelText*(label: cstring; fmt: cstring): void {.cdecl, varargs, importc: "igLabelText".}
proc igLabelTextV*(label: cstring; fmt: cstring): void {.cdecl, varargs, importc: "igLabelTextV".}
...
proc igCombo_Str*(label: cstring; current_item: ptr cint; items_separated_by_zeros: cstring; popup_max_height_in_items: cint): bool {.cdecl, importc: "igCombo_Str".}
proc igCombo_FnStrPtr*(label: cstring; current_item: ptr cint; getter: proc (a0: pointer; a1: cint): cstring {.cdecl.}; user_data: pointer; items_count: cint; popup_max_height_in_items: cint): bool {.cdecl, importc: "igCombo_FnStrPtr".}
proc igDragFloat*(label: cstring; v: ptr cfloat; v_speed: cfloat; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragFloat".}
proc igDragFloat2*(label: cstring; v: array[2'i64, cfloat]; v_speed: cfloat; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragFloat2".}
proc igDragFloat3*(label: cstring; v: array[3'i64, cfloat]; v_speed: cfloat; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragFloat3".}
proc igDragFloat4*(label: cstring; v: array[4'i64, cfloat]; v_speed: cfloat; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragFloat4".}
proc igDragFloatRange2*(label: cstring; v_current_min: ptr cfloat; v_current_max: ptr cfloat; v_speed: cfloat; v_min: cfloat; v_max: cfloat; format: cstring; format_max: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragFloatRange2".}
proc igDragInt*(label: cstring; v: ptr cint; v_speed: cfloat; v_min: cint; v_max: cint; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragInt".}
proc igDragInt2*(label: cstring; v: array[2'i64, cint]; v_speed: cfloat; v_min: cint; v_max: cint; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragInt2".}
proc igDragInt3*(label: cstring; v: array[3'i64, cint]; v_speed: cfloat; v_min: cint; v_max: cint; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragInt3".}
proc igDragInt4*(label: cstring; v: array[4'i64, cint]; v_speed: cfloat; v_min: cint; v_max: cint; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragInt4".}
proc igDragIntRange2*(label: cstring; v_current_min: ptr cint; v_current_max: ptr cint; v_speed: cfloat; v_min: cint; v_max: cint; format: cstring; format_max: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragIntRange2".}
proc igDragScalar*(label: cstring; data_type: ImGuiDataType; p_data: pointer; v_speed: cfloat; p_min: pointer; p_max: pointer; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragScalar".}
proc igDragScalarN*(label: cstring; data_type: ImGuiDataType; p_data: pointer; components: cint; v_speed: cfloat; p_min: pointer; p_max: pointer; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igDragScalarN".}
proc igSliderFloat*(label: cstring; v: ptr cfloat; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderFloat".}
proc igSliderFloat2*(label: cstring; v: array[2'i64, cfloat]; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderFloat2".}
proc igSliderFloat3*(label: cstring; v: array[3'i64, cfloat]; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderFloat3".}
proc igSliderFloat4*(label: cstring; v: array[4'i64, cfloat]; v_min: cfloat; v_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderFloat4".}
proc igSliderAngle*(label: cstring; v_rad: ptr cfloat; v_degrees_min: cfloat; v_degrees_max: cfloat; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderAngle".}
proc igSliderInt*(label: cstring; v: ptr cint; v_min: cint; v_max: cint; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderInt".}
proc igSliderInt2*(label: cstring; v: array[2'i64, cint]; v_min: cint; v_max: cint; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderInt2".}
proc igSliderInt3*(label: cstring; v: array[3'i64, cint]; v_min: cint; v_max: cint; format: cstring; flags: ImGuiSliderFlags): bool {.cdecl, importc: "igSliderInt3".}
...
proc igInputFloat3*(label: cstring; v: array[3'i64, cfloat]; format: cstring; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputFloat3".}
proc igInputFloat4*(label: cstring; v: array[4'i64, cfloat]; format: cstring; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputFloat4".}
proc igInputInt*(label: cstring; v: ptr cint; step: cint; step_fast: cint; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputInt".}
proc igInputInt2*(label: cstring; v: array[2'i64, cint]; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputInt2".}
proc igInputInt3*(label: cstring; v: array[3'i64, cint]; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputInt3".}
proc igInputInt4*(label: cstring; v: array[4'i64, cint]; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputInt4".}
proc igInputDouble*(label: cstring; v: ptr cdouble; step: cdouble; step_fast: cdouble; format: cstring; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputDouble".}
proc igInputScalar*(label: cstring; data_type: ImGuiDataType; p_data: pointer; p_step: pointer; p_step_fast: pointer; format: cstring; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputScalar".}
proc igInputScalarN*(label: cstring; data_type: ImGuiDataType; p_data: pointer; components: cint; p_step: pointer; p_step_fast: pointer; format: cstring; flags: ImGuiInputTextFlags): bool {.cdecl, importc: "igInputScalarN".}
proc igColorEdit3*(label: cstring; col: array[3'i64, cfloat]; flags: ImGuiColorEditFlags): bool {.cdecl, importc: "igColorEdit3".}
...
proc igTreeNodeV_Str*(str_id: cstring; fmt: cstring): bool {.cdecl, varargs, importc: "igTreeNodeV_Str".}
proc igTreeNodeV_Ptr*(ptr_id: pointer; fmt: cstring): bool {.cdecl, varargs, importc: "igTreeNodeV_Ptr".}
proc igTreeNodeEx_Str*(label: cstring; flags: ImGuiTreeNodeFlags): bool {.cdecl, importc: "igTreeNodeEx_Str".}
proc igTreeNodeEx_StrStr*(str_id: cstring; flags: ImGuiTreeNodeFlags; fmt: cstring): bool {.cdecl, varargs, importc: "igTreeNodeEx_StrStr".}
proc igTreeNodeEx_Ptr*(ptr_id: pointer; flags: ImGuiTreeNodeFlags; fmt: cstring): bool {.cdecl, varargs, importc: "igTreeNodeEx_Ptr".}
proc igTreeNodeExV_Str*(str_id: cstring; flags: ImGuiTreeNodeFlags; fmt: cstring): bool {.cdecl, varargs, importc: "igTreeNodeExV_Str".}
proc igTreeNodeExV_Ptr*(ptr_id: pointer; flags: ImGuiTreeNodeFlags; fmt: cstring): bool {.cdecl, varargs, importc: "igTreeNodeExV_Ptr".}
...
proc igGetTreeNodeToLabelSpacing*(): cfloat {.cdecl, importc: "igGetTreeNodeToLabelSpacing".}
proc igCollapsingHeader_TreeNodeFlags*(label: cstring; flags: ImGuiTreeNodeFlags): bool {.cdecl, importc: "igCollapsingHeader_TreeNodeFlags".}
...
proc igValue_Float*(prefix: cstring; v: cfloat; float_format: cstring): void {.cdecl, importc: "igValue_Float".}
...
proc igBeginMenu*(label: cstring; enabled: bool): bool {.cdecl, importc: "igBeginMenu".}
proc igEndMenu*(): void {.cdecl, importc: "igEndMenu".}
proc igMenuItem_Bool*(label: cstring; shortcut: cstring; selected: bool; enabled: bool): bool {.cdecl, importc: "igMenuItem_Bool".}
proc igMenuItem_BoolPtr*(label: cstring; shortcut: cstring; p_selected: ptr bool; enabled: bool): bool {.cdecl, importc: "igMenuItem_BoolPtr".}
...
proc igSetTooltipV*(fmt: cstring): void {.cdecl, varargs, importc: "igSetTooltipV".}
proc igBeginItemTooltip*(): bool {.cdecl, importc: "igBeginItemTooltip".}
proc igSetItemTooltip*(fmt: cstring): void {.cdecl, varargs, importc: "igSetItemTooltip".}
proc igSetItemTooltipV*(fmt: cstring): void {.cdecl, varargs, importc: "igSetItemTooltipV".}
...
proc igTableAngledHeadersRow*(): void {.cdecl, importc: "igTableAngledHeadersRow".}
proc igTableGetSortSpecs*(): ptr ImGuiTableSortSpecs {.cdecl, importc: "igTableGetSortSpecs".}
...
proc igTableGetColumnName_Int*(column_n: cint): cstring {.cdecl, importc: "igTableGetColumnName_Int".}
proc igTableGetColumnFlags*(column_n: cint): ImGuiTableColumnFlags {.cdecl, importc: "igTableGetColumnFlags".}
proc igTableSetColumnEnabled*(column_n: cint; v: bool): void {.cdecl, importc: "igTableSetColumnEnabled".}
proc igTableGetHoveredColumn*(): cint {.cdecl, importc: "igTableGetHoveredColumn".}
proc igTableSetBgColor*(target: ImGuiTableBgTarget; color: ImU32; column_n: cint): void {.cdecl, importc: "igTableSetBgColor".}
proc igColumns*(count: cint; id: cstring; borders: bool): void {.cdecl, importc: "igColumns".}
proc igNextColumn*(): void {.cdecl, importc: "igNextColumn".}
proc igGetColumnIndex*(): cint {.cdecl, importc: "igGetColumnIndex".}
proc igGetColumnWidth*(column_index: cint): cfloat {.cdecl, importc: "igGetColumnWidth".}
proc igSetColumnWidth*(column_index: cint; width: cfloat): void {.cdecl, importc: "igSetColumnWidth".}
proc igGetColumnOffset*(column_index: cint): cfloat {.cdecl, importc: "igGetColumnOffset".}
proc igSetColumnOffset*(column_index: cint; offset_x: cfloat): void {.cdecl, importc: "igSetColumnOffset".}
proc igGetColumnsCount*(): cint {.cdecl, importc: "igGetColumnsCount".}
proc igBeginTabBar*(str_id: cstring; flags: ImGuiTabBarFlags): bool {.cdecl, importc: "igBeginTabBar".}
proc igEndTabBar*(): void {.cdecl, importc: "igEndTabBar".}
proc igBeginTabItem*(label: cstring; p_open: ptr bool; flags: ImGuiTabItemFlags): bool {.cdecl, importc: "igBeginTabItem".}
...
proc igLogToFile*(auto_open_depth: cint; filename: cstring): void {.cdecl, importc: "igLogToFile".}
proc igLogToClipboard*(auto_open_depth: cint): void {.cdecl, importc: "igLogToClipboard".}
...
proc igBeginDragDropSource*(flags: ImGuiDragDropFlags): bool {.cdecl, importc: "igBeginDragDropSource".}
proc igSetDragDropPayload*(type_arg: cstring; data: pointer; sz: csize_t; cond: ImGuiCond): bool {.cdecl, importc: "igSetDragDropPayload".}
...
proc igAcceptDragDropPayload*(type_arg: cstring; flags: ImGuiDragDropFlags): ptr ImGuiPayload {.cdecl, importc: "igAcceptDragDropPayload".}
...
proc igSetNavCursorVisible*(visible: bool): void {.cdecl, importc: "igSetNavCursorVisible".}
proc igSetNextItemAllowOverlap*(): void {.cdecl, importc: "igSetNextItemAllowOverlap".}
proc igIsItemHovered*(flags: ImGuiHoveredFlags): bool {.cdecl, importc: "igIsItemHovered".}
proc igIsItemActive*(): bool {.cdecl, importc: "igIsItemActive".}
proc igIsItemFocused*(): bool {.cdecl, importc: "igIsItemFocused".}
proc igIsItemClicked*(mouse_button: ImGuiMouseButton): bool {.cdecl, importc: "igIsItemClicked".}
...
proc igIsItemDeactivatedAfterEdit*(): bool {.cdecl, importc: "igIsItemDeactivatedAfterEdit".}
...
proc igIsKeyPressed_Bool*(key: ImGuiKey; repeat: bool): bool {.cdecl, importc: "igIsKeyPressed_Bool".}
proc igIsKeyReleased_Nil*(key: ImGuiKey): bool {.cdecl, importc: "igIsKeyReleased_Nil".}
proc igIsKeyChordPressed_Nil*(key_chord: ImGuiKeyChord): bool {.cdecl, importc: "igIsKeyChordPressed_Nil".}
proc igGetKeyPressedAmount*(key: ImGuiKey; repeat_delay: cfloat; rate: cfloat): cint {.cdecl, importc: "igGetKeyPressedAmount".}
proc igGetKeyName*(key: ImGuiKey): cstring {.cdecl, importc: "igGetKeyName".}
proc igSetNextFrameWantCaptureKeyboard*(want_capture_keyboard: bool): void {.cdecl, importc: "igSetNextFrameWantCaptureKeyboard".}
proc igShortcut_Nil*(key_chord: ImGuiKeyChord; flags: ImGuiInputFlags): bool {.cdecl, importc: "igShortcut_Nil".}
proc igSetNextItemShortcut*(key_chord: ImGuiKeyChord; flags: ImGuiInputFlags): void {.cdecl, importc: "igSetNextItemShortcut".}
proc igSetItemKeyOwner_Nil*(key: ImGuiKey): bool {.cdecl, importc: "igSetItemKeyOwner_Nil".}
proc igIsMouseDown_Nil*(button: ImGuiMouseButton): bool {.cdecl, importc: "igIsMouseDown_Nil".}
proc igIsMouseClicked_Bool*(button: ImGuiMouseButton; repeat: bool): bool {.cdecl, importc: "igIsMouseClicked_Bool".}
proc igIsMouseReleased_Nil*(button: ImGuiMouseButton): bool {.cdecl, importc: "igIsMouseReleased_Nil".}
...
proc igSetNextFrameWantCaptureMouse*(want_capture_mouse: bool): void {.cdecl, importc: "igSetNextFrameWantCaptureMouse".}
proc igGetClipboardText*(): cstring {.cdecl, importc: "igGetClipboardText".}
proc igSetClipboardText*(text: cstring): void {.cdecl, importc: "igSetClipboardText".}
proc igLoadIniSettingsFromDisk*(ini_filename: cstring): void {.cdecl, importc: "igLoadIniSettingsFromDisk".}
proc igLoadIniSettingsFromMemory*(ini_data: cstring; ini_size: csize_t): void {.cdecl, importc: "igLoadIniSettingsFromMemory".}
proc igSaveIniSettingsToDisk*(ini_filename: cstring): void {.cdecl, importc: "igSaveIniSettingsToDisk".}
proc igSaveIniSettingsToMemory*(out_ini_size: ptr csize_t): cstring {.cdecl, importc: "igSaveIniSettingsToMemory".}
proc igDebugTextEncoding*(text: cstring): void {.cdecl, importc: "igDebugTextEncoding".}
proc igDebugFlashStyleColor*(idx: ImGuiCol): void {.cdecl, importc: "igDebugFlashStyleColor".}
proc igDebugStartItemPicker*(): void {.cdecl, importc: "igDebugStartItemPicker".}
proc igDebugCheckVersionAndDataLayout*(version_str: cstring; sz_io: csize_t; sz_style: csize_t; sz_vec2: csize_t; sz_vec4: csize_t; sz_drawvert: csize_t; sz_drawidx: csize_t): bool {.cdecl, importc: "igDebugCheckVersionAndDataLayout".}
...
proc igSetAllocatorFunctions*(alloc_func: ImGuiMemAllocFunc; free_func: ImGuiMemFreeFunc; user_data: pointer): void {.cdecl, importc: "igSetAllocatorFunctions".}
proc igGetAllocatorFunctions*(p_alloc_func: ImGuiMemAllocFunc; p_free_func: ImGuiMemFreeFunc; p_user_data: ptr pointer): void {.cdecl, importc: "igGetAllocatorFunctions".}
...
proc ImGuiTableColumnSortSpecs_ImGuiTableColumnSortSpecs*(): ptr ImGuiTableColumnSortSpecs {.cdecl, importc: "ImGuiTableColumnSortSpecs_ImGuiTableColumnSortSpecs".}
proc ImGuiTableColumnSortSpecs_destroy*(self: ptr ImGuiTableColumnSortSpecs): void {.cdecl, importc: "ImGuiTableColumnSortSpecs_destroy".}
proc ImGuiStyle_ImGuiStyle*(): ptr ImGuiStyle {.cdecl, importc: "ImGuiStyle_ImGuiStyle".}
proc ImGuiStyle_destroy*(self: ptr ImGuiStyle): void {.cdecl, importc: "ImGuiStyle_destroy".}
proc ImGuiStyle_ScaleAllSizes*(self: ptr ImGuiStyle; scale_factor: cfloat): void {.cdecl, importc: "ImGuiStyle_ScaleAllSizes".}
proc ImGuiIO_AddKeyEvent*(self: ptr ImGuiIO; key: ImGuiKey; down: bool): void {.cdecl, importc: "ImGuiIO_AddKeyEvent".}
proc ImGuiIO_AddKeyAnalogEvent*(self: ptr ImGuiIO; key: ImGuiKey; down: bool; v: cfloat): void {.cdecl, importc: "ImGuiIO_AddKeyAnalogEvent".}
proc ImGuiIO_AddMousePosEvent*(self: ptr ImGuiIO; x: cfloat; y: cfloat): void {.cdecl, importc: "ImGuiIO_AddMousePosEvent".}
proc ImGuiIO_AddMouseButtonEvent*(self: ptr ImGuiIO; button: cint; down: bool): void {.cdecl, importc: "ImGuiIO_AddMouseButtonEvent".}
proc ImGuiIO_AddMouseWheelEvent*(self: ptr ImGuiIO; wheel_x: cfloat; wheel_y: cfloat): void {.cdecl, importc: "ImGuiIO_AddMouseWheelEvent".}
proc ImGuiIO_AddMouseSourceEvent*(self: ptr ImGuiIO; source: ImGuiMouseSource): void {.cdecl, importc: "ImGuiIO_AddMouseSourceEvent".}
proc ImGuiIO_AddMouseViewportEvent*(self: ptr ImGuiIO; id: ImGuiID): void {.cdecl, importc: "ImGuiIO_AddMouseViewportEvent".}
proc ImGuiIO_AddFocusEvent*(self: ptr ImGuiIO; focused: bool): void {.cdecl, importc: "ImGuiIO_AddFocusEvent".}
proc ImGuiIO_AddInputCharacter*(self: ptr ImGuiIO; c: cuint): void {.cdecl, importc: "ImGuiIO_AddInputCharacter".}
proc ImGuiIO_AddInputCharacterUTF16*(self: ptr ImGuiIO; c: ImWchar16): void {.cdecl, importc: "ImGuiIO_AddInputCharacterUTF16".}
proc ImGuiIO_AddInputCharactersUTF8*(self: ptr ImGuiIO; str: cstring): void {.cdecl, importc: "ImGuiIO_AddInputCharactersUTF8".}
proc ImGuiIO_SetKeyEventNativeData*(self: ptr ImGuiIO; key: ImGuiKey; native_keycode: cint; native_scancode: cint; native_legacy_index: cint): void {.cdecl, importc: "ImGuiIO_SetKeyEventNativeData".}
proc ImGuiIO_SetAppAcceptingEvents*(self: ptr ImGuiIO; accepting_events: bool): void {.cdecl, importc: "ImGuiIO_SetAppAcceptingEvents".}
proc ImGuiIO_ClearEventsQueue*(self: ptr ImGuiIO): void {.cdecl, importc: "ImGuiIO_ClearEventsQueue".}
proc ImGuiIO_ClearInputKeys*(self: ptr ImGuiIO): void {.cdecl, importc: "ImGuiIO_ClearInputKeys".}
proc ImGuiIO_ClearInputMouse*(self: ptr ImGuiIO): void {.cdecl, importc: "ImGuiIO_ClearInputMouse".}
proc ImGuiIO_ImGuiIO*(): ptr ImGuiIO {.cdecl, importc: "ImGuiIO_ImGuiIO".}
proc ImGuiIO_destroy*(self: ptr ImGuiIO): void {.cdecl, importc: "ImGuiIO_destroy".}
proc ImGuiInputTextCallbackData_ImGuiInputTextCallbackData*(): ptr ImGuiInputTextCallbackData {.cdecl, importc: "ImGuiInputTextCallbackData_ImGuiInputTextCallbackData".}
proc ImGuiInputTextCallbackData_destroy*(self: ptr ImGuiInputTextCallbackData): void {.cdecl, importc: "ImGuiInputTextCallbackData_destroy".}
...
proc ImGuiWindowClass_destroy*(self: ptr ImGuiWindowClass): void {.cdecl, importc: "ImGuiWindowClass_destroy".}
proc ImGuiPayload_ImGuiPayload*(): ptr ImGuiPayload {.cdecl, importc: "ImGuiPayload_ImGuiPayload".}
proc ImGuiPayload_destroy*(self: ptr ImGuiPayload): void {.cdecl, importc: "ImGuiPayload_destroy".}
proc ImGuiPayload_Clear*(self: ptr ImGuiPayload): void {.cdecl, importc: "ImGuiPayload_Clear".}
proc ImGuiPayload_IsDataType*(self: ptr ImGuiPayload; type_arg: cstring): bool {.cdecl, importc: "ImGuiPayload_IsDataType".}
proc ImGuiPayload_IsPreview*(self: ptr ImGuiPayload): bool {.cdecl, importc: "ImGuiPayload_IsPreview".}
proc ImGuiPayload_IsDelivery*(self: ptr ImGuiPayload): bool {.cdecl, importc: "ImGuiPayload_IsDelivery".}
proc ImGuiOnceUponAFrame_ImGuiOnceUponAFrame*(): ptr ImGuiOnceUponAFrame {.cdecl, importc: "ImGuiOnceUponAFrame_ImGuiOnceUponAFrame".}
proc ImGuiOnceUponAFrame_destroy*(self: ptr ImGuiOnceUponAFrame): void {.cdecl, importc: "ImGuiOnceUponAFrame_destroy".}
proc ImGuiTextFilter_ImGuiTextFilter*(default_filter: cstring): ptr ImGuiTextFilter {.cdecl, importc: "ImGuiTextFilter_ImGuiTextFilter".}
proc ImGuiTextFilter_destroy*(self: ptr ImGuiTextFilter): void {.cdecl, importc: "ImGuiTextFilter_destroy".}
proc ImGuiTextFilter_Draw*(self: ptr ImGuiTextFilter; label: cstring; width: cfloat): bool {.cdecl, importc: "ImGuiTextFilter_Draw".}
proc ImGuiTextFilter_PassFilter*(self: ptr ImGuiTextFilter; text: cstring; text_end: cstring): bool {.cdecl, importc: "ImGuiTextFilter_PassFilter".}
proc ImGuiTextFilter_Build*(self: ptr ImGuiTextFilter): void {.cdecl, importc: "ImGuiTextFilter_Build".}
proc ImGuiTextFilter_Clear*(self: ptr ImGuiTextFilter): void {.cdecl, importc: "ImGuiTextFilter_Clear".}
proc ImGuiTextFilter_IsActive*(self: ptr ImGuiTextFilter): bool {.cdecl, importc: "ImGuiTextFilter_IsActive".}
proc ImGuiTextRange_ImGuiTextRange_Nil*(): ptr ImGuiTextRange {.cdecl, importc: "ImGuiTextRange_ImGuiTextRange_Nil".}
proc ImGuiTextRange_destroy*(self: ptr ImGuiTextRange): void {.cdecl, importc: "ImGuiTextRange_destroy".}
proc ImGuiTextRange_ImGuiTextRange_Str*(internal_b: cstring; internal_e: cstring): ptr ImGuiTextRange {.cdecl, importc: "ImGuiTextRange_ImGuiTextRange_Str".}
proc ImGuiTextRange_empty*(self: ptr ImGuiTextRange): bool {.cdecl, importc: "ImGuiTextRange_empty".}
proc ImGuiTextRange_split*(self: ptr ImGuiTextRange; separator: cschar; out_arg: ptr ImVector_ImGuiTextRange): void {.cdecl, importc: "ImGuiTextRange_split".}
proc ImGuiTextBuffer_ImGuiTextBuffer*(): ptr ImGuiTextBuffer {.cdecl, importc: "ImGuiTextBuffer_ImGuiTextBuffer".}
proc ImGuiTextBuffer_destroy*(self: ptr ImGuiTextBuffer): void {.cdecl, importc: "ImGuiTextBuffer_destroy".}
proc ImGuiTextBuffer_begin*(self: ptr ImGuiTextBuffer): cstring {.cdecl, importc: "ImGuiTextBuffer_begin".}
proc ImGuiTextBuffer_end*(self: ptr ImGuiTextBuffer): cstring {.cdecl, importc: "ImGuiTextBuffer_end".}
proc ImGuiTextBuffer_size*(self: ptr ImGuiTextBuffer): cint {.cdecl, importc: "ImGuiTextBuffer_size".}
proc ImGuiTextBuffer_empty*(self: ptr ImGuiTextBuffer): bool {.cdecl, importc: "ImGuiTextBuffer_empty".}
proc ImGuiTextBuffer_clear*(self: ptr ImGuiTextBuffer): void {.cdecl, importc: "ImGuiTextBuffer_clear".}
proc ImGuiTextBuffer_resize*(self: ptr ImGuiTextBuffer; size: cint): void {.cdecl, importc: "ImGuiTextBuffer_resize".}
proc ImGuiTextBuffer_reserve*(self: ptr ImGuiTextBuffer; capacity: cint): void {.cdecl, importc: "ImGuiTextBuffer_reserve".}
proc ImGuiTextBuffer_c_str*(self: ptr ImGuiTextBuffer): cstring {.cdecl, importc: "ImGuiTextBuffer_c_str".}
proc ImGuiTextBuffer_append*(self: ptr ImGuiTextBuffer; str: cstring; str_end: cstring): void {.cdecl, importc: "ImGuiTextBuffer_append".}
proc ImGuiTextBuffer_appendfv*(self: ptr ImGuiTextBuffer; fmt: cstring): void {.cdecl, varargs, importc: "ImGuiTextBuffer_appendfv".}
proc ImGuiStoragePair_ImGuiStoragePair_Int*(internal_key: ImGuiID; internal_val: cint): ptr ImGuiStoragePair {.cdecl, importc: "ImGuiStoragePair_ImGuiStoragePair_Int".}
proc ImGuiStoragePair_destroy*(self: ptr ImGuiStoragePair): void {.cdecl, importc: "ImGuiStoragePair_destroy".}
proc ImGuiStoragePair_ImGuiStoragePair_Float*(internal_key: ImGuiID; internal_val: cfloat): ptr ImGuiStoragePair {.cdecl, importc: "ImGuiStoragePair_ImGuiStoragePair_Float".}
proc ImGuiStoragePair_ImGuiStoragePair_Ptr*(internal_key: ImGuiID; internal_val: pointer): ptr ImGuiStoragePair {.cdecl, importc: "ImGuiStoragePair_ImGuiStoragePair_Ptr".}
proc ImGuiStorage_Clear*(self: ptr ImGuiStorage): void {.cdecl, importc: "ImGuiStorage_Clear".}
proc ImGuiStorage_GetInt*(self: ptr ImGuiStorage; key: ImGuiID; default_val: cint): cint {.cdecl, importc: "ImGuiStorage_GetInt".}
proc ImGuiStorage_SetInt*(self: ptr ImGuiStorage; key: ImGuiID; val: cint): void {.cdecl, importc: "ImGuiStorage_SetInt".}
proc ImGuiStorage_GetBool*(self: ptr ImGuiStorage; key: ImGuiID; default_val: bool): bool {.cdecl, importc: "ImGuiStorage_GetBool".}
proc ImGuiStorage_SetBool*(self: ptr ImGuiStorage; key: ImGuiID; val: bool): void {.cdecl, importc: "ImGuiStorage_SetBool".}
proc ImGuiStorage_GetFloat*(self: ptr ImGuiStorage; key: ImGuiID; default_val: cfloat): cfloat {.cdecl, importc: "ImGuiStorage_GetFloat".}
proc ImGuiStorage_SetFloat*(self: ptr ImGuiStorage; key: ImGuiID; val: cfloat): void {.cdecl, importc: "ImGuiStorage_SetFloat".}
proc ImGuiStorage_GetVoidPtr*(self: ptr ImGuiStorage; key: ImGuiID): pointer {.cdecl, importc: "ImGuiStorage_GetVoidPtr".}
proc ImGuiStorage_SetVoidPtr*(self: ptr ImGuiStorage; key: ImGuiID; val: pointer): void {.cdecl, importc: "ImGuiStorage_SetVoidPtr".}
proc ImGuiStorage_GetIntRef*(self: ptr ImGuiStorage; key: ImGuiID; default_val: cint): ptr cint {.cdecl, importc: "ImGuiStorage_GetIntRef".}
proc ImGuiStorage_GetBoolRef*(self: ptr ImGuiStorage; key: ImGuiID; default_val: bool): ptr bool {.cdecl, importc: "ImGuiStorage_GetBoolRef".}
proc ImGuiStorage_GetFloatRef*(self: ptr ImGuiStorage; key: ImGuiID; default_val: cfloat): ptr cfloat {.cdecl, importc: "ImGuiStorage_GetFloatRef".}
proc ImGuiStorage_GetVoidPtrRef*(self: ptr ImGuiStorage; key: ImGuiID; default_val: pointer): ptr pointer {.cdecl, importc: "ImGuiStorage_GetVoidPtrRef".}
proc ImGuiStorage_BuildSortByKey*(self: ptr ImGuiStorage): void {.cdecl, importc: "ImGuiStorage_BuildSortByKey".}
proc ImGuiStorage_SetAllInt*(self: ptr ImGuiStorage; val: cint): void {.cdecl, importc: "ImGuiStorage_SetAllInt".}
proc ImGuiListClipper_ImGuiListClipper*(): ptr ImGuiListClipper {.cdecl, importc: "ImGuiListClipper_ImGuiListClipper".}
proc ImGuiListClipper_destroy*(self: ptr ImGuiListClipper): void {.cdecl, importc: "ImGuiListClipper_destroy".}
proc ImGuiListClipper_Begin*(self: ptr ImGuiListClipper; items_count: cint; items_height: cfloat): void {.cdecl, importc: "ImGuiListClipper_Begin".}
proc ImGuiListClipper_End*(self: ptr ImGuiListClipper): void {.cdecl, importc: "ImGuiListClipper_End".}
proc ImGuiListClipper_Step*(self: ptr ImGuiListClipper): bool {.cdecl, importc: "ImGuiListClipper_Step".}
proc ImGuiListClipper_IncludeItemByIndex*(self: ptr ImGuiListClipper; item_index: cint): void {.cdecl, importc: "ImGuiListClipper_IncludeItemByIndex".}
proc ImGuiListClipper_IncludeItemsByIndex*(self: ptr ImGuiListClipper; item_begin: cint; item_end: cint): void {.cdecl, importc: "ImGuiListClipper_IncludeItemsByIndex".}
proc ImGuiListClipper_SeekCursorForItem*(self: ptr ImGuiListClipper; item_index: cint): void {.cdecl, importc: "ImGuiListClipper_SeekCursorForItem".}
...
proc ImGuiSelectionBasicStorage_Contains*(self: ptr ImGuiSelectionBasicStorage; id: ImGuiID): bool {.cdecl, importc: "ImGuiSelectionBasicStorage_Contains".}
proc ImGuiSelectionBasicStorage_Clear*(self: ptr ImGuiSelectionBasicStorage): void {.cdecl, importc: "ImGuiSelectionBasicStorage_Clear".}
proc ImGuiSelectionBasicStorage_Swap*(self: ptr ImGuiSelectionBasicStorage; r: ptr ImGuiSelectionBasicStorage): void {.cdecl, importc: "ImGuiSelectionBasicStorage_Swap".}
proc ImGuiSelectionBasicStorage_SetItemSelected*(self: ptr ImGuiSelectionBasicStorage; id: ImGuiID; selected: bool): void {.cdecl, importc: "ImGuiSelectionBasicStorage_SetItemSelected".}
proc ImGuiSelectionBasicStorage_GetNextSelectedItem*(self: ptr ImGuiSelectionBasicStorage; opaque_it: ptr pointer; out_id: ptr ImGuiID): bool {.cdecl, importc: "ImGuiSelectionBasicStorage_GetNextSelectedItem".}
proc ImGuiSelectionBasicStorage_GetStorageIdFromIndex*(self: ptr ImGuiSelectionBasicStorage; idx: cint): ImGuiID {.cdecl, importc: "ImGuiSelectionBasicStorage_GetStorageIdFromIndex".}
proc ImGuiSelectionExternalStorage_ImGuiSelectionExternalStorage*(): ptr ImGuiSelectionExternalStorage {.cdecl, importc: "ImGuiSelectionExternalStorage_ImGuiSelectionExternalStorage".}
proc ImGuiSelectionExternalStorage_destroy*(self: ptr ImGuiSelectionExternalStorage): void {.cdecl, importc: "ImGuiSelectionExternalStorage_destroy".}
proc ImGuiSelectionExternalStorage_ApplyRequests*(self: ptr ImGuiSelectionExternalStorage; ms_io: ptr ImGuiMultiSelectIO): void {.cdecl, importc: "ImGuiSelectionExternalStorage_ApplyRequests".}
proc ImDrawCmd_ImDrawCmd*(): ptr ImDrawCmd {.cdecl, importc: "ImDrawCmd_ImDrawCmd".}
proc ImDrawCmd_destroy*(self: ptr ImDrawCmd): void {.cdecl, importc: "ImDrawCmd_destroy".}
proc ImDrawCmd_GetTexID*(self: ptr ImDrawCmd): ImTextureID {.cdecl, importc: "ImDrawCmd_GetTexID".}
proc ImDrawListSplitter_ImDrawListSplitter*(): ptr ImDrawListSplitter {.cdecl, importc: "ImDrawListSplitter_ImDrawListSplitter".}
proc ImDrawListSplitter_destroy*(self: ptr ImDrawListSplitter): void {.cdecl, importc: "ImDrawListSplitter_destroy".}
proc ImDrawListSplitter_Clear*(self: ptr ImDrawListSplitter): void {.cdecl, importc: "ImDrawListSplitter_Clear".}
proc ImDrawListSplitter_ClearFreeMemory*(self: ptr ImDrawListSplitter): void {.cdecl, importc: "ImDrawListSplitter_ClearFreeMemory".}
proc ImDrawListSplitter_Split*(self: ptr ImDrawListSplitter; draw_list: ptr ImDrawList; count: cint): void {.cdecl, importc: "ImDrawListSplitter_Split".}
proc ImDrawListSplitter_Merge*(self: ptr ImDrawListSplitter; draw_list: ptr ImDrawList): void {.cdecl, importc: "ImDrawListSplitter_Merge".}
...
proc ImDrawList_AddLineH*(self: ptr ImDrawList; min_x: cfloat; max_x: cfloat; y: cfloat; col: ImU32; thickness: cfloat): void {.cdecl, importc: "ImDrawList_AddLineH".}
proc ImDrawList_AddLineV*(self: ptr ImDrawList; x: cfloat; min_y: cfloat; max_y: cfloat; col: ImU32; thickness: cfloat): void {.cdecl, importc: "ImDrawList_AddLineV".}
proc ImDrawList_AddRect*(self: ptr ImDrawList; p_min: ImVec2_c; p_max: ImVec2_c; col: ImU32; rounding: cfloat; thickness: cfloat; flags: ImDrawFlags): void {.cdecl, importc: "ImDrawList_AddRect".}
...
proc ImDrawList_AddPolyline*(self: ptr ImDrawList; points: ptr ImVec2_c; num_points: cint; col: ImU32; thickness: cfloat; flags: ImDrawFlags): void {.cdecl, importc: "ImDrawList_AddPolyline".}
...
proc ImDrawList_PathStroke*(self: ptr ImDrawList; col: ImU32; thickness: cfloat; flags: ImDrawFlags): void {.cdecl, importc: "ImDrawList_PathStroke".}
...
proc ImDrawList_ChannelsSplit*(self: ptr ImDrawList; count: cint): void {.cdecl, importc: "ImDrawList_ChannelsSplit".}
proc ImDrawList_ChannelsMerge*(self: ptr ImDrawList): void {.cdecl, importc: "ImDrawList_ChannelsMerge".}
...
proc ImDrawList_PopUnusedDrawCmd*(self: ptr ImDrawList): void {.cdecl, importc: "ImDrawList__PopUnusedDrawCmd".}
proc ImDrawList_TryMergeDrawCmds*(self: ptr ImDrawList): void {.cdecl, importc: "ImDrawList__TryMergeDrawCmds".}
...
proc ImTextureData_DestroyPixels*(self: ptr ImTextureData): void {.cdecl, importc: "ImTextureData_DestroyPixels".}
proc ImTextureData_GetPixels*(self: ptr ImTextureData): pointer {.cdecl, importc: "ImTextureData_GetPixels".}
...
proc ImFontConfig_ImFontConfig*(): ptr ImFontConfig {.cdecl, importc: "ImFontConfig_ImFontConfig".}
proc ImFontConfig_destroy*(self: ptr ImFontConfig): void {.cdecl, importc: "ImFontConfig_destroy".}
proc ImFontGlyph_ImFontGlyph*(): ptr ImFontGlyph {.cdecl, importc: "ImFontGlyph_ImFontGlyph".}
proc ImFontGlyph_destroy*(self: ptr ImFontGlyph): void {.cdecl, importc: "ImFontGlyph_destroy".}
proc ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder*(): ptr ImFontGlyphRangesBuilder {.cdecl, importc: "ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder".}
proc ImFontGlyphRangesBuilder_destroy*(self: ptr ImFontGlyphRangesBuilder): void {.cdecl, importc: "ImFontGlyphRangesBuilder_destroy".}
proc ImFontGlyphRangesBuilder_Clear*(self: ptr ImFontGlyphRangesBuilder): void {.cdecl, importc: "ImFontGlyphRangesBuilder_Clear".}
proc ImFontGlyphRangesBuilder_GetBit*(self: ptr ImFontGlyphRangesBuilder; n: csize_t): bool {.cdecl, importc: "ImFontGlyphRangesBuilder_GetBit".}
proc ImFontGlyphRangesBuilder_SetBit*(self: ptr ImFontGlyphRangesBuilder; n: csize_t): void {.cdecl, importc: "ImFontGlyphRangesBuilder_SetBit".}
proc ImFontGlyphRangesBuilder_AddChar*(self: ptr ImFontGlyphRangesBuilder; c: ImWchar): void {.cdecl, importc: "ImFontGlyphRangesBuilder_AddChar".}
proc ImFontGlyphRangesBuilder_AddText*(self: ptr ImFontGlyphRangesBuilder; text: cstring; text_end: cstring): void {.cdecl, importc: "ImFontGlyphRangesBuilder_AddText".}
proc ImFontGlyphRangesBuilder_AddRanges*(self: ptr ImFontGlyphRangesBuilder; ranges: ptr ImWchar): void {.cdecl, importc: "ImFontGlyphRangesBuilder_AddRanges".}
proc ImFontGlyphRangesBuilder_BuildRanges*(self: ptr ImFontGlyphRangesBuilder; out_ranges: ptr ImVector_ImWchar): void {.cdecl, importc: "ImFontGlyphRangesBuilder_BuildRanges".}
proc ImFontAtlasRect_ImFontAtlasRect*(): ptr ImFontAtlasRect {.cdecl, importc: "ImFontAtlasRect_ImFontAtlasRect".}
proc ImFontAtlasRect_destroy*(self: ptr ImFontAtlasRect): void {.cdecl, importc: "ImFontAtlasRect_destroy".}
proc ImFontAtlas_ImFontAtlas*(): ptr ImFontAtlas {.cdecl, importc: "ImFontAtlas_ImFontAtlas".}
...
proc ImFontAtlas_AddCustomRect*(self: ptr ImFontAtlas; width: cint; height: cint; out_r: ptr ImFontAtlasRect): ImFontAtlasRectId {.cdecl, importc: "ImFontAtlas_AddCustomRect".}
proc ImFontAtlas_RemoveCustomRect*(self: ptr ImFontAtlas; id: ImFontAtlasRectId): void {.cdecl, importc: "ImFontAtlas_RemoveCustomRect".}
proc ImFontAtlas_GetCustomRect*(self: ptr ImFontAtlas; id: ImFontAtlasRectId; out_r: ptr ImFontAtlasRect): bool {.cdecl, importc: "ImFontAtlas_GetCustomRect".}
proc ImFontBaked_ImFontBaked*(): ptr ImFontBaked {.cdecl, importc: "ImFontBaked_ImFontBaked".}
proc ImFontBaked_destroy*(self: ptr ImFontBaked): void {.cdecl, importc: "ImFontBaked_destroy".}
proc ImFontBaked_ClearOutputData*(self: ptr ImFontBaked): void {.cdecl, importc: "ImFontBaked_ClearOutputData".}
proc ImFontBaked_FindGlyph*(self: ptr ImFontBaked; c: ImWchar): ptr ImFontGlyph {.cdecl, importc: "ImFontBaked_FindGlyph".}
proc ImFontBaked_FindGlyphNoFallback*(self: ptr ImFontBaked; c: ImWchar): ptr ImFontGlyph {.cdecl, importc: "ImFontBaked_FindGlyphNoFallback".}
proc ImFontBaked_GetCharAdvance*(self: ptr ImFontBaked; c: ImWchar): cfloat {.cdecl, importc: "ImFontBaked_GetCharAdvance".}
proc ImFontBaked_IsGlyphLoaded*(self: ptr ImFontBaked; c: ImWchar): bool {.cdecl, importc: "ImFontBaked_IsGlyphLoaded".}
...
proc ImFont_IsGlyphInFont*(self: ptr ImFont; c: ImWchar): bool {.cdecl, importc: "ImFont_IsGlyphInFont".}
...
proc ImGuiViewport_GetDebugName*(self: ptr ImGuiViewport): cstring {.cdecl, importc: "ImGuiViewport_GetDebugName".}
...
proc igImIsPowerOfTwo_U64*(v: ImU64): bool {.cdecl, importc: "igImIsPowerOfTwo_U64".}
proc igImUpperPowerOfTwo*(v: cint): cint {.cdecl, importc: "igImUpperPowerOfTwo".}
proc igImCountSetBits*(v: cuint): cuint {.cdecl, importc: "igImCountSetBits".}
proc igImStricmp*(str1: cstring; str2: cstring): cint {.cdecl, importc: "igImStricmp".}
proc igImStrnicmp*(str1: cstring; str2: cstring; count: csize_t): cint {.cdecl, importc: "igImStrnicmp".}
proc igImStrncpy*(dst: cstring; src: cstring; count: csize_t): void {.cdecl, importc: "igImStrncpy".}
proc igImStrdup*(str: cstring): cstring {.cdecl, importc: "igImStrdup".}
proc igImMemdup*(src: pointer; size: csize_t): pointer {.cdecl, importc: "igImMemdup".}
proc igImStrdupcpy*(dst: cstring; p_dst_size: ptr csize_t; str: cstring): cstring {.cdecl, importc: "igImStrdupcpy".}
proc igImStrchrRange*(str_begin: cstring; str_end: cstring; c: cschar): cstring {.cdecl, importc: "igImStrchrRange".}
proc igImStreolRange*(str: cstring; str_end: cstring): cstring {.cdecl, importc: "igImStreolRange".}
proc igImStristr*(haystack: cstring; haystack_end: cstring; needle: cstring; needle_end: cstring): cstring {.cdecl, importc: "igImStristr".}
proc igImStrTrimBlanks*(str: cstring): void {.cdecl, importc: "igImStrTrimBlanks".}
proc igImStrSkipBlank*(str: cstring): cstring {.cdecl, importc: "igImStrSkipBlank".}
proc igImStrlenW*(str: ptr ImWchar): cint {.cdecl, importc: "igImStrlenW".}
proc igImStrbol*(buf_mid_line: cstring; buf_begin: cstring): cstring {.cdecl, importc: "igImStrbol".}
...
proc igImFormatString*(buf: cstring; buf_size: csize_t; fmt: cstring): cint {.cdecl, varargs, importc: "igImFormatString".}
proc igImFormatStringV*(buf: cstring; buf_size: csize_t; fmt: cstring): cint {.cdecl, varargs, importc: "igImFormatStringV".}
proc igImFormatStringToTempBuffer*(out_buf: ptr cstring; out_buf_end: ptr cstring; fmt: cstring): void {.cdecl, varargs, importc: "igImFormatStringToTempBuffer".}
proc igImFormatStringToTempBufferV*(out_buf: ptr cstring; out_buf_end: ptr cstring; fmt: cstring): void {.cdecl, varargs, importc: "igImFormatStringToTempBufferV".}
proc igImParseFormatFindStart*(format: cstring): cstring {.cdecl, importc: "igImParseFormatFindStart".}
proc igImParseFormatFindEnd*(format: cstring): cstring {.cdecl, importc: "igImParseFormatFindEnd".}
proc igImParseFormatTrimDecorations*(format: cstring; buf: cstring; buf_size: csize_t): cstring {.cdecl, importc: "igImParseFormatTrimDecorations".}
proc igImParseFormatSanitizeForPrinting*(fmt_in: cstring; fmt_out: cstring; fmt_out_size: csize_t): void {.cdecl, importc: "igImParseFormatSanitizeForPrinting".}
proc igImParseFormatSanitizeForScanning*(fmt_in: cstring; fmt_out: cstring; fmt_out_size: csize_t): cstring {.cdecl, importc: "igImParseFormatSanitizeForScanning".}
proc igImParseFormatPrecision*(format: cstring; default_value: cint): cint {.cdecl, importc: "igImParseFormatPrecision".}
proc igImTextCharToUtf8*(out_buf: array[5'i64, cschar]; c: cuint): cint {.cdecl, importc: "igImTextCharToUtf8".}
proc igImTextStrToUtf8*(out_buf: cstring; out_buf_size: cint; in_text: ptr ImWchar; in_text_end: ptr ImWchar): cint {.cdecl, importc: "igImTextStrToUtf8".}
proc igImTextCharFromUtf8*(out_char: ptr cuint; in_text: cstring; in_text_end: cstring): cint {.cdecl, importc: "igImTextCharFromUtf8".}
proc igImTextStrFromUtf8*(out_buf: ptr ImWchar; out_buf_size: cint; in_text: cstring; in_text_end: cstring; in_remaining: ptr cstring): cint {.cdecl, importc: "igImTextStrFromUtf8".}
...
proc igImFileRead*(data: pointer; size: ImU64; count: ImU64; file: ImFileHandle): ImU64 {.cdecl, importc: "igImFileRead".}
proc igImFileWrite*(data: pointer; size: ImU64; count: ImU64; file: ImFileHandle): ImU64 {.cdecl, importc: "igImFileWrite".}
proc igImFileLoadToMemory*(filename: cstring; mode: cstring; out_file_size: ptr csize_t; padding_bytes: cint): pointer {.cdecl, importc: "igImFileLoadToMemory".}
proc igImPow_Float*(x: cfloat; y: cfloat): cfloat {.cdecl, importc: "igImPow_Float".}
proc igImPow_double*(x: cdouble; y: cdouble): cdouble {.cdecl, importc: "igImPow_double".}
...
proc ImVec2i_ImVec2i_Nil*(): ptr ImVec2i {.cdecl, importc: "ImVec2i_ImVec2i_Nil".}
proc ImVec2i_destroy*(self: ptr ImVec2i): void {.cdecl, importc: "ImVec2i_destroy".}
proc ImVec2i_ImVec2i_Int*(internal_x: cint; internal_y: cint): ptr ImVec2i {.cdecl, importc: "ImVec2i_ImVec2i_Int".}
...
proc ImRect_AddX*(self: ptr ImRect; x: cfloat): void {.cdecl, importc: "ImRect_AddX".}
proc ImRect_AddY*(self: ptr ImRect; y: cfloat): void {.cdecl, importc: "ImRect_AddY".}
...
proc igImBitArrayClearBit*(arr: ptr ImU32; n: cint): void {.cdecl, importc: "igImBitArrayClearBit".}
proc igImBitArraySetBit*(arr: ptr ImU32; n: cint): void {.cdecl, importc: "igImBitArraySetBit".}
proc igImBitArraySetBitRange*(arr: ptr ImU32; n: cint; n2: cint): void {.cdecl, importc: "igImBitArraySetBitRange".}
proc ImBitVector_Create*(self: ptr ImBitVector; sz: cint): void {.cdecl, importc: "ImBitVector_Create".}
proc ImBitVector_Clear*(self: ptr ImBitVector): void {.cdecl, importc: "ImBitVector_Clear".}
proc ImBitVector_TestBit*(self: ptr ImBitVector; n: cint): bool {.cdecl, importc: "ImBitVector_TestBit".}
proc ImBitVector_SetBit*(self: ptr ImBitVector; n: cint): void {.cdecl, importc: "ImBitVector_SetBit".}
proc ImBitVector_ClearBit*(self: ptr ImBitVector; n: cint): void {.cdecl, importc: "ImBitVector_ClearBit".}
proc ImGuiTextIndex_clear*(self: ptr ImGuiTextIndex): void {.cdecl, importc: "ImGuiTextIndex_clear".}
proc ImGuiTextIndex_size*(self: ptr ImGuiTextIndex): cint {.cdecl, importc: "ImGuiTextIndex_size".}
...
proc ImDrawListSharedData_SetCircleTessellationMaxError*(self: ptr ImDrawListSharedData; max_error: cfloat): void {.cdecl, importc: "ImDrawListSharedData_SetCircleTessellationMaxError".}
proc ImDrawDataBuilder_ImDrawDataBuilder*(): ptr ImDrawDataBuilder {.cdecl, importc: "ImDrawDataBuilder_ImDrawDataBuilder".}
proc ImDrawDataBuilder_destroy*(self: ptr ImDrawDataBuilder): void {.cdecl, importc: "ImDrawDataBuilder_destroy".}
proc ImGuiStyleVarInfo_GetVarPtr*(self: ptr ImGuiStyleVarInfo; parent: pointer): pointer {.cdecl, importc: "ImGuiStyleVarInfo_GetVarPtr".}
...
proc ImGuiMenuColumns_destroy*(self: ptr ImGuiMenuColumns): void {.cdecl, importc: "ImGuiMenuColumns_destroy".}
proc ImGuiMenuColumns_Update*(self: ptr ImGuiMenuColumns; spacing: cfloat; window_reappearing: bool): void {.cdecl, importc: "ImGuiMenuColumns_Update".}
proc ImGuiMenuColumns_DeclColumns*(self: ptr ImGuiMenuColumns; w_icon: cfloat; w_label: cfloat; w_shortcut: cfloat; w_mark: cfloat): cfloat {.cdecl, importc: "ImGuiMenuColumns_DeclColumns".}
proc ImGuiMenuColumns_CalcNextTotalWidth*(self: ptr ImGuiMenuColumns; update_offsets: bool): void {.cdecl, importc: "ImGuiMenuColumns_CalcNextTotalWidth".}
proc ImGuiInputTextDeactivatedState_ImGuiInputTextDeactivatedState*(): ptr ImGuiInputTextDeactivatedState {.cdecl, importc: "ImGuiInputTextDeactivatedState_ImGuiInputTextDeactivatedState".}
proc ImGuiInputTextDeactivatedState_destroy*(self: ptr ImGuiInputTextDeactivatedState): void {.cdecl, importc: "ImGuiInputTextDeactivatedState_destroy".}
proc ImGuiInputTextDeactivatedState_ClearFreeMemory*(self: ptr ImGuiInputTextDeactivatedState): void {.cdecl, importc: "ImGuiInputTextDeactivatedState_ClearFreeMemory".}
proc ImGuiInputTextState_ImGuiInputTextState*(): ptr ImGuiInputTextState {.cdecl, importc: "ImGuiInputTextState_ImGuiInputTextState".}
proc ImGuiInputTextState_destroy*(self: ptr ImGuiInputTextState): void {.cdecl, importc: "ImGuiInputTextState_destroy".}
proc ImGuiInputTextState_ClearText*(self: ptr ImGuiInputTextState): void {.cdecl, importc: "ImGuiInputTextState_ClearText".}
...
proc ImGuiInputTextState_GetText*(self: ptr ImGuiInputTextState): cstring {.cdecl, importc: "ImGuiInputTextState_GetText".}
...
proc ImGuiInputTextState_ClearSelection*(self: ptr ImGuiInputTextState): void {.cdecl, importc: "ImGuiInputTextState_ClearSelection".}
...
proc ImGuiInputTextState_ReloadUserBufAndMoveToEnd*(self: ptr ImGuiInputTextState): void {.cdecl, importc: "ImGuiInputTextState_ReloadUserBufAndMoveToEnd".}
proc ImGuiNextWindowData_ImGuiNextWindowData*(): ptr ImGuiNextWindowData {.cdecl, importc: "ImGuiNextWindowData_ImGuiNextWindowData".}
proc ImGuiNextWindowData_destroy*(self: ptr ImGuiNextWindowData): void {.cdecl, importc: "ImGuiNextWindowData_destroy".}
proc ImGuiNextWindowData_ClearFlags*(self: ptr ImGuiNextWindowData): void {.cdecl, importc: "ImGuiNextWindowData_ClearFlags".}
proc ImGuiNextItemData_ImGuiNextItemData*(): ptr ImGuiNextItemData {.cdecl, importc: "ImGuiNextItemData_ImGuiNextItemData".}
proc ImGuiNextItemData_destroy*(self: ptr ImGuiNextItemData): void {.cdecl, importc: "ImGuiNextItemData_destroy".}
proc ImGuiNextItemData_ClearFlags*(self: ptr ImGuiNextItemData): void {.cdecl, importc: "ImGuiNextItemData_ClearFlags".}
proc ImGuiLastItemData_ImGuiLastItemData*(): ptr ImGuiLastItemData {.cdecl, importc: "ImGuiLastItemData_ImGuiLastItemData".}
proc ImGuiLastItemData_destroy*(self: ptr ImGuiLastItemData): void {.cdecl, importc: "ImGuiLastItemData_destroy".}
proc ImGuiErrorRecoveryState_ImGuiErrorRecoveryState*(): ptr ImGuiErrorRecoveryState {.cdecl, importc: "ImGuiErrorRecoveryState_ImGuiErrorRecoveryState".}
proc ImGuiErrorRecoveryState_destroy*(self: ptr ImGuiErrorRecoveryState): void {.cdecl, importc: "ImGuiErrorRecoveryState_destroy".}
proc ImGuiPtrOrIndex_ImGuiPtrOrIndex_Ptr*(ptr_arg: pointer): ptr ImGuiPtrOrIndex {.cdecl, importc: "ImGuiPtrOrIndex_ImGuiPtrOrIndex_Ptr".}
proc ImGuiPtrOrIndex_destroy*(self: ptr ImGuiPtrOrIndex): void {.cdecl, importc: "ImGuiPtrOrIndex_destroy".}
proc ImGuiPtrOrIndex_ImGuiPtrOrIndex_Int*(index: cint): ptr ImGuiPtrOrIndex {.cdecl, importc: "ImGuiPtrOrIndex_ImGuiPtrOrIndex_Int".}
proc ImGuiPopupData_ImGuiPopupData*(): ptr ImGuiPopupData {.cdecl, importc: "ImGuiPopupData_ImGuiPopupData".}
proc ImGuiPopupData_destroy*(self: ptr ImGuiPopupData): void {.cdecl, importc: "ImGuiPopupData_destroy".}
proc ImGuiInputEvent_ImGuiInputEvent*(): ptr ImGuiInputEvent {.cdecl, importc: "ImGuiInputEvent_ImGuiInputEvent".}
proc ImGuiInputEvent_destroy*(self: ptr ImGuiInputEvent): void {.cdecl, importc: "ImGuiInputEvent_destroy".}
proc ImGuiKeyRoutingData_ImGuiKeyRoutingData*(): ptr ImGuiKeyRoutingData {.cdecl, importc: "ImGuiKeyRoutingData_ImGuiKeyRoutingData".}
proc ImGuiKeyRoutingData_destroy*(self: ptr ImGuiKeyRoutingData): void {.cdecl, importc: "ImGuiKeyRoutingData_destroy".}
proc ImGuiKeyRoutingTable_ImGuiKeyRoutingTable*(): ptr ImGuiKeyRoutingTable {.cdecl, importc: "ImGuiKeyRoutingTable_ImGuiKeyRoutingTable".}
proc ImGuiKeyRoutingTable_destroy*(self: ptr ImGuiKeyRoutingTable): void {.cdecl, importc: "ImGuiKeyRoutingTable_destroy".}
proc ImGuiKeyRoutingTable_Clear*(self: ptr ImGuiKeyRoutingTable): void {.cdecl, importc: "ImGuiKeyRoutingTable_Clear".}
proc ImGuiKeyOwnerData_ImGuiKeyOwnerData*(): ptr ImGuiKeyOwnerData {.cdecl, importc: "ImGuiKeyOwnerData_ImGuiKeyOwnerData".}
proc ImGuiKeyOwnerData_destroy*(self: ptr ImGuiKeyOwnerData): void {.cdecl, importc: "ImGuiKeyOwnerData_destroy".}
proc ImGuiListClipperRange_FromIndices*(min: cint; max: cint): ImGuiListClipperRange {.cdecl, importc: "ImGuiListClipperRange_FromIndices".}
proc ImGuiListClipperRange_FromPositions*(y1: cfloat; y2: cfloat; off_min: cint; off_max: cint): ImGuiListClipperRange {.cdecl, importc: "ImGuiListClipperRange_FromPositions".}
proc ImGuiListClipperData_ImGuiListClipperData*(): ptr ImGuiListClipperData {.cdecl, importc: "ImGuiListClipperData_ImGuiListClipperData".}
proc ImGuiListClipperData_destroy*(self: ptr ImGuiListClipperData): void {.cdecl, importc: "ImGuiListClipperData_destroy".}
proc ImGuiListClipperData_Reset*(self: ptr ImGuiListClipperData; clipper: ptr ImGuiListClipper): void {.cdecl, importc: "ImGuiListClipperData_Reset".}
proc ImGuiNavItemData_ImGuiNavItemData*(): ptr ImGuiNavItemData {.cdecl, importc: "ImGuiNavItemData_ImGuiNavItemData".}
proc ImGuiNavItemData_destroy*(self: ptr ImGuiNavItemData): void {.cdecl, importc: "ImGuiNavItemData_destroy".}
proc ImGuiNavItemData_Clear*(self: ptr ImGuiNavItemData): void {.cdecl, importc: "ImGuiNavItemData_Clear".}
proc ImGuiTypingSelectState_ImGuiTypingSelectState*(): ptr ImGuiTypingSelectState {.cdecl, importc: "ImGuiTypingSelectState_ImGuiTypingSelectState".}
proc ImGuiTypingSelectState_destroy*(self: ptr ImGuiTypingSelectState): void {.cdecl, importc: "ImGuiTypingSelectState_destroy".}
proc ImGuiTypingSelectState_Clear*(self: ptr ImGuiTypingSelectState): void {.cdecl, importc: "ImGuiTypingSelectState_Clear".}
proc ImGuiOldColumnData_ImGuiOldColumnData*(): ptr ImGuiOldColumnData {.cdecl, importc: "ImGuiOldColumnData_ImGuiOldColumnData".}
proc ImGuiOldColumnData_destroy*(self: ptr ImGuiOldColumnData): void {.cdecl, importc: "ImGuiOldColumnData_destroy".}
proc ImGuiOldColumns_ImGuiOldColumns*(): ptr ImGuiOldColumns {.cdecl, importc: "ImGuiOldColumns_ImGuiOldColumns".}
proc ImGuiOldColumns_destroy*(self: ptr ImGuiOldColumns): void {.cdecl, importc: "ImGuiOldColumns_destroy".}
proc ImGuiBoxSelectState_ImGuiBoxSelectState*(): ptr ImGuiBoxSelectState {.cdecl, importc: "ImGuiBoxSelectState_ImGuiBoxSelectState".}
proc ImGuiBoxSelectState_destroy*(self: ptr ImGuiBoxSelectState): void {.cdecl, importc: "ImGuiBoxSelectState_destroy".}
proc ImGuiMultiSelectTempData_ImGuiMultiSelectTempData*(): ptr ImGuiMultiSelectTempData {.cdecl, importc: "ImGuiMultiSelectTempData_ImGuiMultiSelectTempData".}
proc ImGuiMultiSelectTempData_destroy*(self: ptr ImGuiMultiSelectTempData): void {.cdecl, importc: "ImGuiMultiSelectTempData_destroy".}
proc ImGuiMultiSelectTempData_Clear*(self: ptr ImGuiMultiSelectTempData): void {.cdecl, importc: "ImGuiMultiSelectTempData_Clear".}
proc ImGuiMultiSelectTempData_ClearIO*(self: ptr ImGuiMultiSelectTempData): void {.cdecl, importc: "ImGuiMultiSelectTempData_ClearIO".}
proc ImGuiMultiSelectState_ImGuiMultiSelectState*(): ptr ImGuiMultiSelectState {.cdecl, importc: "ImGuiMultiSelectState_ImGuiMultiSelectState".}
proc ImGuiMultiSelectState_destroy*(self: ptr ImGuiMultiSelectState): void {.cdecl, importc: "ImGuiMultiSelectState_destroy".}
proc ImGuiDockNode_ImGuiDockNode*(id: ImGuiID): ptr ImGuiDockNode {.cdecl, importc: "ImGuiDockNode_ImGuiDockNode".}
proc ImGuiDockNode_destroy*(self: ptr ImGuiDockNode): void {.cdecl, importc: "ImGuiDockNode_destroy".}
proc ImGuiDockNode_IsRootNode*(self: ptr ImGuiDockNode): bool {.cdecl, importc: "ImGuiDockNode_IsRootNode".}
proc ImGuiDockNode_IsDockSpace*(self: ptr ImGuiDockNode): bool {.cdecl, importc: "ImGuiDockNode_IsDockSpace".}
proc ImGuiDockNode_IsFloatingNode*(self: ptr ImGuiDockNode): bool {.cdecl, importc: "ImGuiDockNode_IsFloatingNode".}
proc ImGuiDockNode_IsCentralNode*(self: ptr ImGuiDockNode): bool {.cdecl, importc: "ImGuiDockNode_IsCentralNode".}
proc ImGuiDockNode_IsHiddenTabBar*(self: ptr ImGuiDockNode): bool {.cdecl, importc: "ImGuiDockNode_IsHiddenTabBar".}
proc ImGuiDockNode_IsNoTabBar*(self: ptr ImGuiDockNode): bool {.cdecl, importc: "ImGuiDockNode_IsNoTabBar".}
...
proc ImGuiDockContext_destroy*(self: ptr ImGuiDockContext): void {.cdecl, importc: "ImGuiDockContext_destroy".}
...
proc ImGuiSettingsHandler_ImGuiSettingsHandler*(): ptr ImGuiSettingsHandler {.cdecl, importc: "ImGuiSettingsHandler_ImGuiSettingsHandler".}
proc ImGuiSettingsHandler_destroy*(self: ptr ImGuiSettingsHandler): void {.cdecl, importc: "ImGuiSettingsHandler_destroy".}
proc ImGuiDebugAllocInfo_ImGuiDebugAllocInfo*(): ptr ImGuiDebugAllocInfo {.cdecl, importc: "ImGuiDebugAllocInfo_ImGuiDebugAllocInfo".}
...
proc ImGuiContextHook_destroy*(self: ptr ImGuiContextHook): void {.cdecl, importc: "ImGuiContextHook_destroy".}
proc ImGuiContext_ImGuiContext*(shared_font_atlas: ptr ImFontAtlas): ptr ImGuiContext {.cdecl, importc: "ImGuiContext_ImGuiContext".}
proc ImGuiContext_destroy*(self: ptr ImGuiContext): void {.cdecl, importc: "ImGuiContext_destroy".}
proc ImGuiWindow_ImGuiWindow*(context: ptr ImGuiContext; name: cstring): ptr ImGuiWindow {.cdecl, importc: "ImGuiWindow_ImGuiWindow".}
proc ImGuiWindow_destroy*(self: ptr ImGuiWindow): void {.cdecl, importc: "ImGuiWindow_destroy".}
...
proc ImGuiTabBar_destroy*(self: ptr ImGuiTabBar): void {.cdecl, importc: "ImGuiTabBar_destroy".}
proc ImGuiTableColumn_ImGuiTableColumn*(): ptr ImGuiTableColumn {.cdecl, importc: "ImGuiTableColumn_ImGuiTableColumn".}
proc ImGuiTableColumn_destroy*(self: ptr ImGuiTableColumn): void {.cdecl, importc: "ImGuiTableColumn_destroy".}
proc ImGuiTableInstanceData_ImGuiTableInstanceData*(): ptr ImGuiTableInstanceData {.cdecl, importc: "ImGuiTableInstanceData_ImGuiTableInstanceData".}
proc ImGuiTableInstanceData_destroy*(self: ptr ImGuiTableInstanceData): void {.cdecl, importc: "ImGuiTableInstanceData_destroy".}
proc ImGuiTable_ImGuiTable*(): ptr ImGuiTable {.cdecl, importc: "ImGuiTable_ImGuiTable".}
proc ImGuiTable_destroy*(self: ptr ImGuiTable): void {.cdecl, importc: "ImGuiTable_destroy".}
proc ImGuiTableTempData_ImGuiTableTempData*(): ptr ImGuiTableTempData {.cdecl, importc: "ImGuiTableTempData_ImGuiTableTempData".}
proc ImGuiTableTempData_destroy*(self: ptr ImGuiTableTempData): void {.cdecl, importc: "ImGuiTableTempData_destroy".}
proc ImGuiTableColumnSettings_ImGuiTableColumnSettings*(): ptr ImGuiTableColumnSettings {.cdecl, importc: "ImGuiTableColumnSettings_ImGuiTableColumnSettings".}
proc ImGuiTableColumnSettings_destroy*(self: ptr ImGuiTableColumnSettings): void {.cdecl, importc: "ImGuiTableColumnSettings_destroy".}
...
proc igBringWindowToDisplayFront*(window: ptr ImGuiWindow): void {.cdecl, importc: "igBringWindowToDisplayFront".}
proc igBringWindowToDisplayBack*(window: ptr ImGuiWindow): void {.cdecl, importc: "igBringWindowToDisplayBack".}
proc igBringWindowToDisplayBehind*(window: ptr ImGuiWindow; above_window: ptr ImGuiWindow): void {.cdecl, importc: "igBringWindowToDisplayBehind".}
proc igFindWindowDisplayIndex*(window: ptr ImGuiWindow): cint {.cdecl, importc: "igFindWindowDisplayIndex".}
proc igFindBottomMostVisibleWindowWithinBeginStack*(window: ptr ImGuiWindow): ptr ImGuiWindow {.cdecl, importc: "igFindBottomMostVisibleWindowWithinBeginStack".}
proc igSetNextWindowRefreshPolicy*(flags: ImGuiWindowRefreshFlags): void {.cdecl, importc: "igSetNextWindowRefreshPolicy".}
proc igRegisterUserTexture*(tex: ptr ImTextureData): void {.cdecl, importc: "igRegisterUserTexture".}
proc igUnregisterUserTexture*(tex: ptr ImTextureData): void {.cdecl, importc: "igUnregisterUserTexture".}
proc igRegisterFontAtlas*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igRegisterFontAtlas".}
proc igUnregisterFontAtlas*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igUnregisterFontAtlas".}
proc igSetCurrentFont*(font: ptr ImFont; font_size_before_scaling: cfloat; font_size_after_scaling: cfloat): void {.cdecl, importc: "igSetCurrentFont".}
proc igUpdateCurrentFontSize*(restore_font_size_after_scaling: cfloat): void {.cdecl, importc: "igUpdateCurrentFontSize".}
proc igSetFontRasterizerDensity*(rasterizer_density: cfloat): void {.cdecl, importc: "igSetFontRasterizerDensity".}
proc igGetFontRasterizerDensity*(): cfloat {.cdecl, importc: "igGetFontRasterizerDensity".}
proc igGetRoundedFontSize*(size: cfloat): cfloat {.cdecl, importc: "igGetRoundedFontSize".}
...
proc igPopPasswordFont*(): void {.cdecl, importc: "igPopPasswordFont".}
proc igGetForegroundDrawList_WindowPtr*(window: ptr ImGuiWindow): ptr ImDrawList {.cdecl, importc: "igGetForegroundDrawList_WindowPtr".}
...
proc igCreateNewWindowSettings*(name: cstring): ptr ImGuiWindowSettings {.cdecl, importc: "igCreateNewWindowSettings".}
proc igFindWindowSettingsByID*(id: ImGuiID): ptr ImGuiWindowSettings {.cdecl, importc: "igFindWindowSettingsByID".}
proc igFindWindowSettingsByWindow*(window: ptr ImGuiWindow): ptr ImGuiWindowSettings {.cdecl, importc: "igFindWindowSettingsByWindow".}
proc igClearWindowSettings*(name: cstring): void {.cdecl, importc: "igClearWindowSettings".}
proc igLocalizeRegisterEntries*(entries: ptr ImGuiLocEntry; count: cint): void {.cdecl, importc: "igLocalizeRegisterEntries".}
proc igLocalizeGetMsg*(key: ImGuiLocKey): cstring {.cdecl, importc: "igLocalizeGetMsg".}
proc igSetScrollX_WindowPtr*(window: ptr ImGuiWindow; scroll_x: cfloat): void {.cdecl, importc: "igSetScrollX_WindowPtr".}
proc igSetScrollY_WindowPtr*(window: ptr ImGuiWindow; scroll_y: cfloat): void {.cdecl, importc: "igSetScrollY_WindowPtr".}
...
proc igSetFocusID*(id: ImGuiID; window: ptr ImGuiWindow): void {.cdecl, importc: "igSetFocusID".}
...
proc igIsPopupOpenRequestForItem*(flags: ImGuiPopupFlags; id: ImGuiID): bool {.cdecl, importc: "igIsPopupOpenRequestForItem".}
proc igIsPopupOpenRequestForWindow*(flags: ImGuiPopupFlags): bool {.cdecl, importc: "igIsPopupOpenRequestForWindow".}
...
proc igNavInitRequestApplyResult*(): void {.cdecl, importc: "igNavInitRequestApplyResult".}
proc igNavMoveRequestButNoResultYet*(): bool {.cdecl, importc: "igNavMoveRequestButNoResultYet".}
proc igNavMoveRequestSubmit*(move_dir: ImGuiDir; clip_dir: ImGuiDir; move_flags: ImGuiNavMoveFlags; scroll_flags: ImGuiScrollFlags): void {.cdecl, importc: "igNavMoveRequestSubmit".}
proc igNavMoveRequestForward*(move_dir: ImGuiDir; clip_dir: ImGuiDir; move_flags: ImGuiNavMoveFlags; scroll_flags: ImGuiScrollFlags): void {.cdecl, importc: "igNavMoveRequestForward".}
proc igNavMoveRequestResolveWithLastItem*(result: ptr ImGuiNavItemData): void {.cdecl, importc: "igNavMoveRequestResolveWithLastItem".}
proc igNavMoveRequestResolveWithPastTreeNode*(result: ptr ImGuiNavItemData; tree_node_data: ptr ImGuiTreeNodeStackData): void {.cdecl, importc: "igNavMoveRequestResolveWithPastTreeNode".}
proc igNavMoveRequestCancel*(): void {.cdecl, importc: "igNavMoveRequestCancel".}
proc igNavMoveRequestApplyResult*(): void {.cdecl, importc: "igNavMoveRequestApplyResult".}
proc igNavMoveRequestTryWrapping*(window: ptr ImGuiWindow; move_flags: ImGuiNavMoveFlags): void {.cdecl, importc: "igNavMoveRequestTryWrapping".}
proc igNavHighlightActivated*(id: ImGuiID): void {.cdecl, importc: "igNavHighlightActivated".}
proc igNavClearPreferredPosForAxis*(axis: ImGuiAxis): void {.cdecl, importc: "igNavClearPreferredPosForAxis".}
...
proc igIsNamedKeyOrMod*(key: ImGuiKey): bool {.cdecl, importc: "igIsNamedKeyOrMod".}
...
proc igFixupKeyChord*(key_chord: ImGuiKeyChord): ImGuiKeyChord {.cdecl, importc: "igFixupKeyChord".}
proc igConvertSingleModFlagToKey*(key: ImGuiKey): ImGuiKey {.cdecl, importc: "igConvertSingleModFlagToKey".}
proc igGetKeyData_ContextPtr*(ctx: ptr ImGuiContext; key: ImGuiKey): ptr ImGuiKeyData {.cdecl, importc: "igGetKeyData_ContextPtr".}
proc igGetKeyData_Key*(key: ImGuiKey): ptr ImGuiKeyData {.cdecl, importc: "igGetKeyData_Key".}
...
proc igSetKeyOwner*(key: ImGuiKey; owner_id: ImGuiID; flags: ImGuiInputFlags): void {.cdecl, importc: "igSetKeyOwner".}
proc igSetKeyOwnersForKeyChord*(key: ImGuiKeyChord; owner_id: ImGuiID; flags: ImGuiInputFlags): void {.cdecl, importc: "igSetKeyOwnersForKeyChord".}
proc igSetItemKeyOwner_InputFlags*(key: ImGuiKey; flags: ImGuiInputFlags): bool {.cdecl, importc: "igSetItemKeyOwner_InputFlags".}
proc igTestKeyOwner*(key: ImGuiKey; owner_id: ImGuiID): bool {.cdecl, importc: "igTestKeyOwner".}
proc igGetKeyOwnerData*(ctx: ptr ImGuiContext; key: ImGuiKey): ptr ImGuiKeyOwnerData {.cdecl, importc: "igGetKeyOwnerData".}
proc igIsKeyDown_ID*(key: ImGuiKey; owner_id: ImGuiID): bool {.cdecl, importc: "igIsKeyDown_ID".}
proc igIsKeyPressed_InputFlags*(key: ImGuiKey; flags: ImGuiInputFlags; owner_id: ImGuiID): bool {.cdecl, importc: "igIsKeyPressed_InputFlags".}
proc igIsKeyReleased_ID*(key: ImGuiKey; owner_id: ImGuiID): bool {.cdecl, importc: "igIsKeyReleased_ID".}
proc igIsKeyChordPressed_InputFlags*(key_chord: ImGuiKeyChord; flags: ImGuiInputFlags; owner_id: ImGuiID): bool {.cdecl, importc: "igIsKeyChordPressed_InputFlags".}
proc igIsMouseDown_ID*(button: ImGuiMouseButton; owner_id: ImGuiID): bool {.cdecl, importc: "igIsMouseDown_ID".}
proc igIsMouseClicked_InputFlags*(button: ImGuiMouseButton; flags: ImGuiInputFlags; owner_id: ImGuiID): bool {.cdecl, importc: "igIsMouseClicked_InputFlags".}
proc igIsMouseReleased_ID*(button: ImGuiMouseButton; owner_id: ImGuiID): bool {.cdecl, importc: "igIsMouseReleased_ID".}
proc igIsMouseDoubleClicked_ID*(button: ImGuiMouseButton; owner_id: ImGuiID): bool {.cdecl, importc: "igIsMouseDoubleClicked_ID".}
proc igShortcut_ID*(key_chord: ImGuiKeyChord; flags: ImGuiInputFlags; owner_id: ImGuiID): bool {.cdecl, importc: "igShortcut_ID".}
proc igSetShortcutRouting*(key_chord: ImGuiKeyChord; flags: ImGuiInputFlags; owner_id: ImGuiID): bool {.cdecl, importc: "igSetShortcutRouting".}
proc igTestShortcutRouting*(key_chord: ImGuiKeyChord; owner_id: ImGuiID): bool {.cdecl, importc: "igTestShortcutRouting".}
proc igGetShortcutRoutingData*(key_chord: ImGuiKeyChord): ptr ImGuiKeyRoutingData {.cdecl, importc: "igGetShortcutRoutingData".}
proc igDockContextInitialize*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igDockContextInitialize".}
proc igDockContextShutdown*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igDockContextShutdown".}
proc igDockContextClearNodes*(ctx: ptr ImGuiContext; root_id: ImGuiID; clear_settings_refs: bool): void {.cdecl, importc: "igDockContextClearNodes".}
proc igDockContextRebuildNodes*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igDockContextRebuildNodes".}
proc igDockContextNewFrameUpdateUndocking*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igDockContextNewFrameUpdateUndocking".}
proc igDockContextNewFrameUpdateDocking*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igDockContextNewFrameUpdateDocking".}
proc igDockContextEndFrame*(ctx: ptr ImGuiContext): void {.cdecl, importc: "igDockContextEndFrame".}
proc igDockContextGenNodeID*(ctx: ptr ImGuiContext): ImGuiID {.cdecl, importc: "igDockContextGenNodeID".}
proc igDockContextQueueDock*(ctx: ptr ImGuiContext; target: ptr ImGuiWindow; target_node: ptr ImGuiDockNode; payload: ptr ImGuiWindow; split_dir: ImGuiDir; split_ratio: cfloat; split_outer: bool): void {.cdecl, importc: "igDockContextQueueDock".}
proc igDockContextQueueUndockWindow*(ctx: ptr ImGuiContext; window: ptr ImGuiWindow): void {.cdecl, importc: "igDockContextQueueUndockWindow".}
...
proc igDockNodeEndAmendTabBar*(): void {.cdecl, importc: "igDockNodeEndAmendTabBar".}
proc igDockNodeGetRootNode*(node: ptr ImGuiDockNode): ptr ImGuiDockNode {.cdecl, importc: "igDockNodeGetRootNode".}
proc igDockNodeIsInHierarchyOf*(node: ptr ImGuiDockNode; parent: ptr ImGuiDockNode): bool {.cdecl, importc: "igDockNodeIsInHierarchyOf".}
proc igDockNodeGetDepth*(node: ptr ImGuiDockNode): cint {.cdecl, importc: "igDockNodeGetDepth".}
proc igDockNodeGetWindowMenuButtonId*(node: ptr ImGuiDockNode): ImGuiID {.cdecl, importc: "igDockNodeGetWindowMenuButtonId".}
proc igGetWindowDockNode*(): ptr ImGuiDockNode {.cdecl, importc: "igGetWindowDockNode".}
proc igGetWindowAlwaysWantOwnTabBar*(window: ptr ImGuiWindow): bool {.cdecl, importc: "igGetWindowAlwaysWantOwnTabBar".}
proc igBeginDocked*(window: ptr ImGuiWindow; p_open: ptr bool): void {.cdecl, importc: "igBeginDocked".}
proc igBeginDockableDragDropSource*(window: ptr ImGuiWindow): void {.cdecl, importc: "igBeginDockableDragDropSource".}
proc igBeginDockableDragDropTarget*(window: ptr ImGuiWindow): void {.cdecl, importc: "igBeginDockableDragDropTarget".}
proc igSetWindowDock*(window: ptr ImGuiWindow; dock_id: ImGuiID; cond: ImGuiCond): void {.cdecl, importc: "igSetWindowDock".}
proc igDockBuilderDockWindow*(window_name: cstring; node_id: ImGuiID): void {.cdecl, importc: "igDockBuilderDockWindow".}
proc igDockBuilderGetNode*(node_id: ImGuiID): ptr ImGuiDockNode {.cdecl, importc: "igDockBuilderGetNode".}
proc igDockBuilderGetCentralNode*(node_id: ImGuiID): ptr ImGuiDockNode {.cdecl, importc: "igDockBuilderGetCentralNode".}
proc igDockBuilderAddNode*(node_id: ImGuiID; flags: ImGuiDockNodeFlags): ImGuiID {.cdecl, importc: "igDockBuilderAddNode".}
...
proc igDockBuilderCopyWindowSettings*(src_name: cstring; dst_name: cstring): void {.cdecl, importc: "igDockBuilderCopyWindowSettings".}
proc igDockBuilderFinish*(node_id: ImGuiID): void {.cdecl, importc: "igDockBuilderFinish".}
...
proc igIsInNavFocusRoute*(focus_scope_id: ImGuiID): bool {.cdecl, importc: "igIsInNavFocusRoute".}
...
proc igRenderDragDropTargetRectEx*(draw_list: ptr ImDrawList; bb: ImRect_c; rounding: cfloat): void {.cdecl, importc: "igRenderDragDropTargetRectEx".}
...
proc igTabBarGetCurrentTab*(tab_bar: ptr ImGuiTabBar): ptr ImGuiTabItem {.cdecl, importc: "igTabBarGetCurrentTab".}
proc igTabBarGetTabOrder*(tab_bar: ptr ImGuiTabBar; tab: ptr ImGuiTabItem): cint {.cdecl, importc: "igTabBarGetTabOrder".}
proc igTabBarGetTabName*(tab_bar: ptr ImGuiTabBar; tab: ptr ImGuiTabItem): cstring {.cdecl, importc: "igTabBarGetTabName".}
proc igTabBarAddTab*(tab_bar: ptr ImGuiTabBar; tab_flags: ImGuiTabItemFlags; window: ptr ImGuiWindow): void {.cdecl, importc: "igTabBarAddTab".}
proc igTabBarRemoveTab*(tab_bar: ptr ImGuiTabBar; tab_id: ImGuiID): void {.cdecl, importc: "igTabBarRemoveTab".}
proc igTabBarCloseTab*(tab_bar: ptr ImGuiTabBar; tab: ptr ImGuiTabItem): void {.cdecl, importc: "igTabBarCloseTab".}
...
proc igExtendHitBoxWhenNearViewportEdge*(window: ptr ImGuiWindow; bb: ptr ImRect; threshold: cfloat; axis: ImGuiAxis): void {.cdecl, importc: "igExtendHitBoxWhenNearViewportEdge".}
...
proc igTreeNodeSetOpen*(storage_id: ImGuiID; open: bool): void {.cdecl, importc: "igTreeNodeSetOpen".}
proc igTreeNodeUpdateNextOpen*(storage_id: ImGuiID; flags: ImGuiTreeNodeFlags): bool {.cdecl, importc: "igTreeNodeUpdateNextOpen".}
proc igDataTypeGetInfo*(data_type: ImGuiDataType): ptr ImGuiDataTypeInfo {.cdecl, importc: "igDataTypeGetInfo".}
proc igDataTypeFormatString*(buf: cstring; buf_size: cint; data_type: ImGuiDataType; p_data: pointer; format: cstring): cint {.cdecl, importc: "igDataTypeFormatString".}
proc igDataTypeApplyOp*(data_type: ImGuiDataType; op: cint; output: pointer; arg_1: pointer; arg_2: pointer): void {.cdecl, importc: "igDataTypeApplyOp".}
proc igDataTypeApplyFromText*(buf: cstring; data_type: ImGuiDataType; p_data: pointer; format: cstring; p_data_when_empty: pointer): bool {.cdecl, importc: "igDataTypeApplyFromText".}
...
proc igTempInputText*(bb: ImRect_c; id: ImGuiID; label: cstring; buf: cstring; buf_size: csize_t; flags: ImGuiInputTextFlags; callback: ImGuiInputTextCallback; user_data: pointer): bool {.cdecl, importc: "igTempInputText".}
...
proc igIsItemActiveAsInputText*(): bool {.cdecl, importc: "igIsItemActiveAsInputText".}
...
proc igErrorRecoveryStoreState*(state_out: ptr ImGuiErrorRecoveryState): void {.cdecl, importc: "igErrorRecoveryStoreState".}
proc igErrorRecoveryTryToRecoverState*(state_in: ptr ImGuiErrorRecoveryState): void {.cdecl, importc: "igErrorRecoveryTryToRecoverState".}
proc igErrorRecoveryTryToRecoverWindowState*(state_in: ptr ImGuiErrorRecoveryState): void {.cdecl, importc: "igErrorRecoveryTryToRecoverWindowState".}
proc igErrorCheckUsingSetCursorPosToExtendParentBoundaries*(): void {.cdecl, importc: "igErrorCheckUsingSetCursorPosToExtendParentBoundaries".}
proc igErrorCheckEndFrameFinalizeErrorTooltip*(): void {.cdecl, importc: "igErrorCheckEndFrameFinalizeErrorTooltip".}
...
proc igDemoMarker*(file: cstring; line: cint; section: cstring): void {.cdecl, importc: "igDemoMarker".}
proc igDebugAllocHook*(info: ptr ImGuiDebugAllocInfo; frame_count: cint; ptr_arg: pointer; size: csize_t): void {.cdecl, importc: "igDebugAllocHook".}
proc igDebugDrawCursorPos*(col: ImU32): void {.cdecl, importc: "igDebugDrawCursorPos".}
proc igDebugDrawLineExtents*(col: ImU32): void {.cdecl, importc: "igDebugDrawLineExtents".}
proc igDebugDrawItemRect*(col: ImU32): void {.cdecl, importc: "igDebugDrawItemRect".}
proc igDebugTextUnformattedWithLocateItem*(line_begin: cstring; line_end: cstring): void {.cdecl, importc: "igDebugTextUnformattedWithLocateItem".}
proc igDebugLocateItem*(target_id: ImGuiID): void {.cdecl, importc: "igDebugLocateItem".}
proc igDebugLocateItemOnHover*(target_id: ImGuiID): void {.cdecl, importc: "igDebugLocateItemOnHover".}
proc igDebugLocateItemResolveWithLastItem*(): void {.cdecl, importc: "igDebugLocateItemResolveWithLastItem".}
...
proc igDebugNodeDrawList*(window: ptr ImGuiWindow; viewport: ptr ImGuiViewportP; draw_list: ptr ImDrawList; label: cstring): void {.cdecl, importc: "igDebugNodeDrawList".}
proc igDebugNodeDrawCmdShowMeshAndBoundingBox*(out_draw_list: ptr ImDrawList; draw_list: ptr ImDrawList; draw_cmd: ptr ImDrawCmd; show_mesh: bool; show_aabb: bool): void {.cdecl, importc: "igDebugNodeDrawCmdShowMeshAndBoundingBox".}
proc igDebugNodeFont*(font: ptr ImFont): void {.cdecl, importc: "igDebugNodeFont".}
proc igDebugNodeFontGlyphsForSrcMask*(font: ptr ImFont; baked: ptr ImFontBaked; src_mask: cint): void {.cdecl, importc: "igDebugNodeFontGlyphsForSrcMask".}
proc igDebugNodeFontGlyph*(font: ptr ImFont; glyph: ptr ImFontGlyph): void {.cdecl, importc: "igDebugNodeFontGlyph".}
proc igDebugNodeTexture*(tex: ptr ImTextureData; int_id: cint; highlight_rect: ptr ImFontAtlasRect): void {.cdecl, importc: "igDebugNodeTexture".}
...
proc igDebugNodeWindow*(window: ptr ImGuiWindow; label: cstring): void {.cdecl, importc: "igDebugNodeWindow".}
proc igDebugNodeWindowSettings*(settings: ptr ImGuiWindowSettings): void {.cdecl, importc: "igDebugNodeWindowSettings".}
proc igDebugNodeWindowsList*(windows: ptr ImVector_ImGuiWindowPtr; label: cstring): void {.cdecl, importc: "igDebugNodeWindowsList".}
proc igDebugNodeWindowsListByBeginStackParent*(windows: ptr ptr ImGuiWindow; windows_size: cint; parent_in_begin_stack: ptr ImGuiWindow): void {.cdecl, importc: "igDebugNodeWindowsListByBeginStackParent".}
...
proc igImFontAtlasBuildInit*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igImFontAtlasBuildInit".}
...
proc igImFontAtlasTextureAdd*(atlas: ptr ImFontAtlas; w: cint; h: cint): ptr ImTextureData {.cdecl, importc: "igImFontAtlasTextureAdd".}
proc igImFontAtlasTextureMakeSpace*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igImFontAtlasTextureMakeSpace".}
...
proc igImFontAtlasBuildDiscardBakes*(atlas: ptr ImFontAtlas; unused_frames: cint): void {.cdecl, importc: "igImFontAtlasBuildDiscardBakes".}
proc igImFontAtlasFontSourceInit*(atlas: ptr ImFontAtlas; src: ptr ImFontConfig): bool {.cdecl, importc: "igImFontAtlasFontSourceInit".}
proc igImFontAtlasFontSourceAddToFont*(atlas: ptr ImFontAtlas; font: ptr ImFont; src: ptr ImFontConfig): void {.cdecl, importc: "igImFontAtlasFontSourceAddToFont".}
...
proc igImFontAtlasBakedGetClosestMatch*(atlas: ptr ImFontAtlas; font: ptr ImFont; font_size: cfloat; font_rasterizer_density: cfloat): ptr ImFontBaked {.cdecl, importc: "igImFontAtlasBakedGetClosestMatch".}
proc igImFontAtlasBakedAdd*(atlas: ptr ImFontAtlas; font: ptr ImFont; font_size: cfloat; font_rasterizer_density: cfloat; baked_id: ImGuiID): ptr ImFontBaked {.cdecl, importc: "igImFontAtlasBakedAdd".}
proc igImFontAtlasBakedDiscard*(atlas: ptr ImFontAtlas; font: ptr ImFont; baked: ptr ImFontBaked): void {.cdecl, importc: "igImFontAtlasBakedDiscard".}
proc igImFontAtlasBakedAddFontGlyph*(atlas: ptr ImFontAtlas; baked: ptr ImFontBaked; src: ptr ImFontConfig; in_glyph: ptr ImFontGlyph): ptr ImFontGlyph {.cdecl, importc: "igImFontAtlasBakedAddFontGlyph".}
proc igImFontAtlasBakedAddFontGlyphAdvancedX*(atlas: ptr ImFontAtlas; baked: ptr ImFontBaked; src: ptr ImFontConfig; codepoint: ImWchar; advance_x: cfloat): void {.cdecl, importc: "igImFontAtlasBakedAddFontGlyphAdvancedX".}
proc igImFontAtlasBakedDiscardFontGlyph*(atlas: ptr ImFontAtlas; font: ptr ImFont; baked: ptr ImFontBaked; glyph: ptr ImFontGlyph): void {.cdecl, importc: "igImFontAtlasBakedDiscardFontGlyph".}
proc igImFontAtlasBakedSetFontGlyphBitmap*(atlas: ptr ImFontAtlas; baked: ptr ImFontBaked; src: ptr ImFontConfig; glyph: ptr ImFontGlyph; r: ptr ImTextureRect; src_pixels: ptr uint8; src_fmt: ImTextureFormat; src_pitch: cint): void {.cdecl, importc: "igImFontAtlasBakedSetFontGlyphBitmap".}
proc igImFontAtlasPackInit*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igImFontAtlasPackInit".}
proc igImFontAtlasPackAddRect*(atlas: ptr ImFontAtlas; w: cint; h: cint; overwrite_entry: ptr ImFontAtlasRectEntry): ImFontAtlasRectId {.cdecl, importc: "igImFontAtlasPackAddRect".}
proc igImFontAtlasPackGetRect*(atlas: ptr ImFontAtlas; id: ImFontAtlasRectId): ptr ImTextureRect {.cdecl, importc: "igImFontAtlasPackGetRect".}
proc igImFontAtlasPackGetRectSafe*(atlas: ptr ImFontAtlas; id: ImFontAtlasRectId): ptr ImTextureRect {.cdecl, importc: "igImFontAtlasPackGetRectSafe".}
proc igImFontAtlasPackDiscardRect*(atlas: ptr ImFontAtlas; id: ImFontAtlasRectId): void {.cdecl, importc: "igImFontAtlasPackDiscardRect".}
...
proc igImFontAtlasTextureBlockPostProcessMultiply*(data: ptr ImFontAtlasPostProcessData; multiply_factor: cfloat): void {.cdecl, importc: "igImFontAtlasTextureBlockPostProcessMultiply".}
...
proc ImVector_ImWchar_create*(): ptr ImVector_ImWchar {.cdecl, importc: "ImVector_ImWchar_create".}
proc ImVector_ImWchar_destroy*(self: ptr ImVector_ImWchar): void {.cdecl, importc: "ImVector_ImWchar_destroy".}
proc ImVector_ImWchar_Init*(p: ptr ImVector_ImWchar): void {.cdecl, importc: "ImVector_ImWchar_Init".}
proc ImVector_ImWchar_UnInit*(p: ptr ImVector_ImWchar): void {.cdecl, importc: "ImVector_ImWchar_UnInit".}
proc ImGuiPlatformIO_Set_Platform_GetWindowPos*(platform_io: ptr ImGuiPlatformIO; user_callback: proc (a0: ptr ImGuiViewport; a1: ptr ImVec2): void {.cdecl.}): void {.cdecl, importc: "ImGuiPlatformIO_Set_Platform_GetWindowPos".}
proc ImGuiPlatformIO_Set_Platform_GetWindowSize*(platform_io: ptr ImGuiPlatformIO; user_callback: proc (a0: ptr ImGuiViewport; a1: ptr ImVec2): void {.cdecl.}): void {.cdecl, importc: "ImGuiPlatformIO_Set_Platform_GetWindowSize".}
...
proc ImPlotRange_Contains*(self: ptr ImPlotRange; value: cdouble): bool {.cdecl, importc: "ImPlotRange_Contains".}
proc ImPlotRange_Size*(self: ptr ImPlotRange): cdouble {.cdecl, importc: "ImPlotRange_Size".}
proc ImPlotRange_Clamp*(self: ptr ImPlotRange; value: cdouble): cdouble {.cdecl, importc: "ImPlotRange_Clamp".}
...
proc ImPlotInputMap_destroy*(self: ptr ImPlotInputMap): void {.cdecl, importc: "ImPlotInputMap_destroy".}
proc ImPlot_CreateContext*(): ptr ImPlotContext {.cdecl, importc: "ImPlot_CreateContext".}
proc ImPlot_DestroyContext*(ctx: ptr ImPlotContext): void {.cdecl, importc: "ImPlot_DestroyContext".}
...
proc ImPlot_SetupAxisLinks*(axis: ImAxis; link_min: ptr cdouble; link_max: ptr cdouble): void {.cdecl, importc: "ImPlot_SetupAxisLinks".}
proc ImPlot_SetupAxisFormat_Str*(axis: ImAxis; fmt: cstring): void {.cdecl, importc: "ImPlot_SetupAxisFormat_Str".}
proc ImPlot_SetupAxisFormat_PlotFormatter*(axis: ImAxis; formatter: ImPlotFormatter; data: pointer): void {.cdecl, importc: "ImPlot_SetupAxisFormat_PlotFormatter".}
proc ImPlot_SetupAxisTicks_doublePtr*(axis: ImAxis; values: ptr cdouble; n_ticks: cint; labels: ptr UncheckedArray[cstring]; keep_default: bool): void {.cdecl, importc: "ImPlot_SetupAxisTicks_doublePtr".}
proc ImPlot_SetupAxisTicks_double*(axis: ImAxis; v_min: cdouble; v_max: cdouble; n_ticks: cint; labels: ptr UncheckedArray[cstring]; keep_default: bool): void {.cdecl, importc: "ImPlot_SetupAxisTicks_double".}
proc ImPlot_SetupAxisScale_PlotScale*(axis: ImAxis; scale: ImPlotScale): void {.cdecl, importc: "ImPlot_SetupAxisScale_PlotScale".}
proc ImPlot_SetupAxisScale_PlotTransform*(axis: ImAxis; forward: ImPlotTransform; inverse: ImPlotTransform; data: pointer): void {.cdecl, importc: "ImPlot_SetupAxisScale_PlotTransform".}
proc ImPlot_SetupAxisLimitsConstraints*(axis: ImAxis; v_min: cdouble; v_max: cdouble): void {.cdecl, importc: "ImPlot_SetupAxisLimitsConstraints".}
proc ImPlot_SetupAxisZoomConstraints*(axis: ImAxis; z_min: cdouble; z_max: cdouble): void {.cdecl, importc: "ImPlot_SetupAxisZoomConstraints".}
proc ImPlot_SetupAxes*(x_label: cstring; y_label: cstring; x_flags: ImPlotAxisFlags; y_flags: ImPlotAxisFlags): void {.cdecl, importc: "ImPlot_SetupAxes".}
proc ImPlot_SetupAxesLimits*(x_min: cdouble; x_max: cdouble; y_min: cdouble; y_max: cdouble; cond: ImPlotCond): void {.cdecl, importc: "ImPlot_SetupAxesLimits".}
proc ImPlot_SetupLegend*(location: ImPlotLocation; flags: ImPlotLegendFlags): void {.cdecl, importc: "ImPlot_SetupLegend".}
proc ImPlot_SetupMouseText*(location: ImPlotLocation; flags: ImPlotMouseTextFlags): void {.cdecl, importc: "ImPlot_SetupMouseText".}
proc ImPlot_SetupFinish*(): void {.cdecl, importc: "ImPlot_SetupFinish".}
proc ImPlot_SetNextAxisLimits*(axis: ImAxis; v_min: cdouble; v_max: cdouble; cond: ImPlotCond): void {.cdecl, importc: "ImPlot_SetNextAxisLimits".}
proc ImPlot_SetNextAxisLinks*(axis: ImAxis; link_min: ptr cdouble; link_max: ptr cdouble): void {.cdecl, importc: "ImPlot_SetNextAxisLinks".}
proc ImPlot_SetNextAxisToFit*(axis: ImAxis): void {.cdecl, importc: "ImPlot_SetNextAxisToFit".}
proc ImPlot_SetNextAxesLimits*(x_min: cdouble; x_max: cdouble; y_min: cdouble; y_max: cdouble; cond: ImPlotCond): void {.cdecl, importc: "ImPlot_SetNextAxesLimits".}
proc ImPlot_SetNextAxesToFit*(): void {.cdecl, importc: "ImPlot_SetNextAxesToFit".}
proc ImPlot_PlotLine_FloatPtrInt*(label_id: cstring; values: ptr cfloat; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_FloatPtrInt".}
proc ImPlot_PlotLine_doublePtrInt*(label_id: cstring; values: ptr cdouble; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_doublePtrInt".}
proc ImPlot_PlotLine_S8PtrInt*(label_id: cstring; values: cstring; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S8PtrInt".}
proc ImPlot_PlotLine_U8PtrInt*(label_id: cstring; values: ptr ImU8; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U8PtrInt".}
proc ImPlot_PlotLine_S16PtrInt*(label_id: cstring; values: ptr ImS16; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S16PtrInt".}
proc ImPlot_PlotLine_U16PtrInt*(label_id: cstring; values: ptr ImU16; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U16PtrInt".}
proc ImPlot_PlotLine_S32PtrInt*(label_id: cstring; values: ptr ImS32; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S32PtrInt".}
proc ImPlot_PlotLine_U32PtrInt*(label_id: cstring; values: ptr ImU32; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U32PtrInt".}
proc ImPlot_PlotLine_S64PtrInt*(label_id: cstring; values: ptr ImS64; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S64PtrInt".}
proc ImPlot_PlotLine_U64PtrInt*(label_id: cstring; values: ptr ImU64; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U64PtrInt".}
proc ImPlot_PlotLine_FloatPtrFloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_FloatPtrFloatPtr".}
proc ImPlot_PlotLine_doublePtrdoublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_doublePtrdoublePtr".}
proc ImPlot_PlotLine_S8PtrS8Ptr*(label_id: cstring; xs: cstring; ys: cstring; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S8PtrS8Ptr".}
proc ImPlot_PlotLine_U8PtrU8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U8PtrU8Ptr".}
proc ImPlot_PlotLine_S16PtrS16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S16PtrS16Ptr".}
proc ImPlot_PlotLine_U16PtrU16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U16PtrU16Ptr".}
proc ImPlot_PlotLine_S32PtrS32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S32PtrS32Ptr".}
proc ImPlot_PlotLine_U32PtrU32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U32PtrU32Ptr".}
proc ImPlot_PlotLine_S64PtrS64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_S64PtrS64Ptr".}
proc ImPlot_PlotLine_U64PtrU64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; count: cint; flags: ImPlotLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotLine_U64PtrU64Ptr".}
proc ImPlot_PlotLineG*(label_id: cstring; getter: ImPlotPoint_getter; data: pointer; count: cint; flags: ImPlotLineFlags): void {.cdecl, importc: "ImPlot_PlotLineG".}
proc ImPlot_PlotScatter_FloatPtrInt*(label_id: cstring; values: ptr cfloat; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_FloatPtrInt".}
proc ImPlot_PlotScatter_doublePtrInt*(label_id: cstring; values: ptr cdouble; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_doublePtrInt".}
proc ImPlot_PlotScatter_S8PtrInt*(label_id: cstring; values: cstring; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S8PtrInt".}
proc ImPlot_PlotScatter_U8PtrInt*(label_id: cstring; values: ptr ImU8; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U8PtrInt".}
proc ImPlot_PlotScatter_S16PtrInt*(label_id: cstring; values: ptr ImS16; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S16PtrInt".}
proc ImPlot_PlotScatter_U16PtrInt*(label_id: cstring; values: ptr ImU16; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U16PtrInt".}
proc ImPlot_PlotScatter_S32PtrInt*(label_id: cstring; values: ptr ImS32; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S32PtrInt".}
proc ImPlot_PlotScatter_U32PtrInt*(label_id: cstring; values: ptr ImU32; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U32PtrInt".}
proc ImPlot_PlotScatter_S64PtrInt*(label_id: cstring; values: ptr ImS64; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S64PtrInt".}
proc ImPlot_PlotScatter_U64PtrInt*(label_id: cstring; values: ptr ImU64; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U64PtrInt".}
proc ImPlot_PlotScatter_FloatPtrFloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_FloatPtrFloatPtr".}
proc ImPlot_PlotScatter_doublePtrdoublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_doublePtrdoublePtr".}
proc ImPlot_PlotScatter_S8PtrS8Ptr*(label_id: cstring; xs: cstring; ys: cstring; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S8PtrS8Ptr".}
proc ImPlot_PlotScatter_U8PtrU8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U8PtrU8Ptr".}
proc ImPlot_PlotScatter_S16PtrS16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S16PtrS16Ptr".}
proc ImPlot_PlotScatter_U16PtrU16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U16PtrU16Ptr".}
proc ImPlot_PlotScatter_S32PtrS32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S32PtrS32Ptr".}
proc ImPlot_PlotScatter_U32PtrU32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U32PtrU32Ptr".}
proc ImPlot_PlotScatter_S64PtrS64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_S64PtrS64Ptr".}
proc ImPlot_PlotScatter_U64PtrU64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; count: cint; flags: ImPlotScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotScatter_U64PtrU64Ptr".}
proc ImPlot_PlotScatterG*(label_id: cstring; getter: ImPlotPoint_getter; data: pointer; count: cint; flags: ImPlotScatterFlags): void {.cdecl, importc: "ImPlot_PlotScatterG".}
proc ImPlot_PlotStairs_FloatPtrInt*(label_id: cstring; values: ptr cfloat; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_FloatPtrInt".}
proc ImPlot_PlotStairs_doublePtrInt*(label_id: cstring; values: ptr cdouble; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_doublePtrInt".}
proc ImPlot_PlotStairs_S8PtrInt*(label_id: cstring; values: cstring; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S8PtrInt".}
proc ImPlot_PlotStairs_U8PtrInt*(label_id: cstring; values: ptr ImU8; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U8PtrInt".}
proc ImPlot_PlotStairs_S16PtrInt*(label_id: cstring; values: ptr ImS16; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S16PtrInt".}
proc ImPlot_PlotStairs_U16PtrInt*(label_id: cstring; values: ptr ImU16; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U16PtrInt".}
proc ImPlot_PlotStairs_S32PtrInt*(label_id: cstring; values: ptr ImS32; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S32PtrInt".}
proc ImPlot_PlotStairs_U32PtrInt*(label_id: cstring; values: ptr ImU32; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U32PtrInt".}
proc ImPlot_PlotStairs_S64PtrInt*(label_id: cstring; values: ptr ImS64; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S64PtrInt".}
proc ImPlot_PlotStairs_U64PtrInt*(label_id: cstring; values: ptr ImU64; count: cint; xscale: cdouble; xstart: cdouble; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U64PtrInt".}
proc ImPlot_PlotStairs_FloatPtrFloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_FloatPtrFloatPtr".}
proc ImPlot_PlotStairs_doublePtrdoublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_doublePtrdoublePtr".}
proc ImPlot_PlotStairs_S8PtrS8Ptr*(label_id: cstring; xs: cstring; ys: cstring; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S8PtrS8Ptr".}
proc ImPlot_PlotStairs_U8PtrU8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U8PtrU8Ptr".}
proc ImPlot_PlotStairs_S16PtrS16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S16PtrS16Ptr".}
proc ImPlot_PlotStairs_U16PtrU16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U16PtrU16Ptr".}
proc ImPlot_PlotStairs_S32PtrS32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S32PtrS32Ptr".}
proc ImPlot_PlotStairs_U32PtrU32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U32PtrU32Ptr".}
proc ImPlot_PlotStairs_S64PtrS64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_S64PtrS64Ptr".}
proc ImPlot_PlotStairs_U64PtrU64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; count: cint; flags: ImPlotStairsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStairs_U64PtrU64Ptr".}
proc ImPlot_PlotStairsG*(label_id: cstring; getter: ImPlotPoint_getter; data: pointer; count: cint; flags: ImPlotStairsFlags): void {.cdecl, importc: "ImPlot_PlotStairsG".}
proc ImPlot_PlotShaded_FloatPtrInt*(label_id: cstring; values: ptr cfloat; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_FloatPtrInt".}
proc ImPlot_PlotShaded_doublePtrInt*(label_id: cstring; values: ptr cdouble; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_doublePtrInt".}
proc ImPlot_PlotShaded_S8PtrInt*(label_id: cstring; values: cstring; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S8PtrInt".}
proc ImPlot_PlotShaded_U8PtrInt*(label_id: cstring; values: ptr ImU8; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U8PtrInt".}
proc ImPlot_PlotShaded_S16PtrInt*(label_id: cstring; values: ptr ImS16; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S16PtrInt".}
proc ImPlot_PlotShaded_U16PtrInt*(label_id: cstring; values: ptr ImU16; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U16PtrInt".}
proc ImPlot_PlotShaded_S32PtrInt*(label_id: cstring; values: ptr ImS32; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S32PtrInt".}
proc ImPlot_PlotShaded_U32PtrInt*(label_id: cstring; values: ptr ImU32; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U32PtrInt".}
proc ImPlot_PlotShaded_S64PtrInt*(label_id: cstring; values: ptr ImS64; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S64PtrInt".}
proc ImPlot_PlotShaded_U64PtrInt*(label_id: cstring; values: ptr ImU64; count: cint; yref: cdouble; xscale: cdouble; xstart: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U64PtrInt".}
proc ImPlot_PlotShaded_FloatPtrFloatPtrInt*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_FloatPtrFloatPtrInt".}
proc ImPlot_PlotShaded_doublePtrdoublePtrInt*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_doublePtrdoublePtrInt".}
proc ImPlot_PlotShaded_S8PtrS8PtrInt*(label_id: cstring; xs: cstring; ys: cstring; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S8PtrS8PtrInt".}
proc ImPlot_PlotShaded_U8PtrU8PtrInt*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U8PtrU8PtrInt".}
proc ImPlot_PlotShaded_S16PtrS16PtrInt*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S16PtrS16PtrInt".}
proc ImPlot_PlotShaded_U16PtrU16PtrInt*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U16PtrU16PtrInt".}
proc ImPlot_PlotShaded_S32PtrS32PtrInt*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S32PtrS32PtrInt".}
proc ImPlot_PlotShaded_U32PtrU32PtrInt*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U32PtrU32PtrInt".}
proc ImPlot_PlotShaded_S64PtrS64PtrInt*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S64PtrS64PtrInt".}
proc ImPlot_PlotShaded_U64PtrU64PtrInt*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; count: cint; yref: cdouble; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U64PtrU64PtrInt".}
proc ImPlot_PlotShaded_FloatPtrFloatPtrFloatPtr*(label_id: cstring; xs: ptr cfloat; ys1: ptr cfloat; ys2: ptr cfloat; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_FloatPtrFloatPtrFloatPtr".}
proc ImPlot_PlotShaded_doublePtrdoublePtrdoublePtr*(label_id: cstring; xs: ptr cdouble; ys1: ptr cdouble; ys2: ptr cdouble; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_doublePtrdoublePtrdoublePtr".}
proc ImPlot_PlotShaded_S8PtrS8PtrS8Ptr*(label_id: cstring; xs: cstring; ys1: cstring; ys2: cstring; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S8PtrS8PtrS8Ptr".}
proc ImPlot_PlotShaded_U8PtrU8PtrU8Ptr*(label_id: cstring; xs: ptr ImU8; ys1: ptr ImU8; ys2: ptr ImU8; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U8PtrU8PtrU8Ptr".}
proc ImPlot_PlotShaded_S16PtrS16PtrS16Ptr*(label_id: cstring; xs: ptr ImS16; ys1: ptr ImS16; ys2: ptr ImS16; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S16PtrS16PtrS16Ptr".}
proc ImPlot_PlotShaded_U16PtrU16PtrU16Ptr*(label_id: cstring; xs: ptr ImU16; ys1: ptr ImU16; ys2: ptr ImU16; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U16PtrU16PtrU16Ptr".}
proc ImPlot_PlotShaded_S32PtrS32PtrS32Ptr*(label_id: cstring; xs: ptr ImS32; ys1: ptr ImS32; ys2: ptr ImS32; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S32PtrS32PtrS32Ptr".}
proc ImPlot_PlotShaded_U32PtrU32PtrU32Ptr*(label_id: cstring; xs: ptr ImU32; ys1: ptr ImU32; ys2: ptr ImU32; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U32PtrU32PtrU32Ptr".}
proc ImPlot_PlotShaded_S64PtrS64PtrS64Ptr*(label_id: cstring; xs: ptr ImS64; ys1: ptr ImS64; ys2: ptr ImS64; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_S64PtrS64PtrS64Ptr".}
proc ImPlot_PlotShaded_U64PtrU64PtrU64Ptr*(label_id: cstring; xs: ptr ImU64; ys1: ptr ImU64; ys2: ptr ImU64; count: cint; flags: ImPlotShadedFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotShaded_U64PtrU64PtrU64Ptr".}
proc ImPlot_PlotShadedG*(label_id: cstring; getter1: ImPlotPoint_getter; data1: pointer; getter2: ImPlotPoint_getter; data2: pointer; count: cint; flags: ImPlotShadedFlags): void {.cdecl, importc: "ImPlot_PlotShadedG".}
proc ImPlot_PlotBars_FloatPtrInt*(label_id: cstring; values: ptr cfloat; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_FloatPtrInt".}
proc ImPlot_PlotBars_doublePtrInt*(label_id: cstring; values: ptr cdouble; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_doublePtrInt".}
proc ImPlot_PlotBars_S8PtrInt*(label_id: cstring; values: cstring; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S8PtrInt".}
proc ImPlot_PlotBars_U8PtrInt*(label_id: cstring; values: ptr ImU8; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U8PtrInt".}
proc ImPlot_PlotBars_S16PtrInt*(label_id: cstring; values: ptr ImS16; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S16PtrInt".}
proc ImPlot_PlotBars_U16PtrInt*(label_id: cstring; values: ptr ImU16; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U16PtrInt".}
proc ImPlot_PlotBars_S32PtrInt*(label_id: cstring; values: ptr ImS32; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S32PtrInt".}
proc ImPlot_PlotBars_U32PtrInt*(label_id: cstring; values: ptr ImU32; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U32PtrInt".}
proc ImPlot_PlotBars_S64PtrInt*(label_id: cstring; values: ptr ImS64; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S64PtrInt".}
proc ImPlot_PlotBars_U64PtrInt*(label_id: cstring; values: ptr ImU64; count: cint; bar_size: cdouble; shift: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U64PtrInt".}
proc ImPlot_PlotBars_FloatPtrFloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_FloatPtrFloatPtr".}
proc ImPlot_PlotBars_doublePtrdoublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_doublePtrdoublePtr".}
proc ImPlot_PlotBars_S8PtrS8Ptr*(label_id: cstring; xs: cstring; ys: cstring; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S8PtrS8Ptr".}
proc ImPlot_PlotBars_U8PtrU8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U8PtrU8Ptr".}
proc ImPlot_PlotBars_S16PtrS16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S16PtrS16Ptr".}
proc ImPlot_PlotBars_U16PtrU16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U16PtrU16Ptr".}
proc ImPlot_PlotBars_S32PtrS32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S32PtrS32Ptr".}
proc ImPlot_PlotBars_U32PtrU32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U32PtrU32Ptr".}
proc ImPlot_PlotBars_S64PtrS64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_S64PtrS64Ptr".}
proc ImPlot_PlotBars_U64PtrU64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotBars_U64PtrU64Ptr".}
proc ImPlot_PlotBarsG*(label_id: cstring; getter: ImPlotPoint_getter; data: pointer; count: cint; bar_size: cdouble; flags: ImPlotBarsFlags): void {.cdecl, importc: "ImPlot_PlotBarsG".}
proc ImPlot_PlotBarGroups_FloatPtr*(label_ids: ptr UncheckedArray[cstring]; values: ptr cfloat; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_FloatPtr".}
proc ImPlot_PlotBarGroups_doublePtr*(label_ids: ptr UncheckedArray[cstring]; values: ptr cdouble; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_doublePtr".}
proc ImPlot_PlotBarGroups_S8Ptr*(label_ids: ptr UncheckedArray[cstring]; values: cstring; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_S8Ptr".}
proc ImPlot_PlotBarGroups_U8Ptr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU8; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_U8Ptr".}
proc ImPlot_PlotBarGroups_S16Ptr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS16; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_S16Ptr".}
proc ImPlot_PlotBarGroups_U16Ptr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU16; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_U16Ptr".}
proc ImPlot_PlotBarGroups_S32Ptr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS32; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_S32Ptr".}
proc ImPlot_PlotBarGroups_U32Ptr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU32; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_U32Ptr".}
proc ImPlot_PlotBarGroups_S64Ptr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS64; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_S64Ptr".}
proc ImPlot_PlotBarGroups_U64Ptr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU64; item_count: cint; group_count: cint; group_size: cdouble; shift: cdouble; flags: ImPlotBarGroupsFlags): void {.cdecl, importc: "ImPlot_PlotBarGroups_U64Ptr".}
proc ImPlot_PlotErrorBars_FloatPtrFloatPtrFloatPtrInt*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; err: ptr cfloat; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_FloatPtrFloatPtrFloatPtrInt".}
proc ImPlot_PlotErrorBars_doublePtrdoublePtrdoublePtrInt*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; err: ptr cdouble; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_doublePtrdoublePtrdoublePtrInt".}
proc ImPlot_PlotErrorBars_S8PtrS8PtrS8PtrInt*(label_id: cstring; xs: cstring; ys: cstring; err: cstring; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S8PtrS8PtrS8PtrInt".}
proc ImPlot_PlotErrorBars_U8PtrU8PtrU8PtrInt*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; err: ptr ImU8; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U8PtrU8PtrU8PtrInt".}
proc ImPlot_PlotErrorBars_S16PtrS16PtrS16PtrInt*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; err: ptr ImS16; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S16PtrS16PtrS16PtrInt".}
proc ImPlot_PlotErrorBars_U16PtrU16PtrU16PtrInt*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; err: ptr ImU16; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U16PtrU16PtrU16PtrInt".}
proc ImPlot_PlotErrorBars_S32PtrS32PtrS32PtrInt*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; err: ptr ImS32; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S32PtrS32PtrS32PtrInt".}
proc ImPlot_PlotErrorBars_U32PtrU32PtrU32PtrInt*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; err: ptr ImU32; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U32PtrU32PtrU32PtrInt".}
proc ImPlot_PlotErrorBars_S64PtrS64PtrS64PtrInt*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; err: ptr ImS64; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S64PtrS64PtrS64PtrInt".}
proc ImPlot_PlotErrorBars_U64PtrU64PtrU64PtrInt*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; err: ptr ImU64; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U64PtrU64PtrU64PtrInt".}
proc ImPlot_PlotErrorBars_FloatPtrFloatPtrFloatPtrFloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; neg: ptr cfloat; pos: ptr cfloat; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_FloatPtrFloatPtrFloatPtrFloatPtr".}
proc ImPlot_PlotErrorBars_doublePtrdoublePtrdoublePtrdoublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; neg: ptr cdouble; pos: ptr cdouble; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_doublePtrdoublePtrdoublePtrdoublePtr".}
proc ImPlot_PlotErrorBars_S8PtrS8PtrS8PtrS8Ptr*(label_id: cstring; xs: cstring; ys: cstring; neg: cstring; pos: cstring; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S8PtrS8PtrS8PtrS8Ptr".}
proc ImPlot_PlotErrorBars_U8PtrU8PtrU8PtrU8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; neg: ptr ImU8; pos: ptr ImU8; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U8PtrU8PtrU8PtrU8Ptr".}
proc ImPlot_PlotErrorBars_S16PtrS16PtrS16PtrS16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; neg: ptr ImS16; pos: ptr ImS16; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S16PtrS16PtrS16PtrS16Ptr".}
proc ImPlot_PlotErrorBars_U16PtrU16PtrU16PtrU16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; neg: ptr ImU16; pos: ptr ImU16; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U16PtrU16PtrU16PtrU16Ptr".}
proc ImPlot_PlotErrorBars_S32PtrS32PtrS32PtrS32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; neg: ptr ImS32; pos: ptr ImS32; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S32PtrS32PtrS32PtrS32Ptr".}
proc ImPlot_PlotErrorBars_U32PtrU32PtrU32PtrU32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; neg: ptr ImU32; pos: ptr ImU32; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U32PtrU32PtrU32PtrU32Ptr".}
proc ImPlot_PlotErrorBars_S64PtrS64PtrS64PtrS64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; neg: ptr ImS64; pos: ptr ImS64; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_S64PtrS64PtrS64PtrS64Ptr".}
proc ImPlot_PlotErrorBars_U64PtrU64PtrU64PtrU64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; neg: ptr ImU64; pos: ptr ImU64; count: cint; flags: ImPlotErrorBarsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotErrorBars_U64PtrU64PtrU64PtrU64Ptr".}
proc ImPlot_PlotStems_FloatPtrInt*(label_id: cstring; values: ptr cfloat; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_FloatPtrInt".}
proc ImPlot_PlotStems_doublePtrInt*(label_id: cstring; values: ptr cdouble; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_doublePtrInt".}
proc ImPlot_PlotStems_S8PtrInt*(label_id: cstring; values: cstring; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S8PtrInt".}
proc ImPlot_PlotStems_U8PtrInt*(label_id: cstring; values: ptr ImU8; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U8PtrInt".}
proc ImPlot_PlotStems_S16PtrInt*(label_id: cstring; values: ptr ImS16; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S16PtrInt".}
proc ImPlot_PlotStems_U16PtrInt*(label_id: cstring; values: ptr ImU16; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U16PtrInt".}
proc ImPlot_PlotStems_S32PtrInt*(label_id: cstring; values: ptr ImS32; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S32PtrInt".}
proc ImPlot_PlotStems_U32PtrInt*(label_id: cstring; values: ptr ImU32; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U32PtrInt".}
proc ImPlot_PlotStems_S64PtrInt*(label_id: cstring; values: ptr ImS64; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S64PtrInt".}
proc ImPlot_PlotStems_U64PtrInt*(label_id: cstring; values: ptr ImU64; count: cint; ref_arg: cdouble; scale: cdouble; start: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U64PtrInt".}
proc ImPlot_PlotStems_FloatPtrFloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_FloatPtrFloatPtr".}
proc ImPlot_PlotStems_doublePtrdoublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_doublePtrdoublePtr".}
proc ImPlot_PlotStems_S8PtrS8Ptr*(label_id: cstring; xs: cstring; ys: cstring; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S8PtrS8Ptr".}
proc ImPlot_PlotStems_U8PtrU8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U8PtrU8Ptr".}
proc ImPlot_PlotStems_S16PtrS16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S16PtrS16Ptr".}
proc ImPlot_PlotStems_U16PtrU16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U16PtrU16Ptr".}
proc ImPlot_PlotStems_S32PtrS32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S32PtrS32Ptr".}
proc ImPlot_PlotStems_U32PtrU32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U32PtrU32Ptr".}
proc ImPlot_PlotStems_S64PtrS64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_S64PtrS64Ptr".}
proc ImPlot_PlotStems_U64PtrU64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; count: cint; ref_arg: cdouble; flags: ImPlotStemsFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotStems_U64PtrU64Ptr".}
proc ImPlot_PlotInfLines_FloatPtr*(label_id: cstring; values: ptr cfloat; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_FloatPtr".}
proc ImPlot_PlotInfLines_doublePtr*(label_id: cstring; values: ptr cdouble; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_doublePtr".}
proc ImPlot_PlotInfLines_S8Ptr*(label_id: cstring; values: cstring; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_S8Ptr".}
proc ImPlot_PlotInfLines_U8Ptr*(label_id: cstring; values: ptr ImU8; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_U8Ptr".}
proc ImPlot_PlotInfLines_S16Ptr*(label_id: cstring; values: ptr ImS16; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_S16Ptr".}
proc ImPlot_PlotInfLines_U16Ptr*(label_id: cstring; values: ptr ImU16; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_U16Ptr".}
proc ImPlot_PlotInfLines_S32Ptr*(label_id: cstring; values: ptr ImS32; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_S32Ptr".}
proc ImPlot_PlotInfLines_U32Ptr*(label_id: cstring; values: ptr ImU32; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_U32Ptr".}
proc ImPlot_PlotInfLines_S64Ptr*(label_id: cstring; values: ptr ImS64; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_S64Ptr".}
proc ImPlot_PlotInfLines_U64Ptr*(label_id: cstring; values: ptr ImU64; count: cint; flags: ImPlotInfLinesFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotInfLines_U64Ptr".}
proc ImPlot_PlotPieChart_FloatPtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr cfloat; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_FloatPtrPlotFormatter".}
proc ImPlot_PlotPieChart_doublePtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr cdouble; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_doublePtrPlotFormatter".}
proc ImPlot_PlotPieChart_S8PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: cstring; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_S8PtrPlotFormatter".}
proc ImPlot_PlotPieChart_U8PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU8; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_U8PtrPlotFormatter".}
proc ImPlot_PlotPieChart_S16PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS16; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_S16PtrPlotFormatter".}
proc ImPlot_PlotPieChart_U16PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU16; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_U16PtrPlotFormatter".}
proc ImPlot_PlotPieChart_S32PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS32; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_S32PtrPlotFormatter".}
proc ImPlot_PlotPieChart_U32PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU32; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_U32PtrPlotFormatter".}
proc ImPlot_PlotPieChart_S64PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS64; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_S64PtrPlotFormatter".}
proc ImPlot_PlotPieChart_U64PtrPlotFormatter*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU64; count: cint; x: cdouble; y: cdouble; radius: cdouble; fmt: ImPlotFormatter; fmt_data: pointer; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_U64PtrPlotFormatter".}
proc ImPlot_PlotPieChart_FloatPtrStr*(label_ids: ptr UncheckedArray[cstring]; values: ptr cfloat; count: cint; x: cdouble; y: cdouble; radius: cdouble; label_fmt: cstring; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_FloatPtrStr".}
proc ImPlot_PlotPieChart_doublePtrStr*(label_ids: ptr UncheckedArray[cstring]; values: ptr cdouble; count: cint; x: cdouble; y: cdouble; radius: cdouble; label_fmt: cstring; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_doublePtrStr".}
proc ImPlot_PlotPieChart_S8PtrStr*(label_ids: ptr UncheckedArray[cstring]; values: cstring; count: cint; x: cdouble; y: cdouble; radius: cdouble; label_fmt: cstring; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_S8PtrStr".}
proc ImPlot_PlotPieChart_U8PtrStr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU8; count: cint; x: cdouble; y: cdouble; radius: cdouble; label_fmt: cstring; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_U8PtrStr".}
proc ImPlot_PlotPieChart_S16PtrStr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS16; count: cint; x: cdouble; y: cdouble; radius: cdouble; label_fmt: cstring; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_S16PtrStr".}
proc ImPlot_PlotPieChart_U16PtrStr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImU16; count: cint; x: cdouble; y: cdouble; radius: cdouble; label_fmt: cstring; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_U16PtrStr".}
proc ImPlot_PlotPieChart_S32PtrStr*(label_ids: ptr UncheckedArray[cstring]; values: ptr ImS32; count: cint; x: cdouble; y: cdouble; radius: cdouble; label_fmt: cstring; angle0: cdouble; flags: ImPlotPieChartFlags): void {.cdecl, importc: "ImPlot_PlotPieChart_S32PtrStr".}
...
proc ImPlot_PlotDigital_U8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; flags: ImPlotDigitalFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotDigital_U8Ptr".}
proc ImPlot_PlotDigital_S16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; flags: ImPlotDigitalFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotDigital_S16Ptr".}
proc ImPlot_PlotDigital_U16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; flags: ImPlotDigitalFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotDigital_U16Ptr".}
proc ImPlot_PlotDigital_S32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; flags: ImPlotDigitalFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotDigital_S32Ptr".}
proc ImPlot_PlotDigital_U32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; flags: ImPlotDigitalFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot_PlotDigital_U32Ptr".}
...
proc ImPlot_BeginLegendPopup*(label_id: cstring; mouse_button: ImGuiMouseButton): bool {.cdecl, importc: "ImPlot_BeginLegendPopup".}
proc ImPlot_EndLegendPopup*(): void {.cdecl, importc: "ImPlot_EndLegendPopup".}
proc ImPlot_IsLegendEntryHovered*(label_id: cstring): bool {.cdecl, importc: "ImPlot_IsLegendEntryHovered".}
proc ImPlot_BeginDragDropTargetPlot*(): bool {.cdecl, importc: "ImPlot_BeginDragDropTargetPlot".}
proc ImPlot_BeginDragDropTargetAxis*(axis: ImAxis): bool {.cdecl, importc: "ImPlot_BeginDragDropTargetAxis".}
proc ImPlot_BeginDragDropTargetLegend*(): bool {.cdecl, importc: "ImPlot_BeginDragDropTargetLegend".}
proc ImPlot_EndDragDropTarget*(): void {.cdecl, importc: "ImPlot_EndDragDropTarget".}
proc ImPlot_BeginDragDropSourcePlot*(flags: ImGuiDragDropFlags): bool {.cdecl, importc: "ImPlot_BeginDragDropSourcePlot".}
proc ImPlot_BeginDragDropSourceAxis*(axis: ImAxis; flags: ImGuiDragDropFlags): bool {.cdecl, importc: "ImPlot_BeginDragDropSourceAxis".}
proc ImPlot_BeginDragDropSourceItem*(label_id: cstring; flags: ImGuiDragDropFlags): bool {.cdecl, importc: "ImPlot_BeginDragDropSourceItem".}
proc ImPlot_EndDragDropSource*(): void {.cdecl, importc: "ImPlot_EndDragDropSource".}
proc ImPlot_GetStyle*(): ptr ImPlotStyle {.cdecl, importc: "ImPlot_GetStyle".}
proc ImPlot_StyleColorsAuto*(dst: ptr ImPlotStyle): void {.cdecl, importc: "ImPlot_StyleColorsAuto".}
proc ImPlot_StyleColorsClassic*(dst: ptr ImPlotStyle): void {.cdecl, importc: "ImPlot_StyleColorsClassic".}
...
proc ImPlot_AddColormap_U32Ptr*(name: cstring; cols: ptr ImU32; size: cint; qual: bool): ImPlotColormap {.cdecl, importc: "ImPlot_AddColormap_U32Ptr".}
proc ImPlot_GetColormapCount*(): cint {.cdecl, importc: "ImPlot_GetColormapCount".}
proc ImPlot_GetColormapName*(cmap: ImPlotColormap): cstring {.cdecl, importc: "ImPlot_GetColormapName".}
proc ImPlot_GetColormapIndex*(name: cstring): ImPlotColormap {.cdecl, importc: "ImPlot_GetColormapIndex".}
...
proc ImPlot_PushPlotClipRect*(expand: cfloat): void {.cdecl, importc: "ImPlot_PushPlotClipRect".}
proc ImPlot_PopPlotClipRect*(): void {.cdecl, importc: "ImPlot_PopPlotClipRect".}
proc ImPlot_ShowStyleSelector*(label: cstring): bool {.cdecl, importc: "ImPlot_ShowStyleSelector".}
proc ImPlot_ShowColormapSelector*(label: cstring): bool {.cdecl, importc: "ImPlot_ShowColormapSelector".}
proc ImPlot_ShowInputMapSelector*(label: cstring): bool {.cdecl, importc: "ImPlot_ShowInputMapSelector".}
proc ImPlot_ShowStyleEditor*(ref_arg: ptr ImPlotStyle): void {.cdecl, importc: "ImPlot_ShowStyleEditor".}
proc ImPlot_ShowUserGuide*(): void {.cdecl, importc: "ImPlot_ShowUserGuide".}
proc ImPlot_ShowMetricsWindow*(p_popen: ptr bool): void {.cdecl, importc: "ImPlot_ShowMetricsWindow".}
proc ImPlot_ShowDemoWindow*(p_open: ptr bool): void {.cdecl, importc: "ImPlot_ShowDemoWindow".}
proc ImPlot_ImLog10_Float*(x: cfloat): cfloat {.cdecl, importc: "ImPlot_ImLog10_Float".}
proc ImPlot_ImLog10_double*(x: cdouble): cdouble {.cdecl, importc: "ImPlot_ImLog10_double".}
proc ImPlot_ImSinh_Float*(x: cfloat): cfloat {.cdecl, importc: "ImPlot_ImSinh_Float".}
proc ImPlot_ImSinh_double*(x: cdouble): cdouble {.cdecl, importc: "ImPlot_ImSinh_double".}
proc ImPlot_ImAsinh_Float*(x: cfloat): cfloat {.cdecl, importc: "ImPlot_ImAsinh_Float".}
proc ImPlot_ImAsinh_double*(x: cdouble): cdouble {.cdecl, importc: "ImPlot_ImAsinh_double".}
proc ImPlot_ImRemap_Float*(x: cfloat; x0: cfloat; x1: cfloat; y0: cfloat; y1: cfloat): cfloat {.cdecl, importc: "ImPlot_ImRemap_Float".}
proc ImPlot_ImRemap_double*(x: cdouble; x0: cdouble; x1: cdouble; y0: cdouble; y1: cdouble): cdouble {.cdecl, importc: "ImPlot_ImRemap_double".}
proc ImPlot_ImRemap_S8*(x: ImS8; x0: ImS8; x1: ImS8; y0: ImS8; y1: ImS8): ImS8 {.cdecl, importc: "ImPlot_ImRemap_S8".}
proc ImPlot_ImRemap_U8*(x: ImU8; x0: ImU8; x1: ImU8; y0: ImU8; y1: ImU8): ImU8 {.cdecl, importc: "ImPlot_ImRemap_U8".}
proc ImPlot_ImRemap_S16*(x: ImS16; x0: ImS16; x1: ImS16; y0: ImS16; y1: ImS16): ImS16 {.cdecl, importc: "ImPlot_ImRemap_S16".}
proc ImPlot_ImRemap_U16*(x: ImU16; x0: ImU16; x1: ImU16; y0: ImU16; y1: ImU16): ImU16 {.cdecl, importc: "ImPlot_ImRemap_U16".}
proc ImPlot_ImRemap_S32*(x: ImS32; x0: ImS32; x1: ImS32; y0: ImS32; y1: ImS32): ImS32 {.cdecl, importc: "ImPlot_ImRemap_S32".}
proc ImPlot_ImRemap_U32*(x: ImU32; x0: ImU32; x1: ImU32; y0: ImU32; y1: ImU32): ImU32 {.cdecl, importc: "ImPlot_ImRemap_U32".}
proc ImPlot_ImRemap_S64*(x: ImS64; x0: ImS64; x1: ImS64; y0: ImS64; y1: ImS64): ImS64 {.cdecl, importc: "ImPlot_ImRemap_S64".}
proc ImPlot_ImRemap_U64*(x: ImU64; x0: ImU64; x1: ImU64; y0: ImU64; y1: ImU64): ImU64 {.cdecl, importc: "ImPlot_ImRemap_U64".}
proc ImPlot_ImRemap01_Float*(x: cfloat; x0: cfloat; x1: cfloat): cfloat {.cdecl, importc: "ImPlot_ImRemap01_Float".}
proc ImPlot_ImRemap01_double*(x: cdouble; x0: cdouble; x1: cdouble): cdouble {.cdecl, importc: "ImPlot_ImRemap01_double".}
proc ImPlot_ImRemap01_S8*(x: ImS8; x0: ImS8; x1: ImS8): ImS8 {.cdecl, importc: "ImPlot_ImRemap01_S8".}
proc ImPlot_ImRemap01_U8*(x: ImU8; x0: ImU8; x1: ImU8): ImU8 {.cdecl, importc: "ImPlot_ImRemap01_U8".}
proc ImPlot_ImRemap01_S16*(x: ImS16; x0: ImS16; x1: ImS16): ImS16 {.cdecl, importc: "ImPlot_ImRemap01_S16".}
proc ImPlot_ImRemap01_U16*(x: ImU16; x0: ImU16; x1: ImU16): ImU16 {.cdecl, importc: "ImPlot_ImRemap01_U16".}
proc ImPlot_ImRemap01_S32*(x: ImS32; x0: ImS32; x1: ImS32): ImS32 {.cdecl, importc: "ImPlot_ImRemap01_S32".}
proc ImPlot_ImRemap01_U32*(x: ImU32; x0: ImU32; x1: ImU32): ImU32 {.cdecl, importc: "ImPlot_ImRemap01_U32".}
proc ImPlot_ImRemap01_S64*(x: ImS64; x0: ImS64; x1: ImS64): ImS64 {.cdecl, importc: "ImPlot_ImRemap01_S64".}
proc ImPlot_ImRemap01_U64*(x: ImU64; x0: ImU64; x1: ImU64): ImU64 {.cdecl, importc: "ImPlot_ImRemap01_U64".}
proc ImPlot_ImPosMod*(l: cint; r: cint): cint {.cdecl, importc: "ImPlot_ImPosMod".}
proc ImPlot_ImNan*(val: cdouble): bool {.cdecl, importc: "ImPlot_ImNan".}
proc ImPlot_ImNanOrInf*(val: cdouble): bool {.cdecl, importc: "ImPlot_ImNanOrInf".}
proc ImPlot_ImConstrainNan*(val: cdouble): cdouble {.cdecl, importc: "ImPlot_ImConstrainNan".}
proc ImPlot_ImConstrainInf*(val: cdouble): cdouble {.cdecl, importc: "ImPlot_ImConstrainInf".}
proc ImPlot_ImConstrainLog*(val: cdouble): cdouble {.cdecl, importc: "ImPlot_ImConstrainLog".}
proc ImPlot_ImConstrainTime*(val: cdouble): cdouble {.cdecl, importc: "ImPlot_ImConstrainTime".}
proc ImPlot_ImAlmostEqual*(v1: cdouble; v2: cdouble; ulp: cint): bool {.cdecl, importc: "ImPlot_ImAlmostEqual".}
proc ImPlot_ImMinArray_FloatPtr*(values: ptr cfloat; count: cint): cfloat {.cdecl, importc: "ImPlot_ImMinArray_FloatPtr".}
proc ImPlot_ImMinArray_doublePtr*(values: ptr cdouble; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMinArray_doublePtr".}
proc ImPlot_ImMinArray_S8Ptr*(values: cstring; count: cint): ImS8 {.cdecl, importc: "ImPlot_ImMinArray_S8Ptr".}
proc ImPlot_ImMinArray_U8Ptr*(values: ptr ImU8; count: cint): ImU8 {.cdecl, importc: "ImPlot_ImMinArray_U8Ptr".}
proc ImPlot_ImMinArray_S16Ptr*(values: ptr ImS16; count: cint): ImS16 {.cdecl, importc: "ImPlot_ImMinArray_S16Ptr".}
proc ImPlot_ImMinArray_U16Ptr*(values: ptr ImU16; count: cint): ImU16 {.cdecl, importc: "ImPlot_ImMinArray_U16Ptr".}
proc ImPlot_ImMinArray_S32Ptr*(values: ptr ImS32; count: cint): ImS32 {.cdecl, importc: "ImPlot_ImMinArray_S32Ptr".}
proc ImPlot_ImMinArray_U32Ptr*(values: ptr ImU32; count: cint): ImU32 {.cdecl, importc: "ImPlot_ImMinArray_U32Ptr".}
proc ImPlot_ImMinArray_S64Ptr*(values: ptr ImS64; count: cint): ImS64 {.cdecl, importc: "ImPlot_ImMinArray_S64Ptr".}
proc ImPlot_ImMinArray_U64Ptr*(values: ptr ImU64; count: cint): ImU64 {.cdecl, importc: "ImPlot_ImMinArray_U64Ptr".}
proc ImPlot_ImMaxArray_FloatPtr*(values: ptr cfloat; count: cint): cfloat {.cdecl, importc: "ImPlot_ImMaxArray_FloatPtr".}
proc ImPlot_ImMaxArray_doublePtr*(values: ptr cdouble; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMaxArray_doublePtr".}
proc ImPlot_ImMaxArray_S8Ptr*(values: cstring; count: cint): ImS8 {.cdecl, importc: "ImPlot_ImMaxArray_S8Ptr".}
proc ImPlot_ImMaxArray_U8Ptr*(values: ptr ImU8; count: cint): ImU8 {.cdecl, importc: "ImPlot_ImMaxArray_U8Ptr".}
proc ImPlot_ImMaxArray_S16Ptr*(values: ptr ImS16; count: cint): ImS16 {.cdecl, importc: "ImPlot_ImMaxArray_S16Ptr".}
proc ImPlot_ImMaxArray_U16Ptr*(values: ptr ImU16; count: cint): ImU16 {.cdecl, importc: "ImPlot_ImMaxArray_U16Ptr".}
proc ImPlot_ImMaxArray_S32Ptr*(values: ptr ImS32; count: cint): ImS32 {.cdecl, importc: "ImPlot_ImMaxArray_S32Ptr".}
proc ImPlot_ImMaxArray_U32Ptr*(values: ptr ImU32; count: cint): ImU32 {.cdecl, importc: "ImPlot_ImMaxArray_U32Ptr".}
proc ImPlot_ImMaxArray_S64Ptr*(values: ptr ImS64; count: cint): ImS64 {.cdecl, importc: "ImPlot_ImMaxArray_S64Ptr".}
proc ImPlot_ImMaxArray_U64Ptr*(values: ptr ImU64; count: cint): ImU64 {.cdecl, importc: "ImPlot_ImMaxArray_U64Ptr".}
proc ImPlot_ImMinMaxArray_FloatPtr*(values: ptr cfloat; count: cint; min_out: ptr cfloat; max_out: ptr cfloat): void {.cdecl, importc: "ImPlot_ImMinMaxArray_FloatPtr".}
proc ImPlot_ImMinMaxArray_doublePtr*(values: ptr cdouble; count: cint; min_out: ptr cdouble; max_out: ptr cdouble): void {.cdecl, importc: "ImPlot_ImMinMaxArray_doublePtr".}
proc ImPlot_ImMinMaxArray_S8Ptr*(values: cstring; count: cint; min_out: cstring; max_out: cstring): void {.cdecl, importc: "ImPlot_ImMinMaxArray_S8Ptr".}
proc ImPlot_ImMinMaxArray_U8Ptr*(values: ptr ImU8; count: cint; min_out: ptr ImU8; max_out: ptr ImU8): void {.cdecl, importc: "ImPlot_ImMinMaxArray_U8Ptr".}
proc ImPlot_ImMinMaxArray_S16Ptr*(values: ptr ImS16; count: cint; min_out: ptr ImS16; max_out: ptr ImS16): void {.cdecl, importc: "ImPlot_ImMinMaxArray_S16Ptr".}
proc ImPlot_ImMinMaxArray_U16Ptr*(values: ptr ImU16; count: cint; min_out: ptr ImU16; max_out: ptr ImU16): void {.cdecl, importc: "ImPlot_ImMinMaxArray_U16Ptr".}
proc ImPlot_ImMinMaxArray_S32Ptr*(values: ptr ImS32; count: cint; min_out: ptr ImS32; max_out: ptr ImS32): void {.cdecl, importc: "ImPlot_ImMinMaxArray_S32Ptr".}
proc ImPlot_ImMinMaxArray_U32Ptr*(values: ptr ImU32; count: cint; min_out: ptr ImU32; max_out: ptr ImU32): void {.cdecl, importc: "ImPlot_ImMinMaxArray_U32Ptr".}
proc ImPlot_ImMinMaxArray_S64Ptr*(values: ptr ImS64; count: cint; min_out: ptr ImS64; max_out: ptr ImS64): void {.cdecl, importc: "ImPlot_ImMinMaxArray_S64Ptr".}
proc ImPlot_ImMinMaxArray_U64Ptr*(values: ptr ImU64; count: cint; min_out: ptr ImU64; max_out: ptr ImU64): void {.cdecl, importc: "ImPlot_ImMinMaxArray_U64Ptr".}
proc ImPlot_ImSum_FloatPtr*(values: ptr cfloat; count: cint): cfloat {.cdecl, importc: "ImPlot_ImSum_FloatPtr".}
proc ImPlot_ImSum_doublePtr*(values: ptr cdouble; count: cint): cdouble {.cdecl, importc: "ImPlot_ImSum_doublePtr".}
proc ImPlot_ImSum_S8Ptr*(values: cstring; count: cint): ImS8 {.cdecl, importc: "ImPlot_ImSum_S8Ptr".}
proc ImPlot_ImSum_U8Ptr*(values: ptr ImU8; count: cint): ImU8 {.cdecl, importc: "ImPlot_ImSum_U8Ptr".}
proc ImPlot_ImSum_S16Ptr*(values: ptr ImS16; count: cint): ImS16 {.cdecl, importc: "ImPlot_ImSum_S16Ptr".}
proc ImPlot_ImSum_U16Ptr*(values: ptr ImU16; count: cint): ImU16 {.cdecl, importc: "ImPlot_ImSum_U16Ptr".}
proc ImPlot_ImSum_S32Ptr*(values: ptr ImS32; count: cint): ImS32 {.cdecl, importc: "ImPlot_ImSum_S32Ptr".}
proc ImPlot_ImSum_U32Ptr*(values: ptr ImU32; count: cint): ImU32 {.cdecl, importc: "ImPlot_ImSum_U32Ptr".}
proc ImPlot_ImSum_S64Ptr*(values: ptr ImS64; count: cint): ImS64 {.cdecl, importc: "ImPlot_ImSum_S64Ptr".}
proc ImPlot_ImSum_U64Ptr*(values: ptr ImU64; count: cint): ImU64 {.cdecl, importc: "ImPlot_ImSum_U64Ptr".}
proc ImPlot_ImMean_FloatPtr*(values: ptr cfloat; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_FloatPtr".}
proc ImPlot_ImMean_doublePtr*(values: ptr cdouble; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_doublePtr".}
proc ImPlot_ImMean_S8Ptr*(values: cstring; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_S8Ptr".}
proc ImPlot_ImMean_U8Ptr*(values: ptr ImU8; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_U8Ptr".}
proc ImPlot_ImMean_S16Ptr*(values: ptr ImS16; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_S16Ptr".}
proc ImPlot_ImMean_U16Ptr*(values: ptr ImU16; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_U16Ptr".}
proc ImPlot_ImMean_S32Ptr*(values: ptr ImS32; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_S32Ptr".}
proc ImPlot_ImMean_U32Ptr*(values: ptr ImU32; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_U32Ptr".}
proc ImPlot_ImMean_S64Ptr*(values: ptr ImS64; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_S64Ptr".}
proc ImPlot_ImMean_U64Ptr*(values: ptr ImU64; count: cint): cdouble {.cdecl, importc: "ImPlot_ImMean_U64Ptr".}
proc ImPlot_ImStdDev_FloatPtr*(values: ptr cfloat; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_FloatPtr".}
proc ImPlot_ImStdDev_doublePtr*(values: ptr cdouble; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_doublePtr".}
proc ImPlot_ImStdDev_S8Ptr*(values: cstring; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_S8Ptr".}
proc ImPlot_ImStdDev_U8Ptr*(values: ptr ImU8; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_U8Ptr".}
proc ImPlot_ImStdDev_S16Ptr*(values: ptr ImS16; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_S16Ptr".}
proc ImPlot_ImStdDev_U16Ptr*(values: ptr ImU16; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_U16Ptr".}
proc ImPlot_ImStdDev_S32Ptr*(values: ptr ImS32; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_S32Ptr".}
proc ImPlot_ImStdDev_U32Ptr*(values: ptr ImU32; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_U32Ptr".}
proc ImPlot_ImStdDev_S64Ptr*(values: ptr ImS64; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_S64Ptr".}
proc ImPlot_ImStdDev_U64Ptr*(values: ptr ImU64; count: cint): cdouble {.cdecl, importc: "ImPlot_ImStdDev_U64Ptr".}
proc ImPlot_ImMixU32*(a: ImU32; b: ImU32; s: ImU32): ImU32 {.cdecl, importc: "ImPlot_ImMixU32".}
proc ImPlot_ImLerpU32*(colors: ptr ImU32; size: cint; t: cfloat): ImU32 {.cdecl, importc: "ImPlot_ImLerpU32".}
proc ImPlot_ImAlphaU32*(col: ImU32; alpha: cfloat): ImU32 {.cdecl, importc: "ImPlot_ImAlphaU32".}
proc ImPlot_ImOverlaps_Float*(min_a: cfloat; max_a: cfloat; min_b: cfloat; max_b: cfloat): bool {.cdecl, importc: "ImPlot_ImOverlaps_Float".}
proc ImPlot_ImOverlaps_double*(min_a: cdouble; max_a: cdouble; min_b: cdouble; max_b: cdouble): bool {.cdecl, importc: "ImPlot_ImOverlaps_double".}
proc ImPlot_ImOverlaps_S8*(min_a: ImS8; max_a: ImS8; min_b: ImS8; max_b: ImS8): bool {.cdecl, importc: "ImPlot_ImOverlaps_S8".}
proc ImPlot_ImOverlaps_U8*(min_a: ImU8; max_a: ImU8; min_b: ImU8; max_b: ImU8): bool {.cdecl, importc: "ImPlot_ImOverlaps_U8".}
proc ImPlot_ImOverlaps_S16*(min_a: ImS16; max_a: ImS16; min_b: ImS16; max_b: ImS16): bool {.cdecl, importc: "ImPlot_ImOverlaps_S16".}
proc ImPlot_ImOverlaps_U16*(min_a: ImU16; max_a: ImU16; min_b: ImU16; max_b: ImU16): bool {.cdecl, importc: "ImPlot_ImOverlaps_U16".}
proc ImPlot_ImOverlaps_S32*(min_a: ImS32; max_a: ImS32; min_b: ImS32; max_b: ImS32): bool {.cdecl, importc: "ImPlot_ImOverlaps_S32".}
proc ImPlot_ImOverlaps_U32*(min_a: ImU32; max_a: ImU32; min_b: ImU32; max_b: ImU32): bool {.cdecl, importc: "ImPlot_ImOverlaps_U32".}
proc ImPlot_ImOverlaps_S64*(min_a: ImS64; max_a: ImS64; min_b: ImS64; max_b: ImS64): bool {.cdecl, importc: "ImPlot_ImOverlaps_S64".}
proc ImPlot_ImOverlaps_U64*(min_a: ImU64; max_a: ImU64; min_b: ImU64; max_b: ImU64): bool {.cdecl, importc: "ImPlot_ImOverlaps_U64".}
proc ImPlotDateTimeSpec_ImPlotDateTimeSpec_Nil*(): ptr ImPlotDateTimeSpec {.cdecl, importc: "ImPlotDateTimeSpec_ImPlotDateTimeSpec_Nil".}
proc ImPlotDateTimeSpec_destroy*(self: ptr ImPlotDateTimeSpec): void {.cdecl, importc: "ImPlotDateTimeSpec_destroy".}
proc ImPlotDateTimeSpec_ImPlotDateTimeSpec_PlotDateFmt*(date_fmt: ImPlotDateFmt; time_fmt: ImPlotTimeFmt; use_24_hr_clk: bool; use_iso_8601: bool): ptr ImPlotDateTimeSpec {.cdecl, importc: "ImPlotDateTimeSpec_ImPlotDateTimeSpec_PlotDateFmt".}
proc ImPlotTime_ImPlotTime_Nil*(): ptr ImPlotTime {.cdecl, importc: "ImPlotTime_ImPlotTime_Nil".}
proc ImPlotTime_destroy*(self: ptr ImPlotTime): void {.cdecl, importc: "ImPlotTime_destroy".}
...
proc ImPlotColormapData_AppendTable*(self: ptr ImPlotColormapData; cmap: ImPlotColormap): void {.cdecl, importc: "ImPlotColormapData__AppendTable".}
proc ImPlotColormapData_RebuildTables*(self: ptr ImPlotColormapData): void {.cdecl, importc: "ImPlotColormapData_RebuildTables".}
proc ImPlotColormapData_IsQual*(self: ptr ImPlotColormapData; cmap: ImPlotColormap): bool {.cdecl, importc: "ImPlotColormapData_IsQual".}
proc ImPlotColormapData_GetName*(self: ptr ImPlotColormapData; cmap: ImPlotColormap): cstring {.cdecl, importc: "ImPlotColormapData_GetName".}
proc ImPlotColormapData_GetIndex*(self: ptr ImPlotColormapData; name: cstring): ImPlotColormap {.cdecl, importc: "ImPlotColormapData_GetIndex".}
proc ImPlotColormapData_GetKeys*(self: ptr ImPlotColormapData; cmap: ImPlotColormap): ptr ImU32 {.cdecl, importc: "ImPlotColormapData_GetKeys".}
proc ImPlotColormapData_GetKeyCount*(self: ptr ImPlotColormapData; cmap: ImPlotColormap): cint {.cdecl, importc: "ImPlotColormapData_GetKeyCount".}
proc ImPlotColormapData_GetKeyColor*(self: ptr ImPlotColormapData; cmap: ImPlotColormap; idx: cint): ImU32 {.cdecl, importc: "ImPlotColormapData_GetKeyColor".}
proc ImPlotColormapData_SetKeyColor*(self: ptr ImPlotColormapData; cmap: ImPlotColormap; idx: cint; value: ImU32): void {.cdecl, importc: "ImPlotColormapData_SetKeyColor".}
proc ImPlotColormapData_GetTable*(self: ptr ImPlotColormapData; cmap: ImPlotColormap): ptr ImU32 {.cdecl, importc: "ImPlotColormapData_GetTable".}
...
proc ImPlotAxis_destroy*(self: ptr ImPlotAxis): void {.cdecl, importc: "ImPlotAxis_destroy".}
proc ImPlotAxis_Reset*(self: ptr ImPlotAxis): void {.cdecl, importc: "ImPlotAxis_Reset".}
...
proc ImPlotAxis_Constrain*(self: ptr ImPlotAxis): void {.cdecl, importc: "ImPlotAxis_Constrain".}
proc ImPlotAxis_UpdateTransformCache*(self: ptr ImPlotAxis): void {.cdecl, importc: "ImPlotAxis_UpdateTransformCache".}
proc ImPlotAxis_PlotToPixels*(self: ptr ImPlotAxis; plt: cdouble): cfloat {.cdecl, importc: "ImPlotAxis_PlotToPixels".}
proc ImPlotAxis_PixelsToPlot*(self: ptr ImPlotAxis; pix: cfloat): cdouble {.cdecl, importc: "ImPlotAxis_PixelsToPlot".}
proc ImPlotAxis_ExtendFit*(self: ptr ImPlotAxis; v: cdouble): void {.cdecl, importc: "ImPlotAxis_ExtendFit".}
proc ImPlotAxis_ExtendFitWith*(self: ptr ImPlotAxis; alt: ptr ImPlotAxis; v: cdouble; v_alt: cdouble): void {.cdecl, importc: "ImPlotAxis_ExtendFitWith".}
proc ImPlotAxis_ApplyFit*(self: ptr ImPlotAxis; padding: cfloat): void {.cdecl, importc: "ImPlotAxis_ApplyFit".}
proc ImPlotAxis_HasLabel*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_HasLabel".}
proc ImPlotAxis_HasGridLines*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_HasGridLines".}
proc ImPlotAxis_HasTickLabels*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_HasTickLabels".}
proc ImPlotAxis_HasTickMarks*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_HasTickMarks".}
proc ImPlotAxis_WillRender*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_WillRender".}
proc ImPlotAxis_IsOpposite*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsOpposite".}
proc ImPlotAxis_IsInverted*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsInverted".}
proc ImPlotAxis_IsForeground*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsForeground".}
proc ImPlotAxis_IsAutoFitting*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsAutoFitting".}
proc ImPlotAxis_CanInitFit*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_CanInitFit".}
proc ImPlotAxis_IsRangeLocked*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsRangeLocked".}
proc ImPlotAxis_IsLockedMin*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsLockedMin".}
proc ImPlotAxis_IsLockedMax*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsLockedMax".}
proc ImPlotAxis_IsLocked*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsLocked".}
proc ImPlotAxis_IsInputLockedMin*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsInputLockedMin".}
proc ImPlotAxis_IsInputLockedMax*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsInputLockedMax".}
proc ImPlotAxis_IsInputLocked*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_IsInputLocked".}
proc ImPlotAxis_HasMenus*(self: ptr ImPlotAxis): bool {.cdecl, importc: "ImPlotAxis_HasMenus".}
proc ImPlotAxis_IsPanLocked*(self: ptr ImPlotAxis; increasing: bool): bool {.cdecl, importc: "ImPlotAxis_IsPanLocked".}
proc ImPlotAxis_PushLinks*(self: ptr ImPlotAxis): void {.cdecl, importc: "ImPlotAxis_PushLinks".}
proc ImPlotAxis_PullLinks*(self: ptr ImPlotAxis): void {.cdecl, importc: "ImPlotAxis_PullLinks".}
proc ImPlotAlignmentData_ImPlotAlignmentData*(): ptr ImPlotAlignmentData {.cdecl, importc: "ImPlotAlignmentData_ImPlotAlignmentData".}
proc ImPlotAlignmentData_destroy*(self: ptr ImPlotAlignmentData): void {.cdecl, importc: "ImPlotAlignmentData_destroy".}
proc ImPlotAlignmentData_Begin*(self: ptr ImPlotAlignmentData): void {.cdecl, importc: "ImPlotAlignmentData_Begin".}
proc ImPlotAlignmentData_Update*(self: ptr ImPlotAlignmentData; pad_a: ptr cfloat; pad_b: ptr cfloat; delta_a: ptr cfloat; delta_b: ptr cfloat): void {.cdecl, importc: "ImPlotAlignmentData_Update".}
proc ImPlotAlignmentData_End*(self: ptr ImPlotAlignmentData): void {.cdecl, importc: "ImPlotAlignmentData_End".}
proc ImPlotAlignmentData_Reset*(self: ptr ImPlotAlignmentData): void {.cdecl, importc: "ImPlotAlignmentData_Reset".}
proc ImPlotItem_ImPlotItem*(): ptr ImPlotItem {.cdecl, importc: "ImPlotItem_ImPlotItem".}
proc ImPlotItem_destroy*(self: ptr ImPlotItem): void {.cdecl, importc: "ImPlotItem_destroy".}
proc ImPlotLegend_ImPlotLegend*(): ptr ImPlotLegend {.cdecl, importc: "ImPlotLegend_ImPlotLegend".}
proc ImPlotLegend_destroy*(self: ptr ImPlotLegend): void {.cdecl, importc: "ImPlotLegend_destroy".}
proc ImPlotLegend_Reset*(self: ptr ImPlotLegend): void {.cdecl, importc: "ImPlotLegend_Reset".}
proc ImPlotItemGroup_ImPlotItemGroup*(): ptr ImPlotItemGroup {.cdecl, importc: "ImPlotItemGroup_ImPlotItemGroup".}
proc ImPlotItemGroup_destroy*(self: ptr ImPlotItemGroup): void {.cdecl, importc: "ImPlotItemGroup_destroy".}
proc ImPlotItemGroup_GetItemCount*(self: ptr ImPlotItemGroup): cint {.cdecl, importc: "ImPlotItemGroup_GetItemCount".}
proc ImPlotItemGroup_GetItemID*(self: ptr ImPlotItemGroup; label_id: cstring): ImGuiID {.cdecl, importc: "ImPlotItemGroup_GetItemID".}
proc ImPlotItemGroup_GetItem_ID_proc*(self: ptr ImPlotItemGroup; id: ImGuiID): ptr ImPlotItem {.cdecl, importc: "ImPlotItemGroup_GetItem_ID".}
proc ImPlotItemGroup_GetItem_Str*(self: ptr ImPlotItemGroup; label_id: cstring): ptr ImPlotItem {.cdecl, importc: "ImPlotItemGroup_GetItem_Str".}
proc ImPlotItemGroup_GetOrAddItem*(self: ptr ImPlotItemGroup; id: ImGuiID): ptr ImPlotItem {.cdecl, importc: "ImPlotItemGroup_GetOrAddItem".}
proc ImPlotItemGroup_GetItemByIndex*(self: ptr ImPlotItemGroup; i: cint): ptr ImPlotItem {.cdecl, importc: "ImPlotItemGroup_GetItemByIndex".}
proc ImPlotItemGroup_GetItemIndex*(self: ptr ImPlotItemGroup; item: ptr ImPlotItem): cint {.cdecl, importc: "ImPlotItemGroup_GetItemIndex".}
proc ImPlotItemGroup_GetLegendCount*(self: ptr ImPlotItemGroup): cint {.cdecl, importc: "ImPlotItemGroup_GetLegendCount".}
proc ImPlotItemGroup_GetLegendItem*(self: ptr ImPlotItemGroup; i: cint): ptr ImPlotItem {.cdecl, importc: "ImPlotItemGroup_GetLegendItem".}
proc ImPlotItemGroup_GetLegendLabel*(self: ptr ImPlotItemGroup; i: cint): cstring {.cdecl, importc: "ImPlotItemGroup_GetLegendLabel".}
proc ImPlotItemGroup_Reset*(self: ptr ImPlotItemGroup): void {.cdecl, importc: "ImPlotItemGroup_Reset".}
proc ImPlotPlot_ImPlotPlot*(): ptr ImPlotPlot {.cdecl, importc: "ImPlotPlot_ImPlotPlot".}
proc ImPlotPlot_destroy*(self: ptr ImPlotPlot): void {.cdecl, importc: "ImPlotPlot_destroy".}
proc ImPlotPlot_IsInputLocked*(self: ptr ImPlotPlot): bool {.cdecl, importc: "ImPlotPlot_IsInputLocked".}
proc ImPlotPlot_ClearTextBuffer*(self: ptr ImPlotPlot): void {.cdecl, importc: "ImPlotPlot_ClearTextBuffer".}
proc ImPlotPlot_SetTitle*(self: ptr ImPlotPlot; title: cstring): void {.cdecl, importc: "ImPlotPlot_SetTitle".}
proc ImPlotPlot_HasTitle*(self: ptr ImPlotPlot): bool {.cdecl, importc: "ImPlotPlot_HasTitle".}
proc ImPlotPlot_GetTitle*(self: ptr ImPlotPlot): cstring {.cdecl, importc: "ImPlotPlot_GetTitle".}
proc ImPlotPlot_XAxis_Nil*(self: ptr ImPlotPlot; i: cint): ptr ImPlotAxis {.cdecl, importc: "ImPlotPlot_XAxis_Nil".}
proc ImPlotPlot_XAxis_const*(self: ptr ImPlotPlot; i: cint): ptr ImPlotAxis {.cdecl, importc: "ImPlotPlot_XAxis__const".}
proc ImPlotPlot_YAxis_Nil*(self: ptr ImPlotPlot; i: cint): ptr ImPlotAxis {.cdecl, importc: "ImPlotPlot_YAxis_Nil".}
proc ImPlotPlot_YAxis_const*(self: ptr ImPlotPlot; i: cint): ptr ImPlotAxis {.cdecl, importc: "ImPlotPlot_YAxis__const".}
...
proc ImPlotNextPlotData_destroy*(self: ptr ImPlotNextPlotData): void {.cdecl, importc: "ImPlotNextPlotData_destroy".}
proc ImPlotNextPlotData_Reset*(self: ptr ImPlotNextPlotData): void {.cdecl, importc: "ImPlotNextPlotData_Reset".}
proc ImPlotNextItemData_ImPlotNextItemData*(): ptr ImPlotNextItemData {.cdecl, importc: "ImPlotNextItemData_ImPlotNextItemData".}
proc ImPlotNextItemData_destroy*(self: ptr ImPlotNextItemData): void {.cdecl, importc: "ImPlotNextItemData_destroy".}
proc ImPlotNextItemData_Reset*(self: ptr ImPlotNextItemData): void {.cdecl, importc: "ImPlotNextItemData_Reset".}
proc ImPlot_Initialize*(ctx: ptr ImPlotContext): void {.cdecl, importc: "ImPlot_Initialize".}
proc ImPlot_ResetCtxForNextPlot*(ctx: ptr ImPlotContext): void {.cdecl, importc: "ImPlot_ResetCtxForNextPlot".}
proc ImPlot_ResetCtxForNextAlignedPlots*(ctx: ptr ImPlotContext): void {.cdecl, importc: "ImPlot_ResetCtxForNextAlignedPlots".}
proc ImPlot_ResetCtxForNextSubplot*(ctx: ptr ImPlotContext): void {.cdecl, importc: "ImPlot_ResetCtxForNextSubplot".}
proc ImPlot_GetPlot*(title: cstring): ptr ImPlotPlot {.cdecl, importc: "ImPlot_GetPlot".}
proc ImPlot_GetCurrentPlot*(): ptr ImPlotPlot {.cdecl, importc: "ImPlot_GetCurrentPlot".}
proc ImPlot_BustPlotCache*(): void {.cdecl, importc: "ImPlot_BustPlotCache".}
proc ImPlot_ShowPlotContextMenu*(plot: ptr ImPlotPlot): void {.cdecl, importc: "ImPlot_ShowPlotContextMenu".}
...
proc ImPlot_ShowSubplotsContextMenu*(subplot: ptr ImPlotSubplot): void {.cdecl, importc: "ImPlot_ShowSubplotsContextMenu".}
proc ImPlot_BeginItem*(label_id: cstring; flags: ImPlotItemFlags; recolor_from: ImPlotCol): bool {.cdecl, importc: "ImPlot_BeginItem".}
proc ImPlot_EndItem*(): void {.cdecl, importc: "ImPlot_EndItem".}
proc ImPlot_RegisterOrGetItem*(label_id: cstring; flags: ImPlotItemFlags; just_created: ptr bool): ptr ImPlotItem {.cdecl, importc: "ImPlot_RegisterOrGetItem".}
proc ImPlot_GetItem*(label_id: cstring): ptr ImPlotItem {.cdecl, importc: "ImPlot_GetItem".}
proc ImPlot_GetCurrentItem*(): ptr ImPlotItem {.cdecl, importc: "ImPlot_GetCurrentItem".}
proc ImPlot_BustItemCache*(): void {.cdecl, importc: "ImPlot_BustItemCache".}
proc ImPlot_AnyAxesInputLocked*(axes: ptr ImPlotAxis; count: cint): bool {.cdecl, importc: "ImPlot_AnyAxesInputLocked".}
proc ImPlot_AllAxesInputLocked*(axes: ptr ImPlotAxis; count: cint): bool {.cdecl, importc: "ImPlot_AllAxesInputLocked".}
proc ImPlot_AnyAxesHeld*(axes: ptr ImPlotAxis; count: cint): bool {.cdecl, importc: "ImPlot_AnyAxesHeld".}
proc ImPlot_AnyAxesHovered*(axes: ptr ImPlotAxis; count: cint): bool {.cdecl, importc: "ImPlot_AnyAxesHovered".}
...
proc ImPlot_FillRange_Vector_U8_Ptr*(buffer: ptr ImVector_ImU8; n: cint; vmin: ImU8; vmax: ImU8): void {.cdecl, importc: "ImPlot_FillRange_Vector_U8_Ptr".}
proc ImPlot_FillRange_Vector_S16_Ptr*(buffer: ptr ImVector_ImS16; n: cint; vmin: ImS16; vmax: ImS16): void {.cdecl, importc: "ImPlot_FillRange_Vector_S16_Ptr".}
proc ImPlot_FillRange_Vector_U16_Ptr*(buffer: ptr ImVector_ImU16; n: cint; vmin: ImU16; vmax: ImU16): void {.cdecl, importc: "ImPlot_FillRange_Vector_U16_Ptr".}
proc ImPlot_FillRange_Vector_S32_Ptr*(buffer: ptr ImVector_ImS32; n: cint; vmin: ImS32; vmax: ImS32): void {.cdecl, importc: "ImPlot_FillRange_Vector_S32_Ptr".}
...
proc ImPlot_TransformInverse_Log10*(v: cdouble; noname1: pointer): cdouble {.cdecl, importc: "ImPlot_TransformInverse_Log10".}
proc ImPlot_TransformForward_SymLog*(v: cdouble; noname1: pointer): cdouble {.cdecl, importc: "ImPlot_TransformForward_SymLog".}
proc ImPlot_TransformInverse_SymLog*(v: cdouble; noname1: pointer): cdouble {.cdecl, importc: "ImPlot_TransformInverse_SymLog".}
proc ImPlot_TransformForward_Logit*(v: cdouble; noname1: pointer): cdouble {.cdecl, importc: "ImPlot_TransformForward_Logit".}
proc ImPlot_TransformInverse_Logit*(v: cdouble; noname1: pointer): cdouble {.cdecl, importc: "ImPlot_TransformInverse_Logit".}
...
proc ImPlot3D_PlotScatter_S8Ptr*(label_id: cstring; xs: cstring; ys: cstring; zs: cstring; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_S8Ptr".}
proc ImPlot3D_PlotScatter_U8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; zs: ptr ImU8; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_U8Ptr".}
proc ImPlot3D_PlotScatter_S16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; zs: ptr ImS16; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_S16Ptr".}
proc ImPlot3D_PlotScatter_U16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; zs: ptr ImU16; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_U16Ptr".}
proc ImPlot3D_PlotScatter_S32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; zs: ptr ImS32; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_S32Ptr".}
proc ImPlot3D_PlotScatter_U32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; zs: ptr ImU32; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_U32Ptr".}
proc ImPlot3D_PlotScatter_S64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; zs: ptr ImS64; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_S64Ptr".}
proc ImPlot3D_PlotScatter_U64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; zs: ptr ImU64; count: cint; flags: ImPlot3DScatterFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotScatter_U64Ptr".}
proc ImPlot3D_PlotLine_FloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; zs: ptr cfloat; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_FloatPtr".}
proc ImPlot3D_PlotLine_doublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; zs: ptr cdouble; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_doublePtr".}
proc ImPlot3D_PlotLine_S8Ptr*(label_id: cstring; xs: cstring; ys: cstring; zs: cstring; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_S8Ptr".}
proc ImPlot3D_PlotLine_U8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; zs: ptr ImU8; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_U8Ptr".}
proc ImPlot3D_PlotLine_S16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; zs: ptr ImS16; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_S16Ptr".}
proc ImPlot3D_PlotLine_U16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; zs: ptr ImU16; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_U16Ptr".}
proc ImPlot3D_PlotLine_S32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; zs: ptr ImS32; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_S32Ptr".}
proc ImPlot3D_PlotLine_U32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; zs: ptr ImU32; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_U32Ptr".}
proc ImPlot3D_PlotLine_S64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; zs: ptr ImS64; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_S64Ptr".}
proc ImPlot3D_PlotLine_U64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; zs: ptr ImU64; count: cint; flags: ImPlot3DLineFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotLine_U64Ptr".}
proc ImPlot3D_PlotTriangle_FloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; zs: ptr cfloat; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_FloatPtr".}
proc ImPlot3D_PlotTriangle_doublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; zs: ptr cdouble; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_doublePtr".}
proc ImPlot3D_PlotTriangle_S8Ptr*(label_id: cstring; xs: cstring; ys: cstring; zs: cstring; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_S8Ptr".}
proc ImPlot3D_PlotTriangle_U8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; zs: ptr ImU8; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_U8Ptr".}
proc ImPlot3D_PlotTriangle_S16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; zs: ptr ImS16; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_S16Ptr".}
proc ImPlot3D_PlotTriangle_U16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; zs: ptr ImU16; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_U16Ptr".}
proc ImPlot3D_PlotTriangle_S32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; zs: ptr ImS32; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_S32Ptr".}
proc ImPlot3D_PlotTriangle_U32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; zs: ptr ImU32; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_U32Ptr".}
proc ImPlot3D_PlotTriangle_S64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; zs: ptr ImS64; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_S64Ptr".}
proc ImPlot3D_PlotTriangle_U64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; zs: ptr ImU64; count: cint; flags: ImPlot3DTriangleFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotTriangle_U64Ptr".}
proc ImPlot3D_PlotQuad_FloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; zs: ptr cfloat; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_FloatPtr".}
proc ImPlot3D_PlotQuad_doublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; zs: ptr cdouble; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_doublePtr".}
proc ImPlot3D_PlotQuad_S8Ptr*(label_id: cstring; xs: cstring; ys: cstring; zs: cstring; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_S8Ptr".}
proc ImPlot3D_PlotQuad_U8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; zs: ptr ImU8; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_U8Ptr".}
proc ImPlot3D_PlotQuad_S16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; zs: ptr ImS16; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_S16Ptr".}
proc ImPlot3D_PlotQuad_U16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; zs: ptr ImU16; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_U16Ptr".}
proc ImPlot3D_PlotQuad_S32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; zs: ptr ImS32; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_S32Ptr".}
proc ImPlot3D_PlotQuad_U32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; zs: ptr ImU32; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_U32Ptr".}
proc ImPlot3D_PlotQuad_S64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; zs: ptr ImS64; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_S64Ptr".}
proc ImPlot3D_PlotQuad_U64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; zs: ptr ImU64; count: cint; flags: ImPlot3DQuadFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotQuad_U64Ptr".}
proc ImPlot3D_PlotSurface_FloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; zs: ptr cfloat; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_FloatPtr".}
proc ImPlot3D_PlotSurface_doublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; zs: ptr cdouble; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_doublePtr".}
proc ImPlot3D_PlotSurface_S8Ptr*(label_id: cstring; xs: cstring; ys: cstring; zs: cstring; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_S8Ptr".}
proc ImPlot3D_PlotSurface_U8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; zs: ptr ImU8; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_U8Ptr".}
proc ImPlot3D_PlotSurface_S16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; zs: ptr ImS16; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_S16Ptr".}
proc ImPlot3D_PlotSurface_U16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; zs: ptr ImU16; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_U16Ptr".}
proc ImPlot3D_PlotSurface_S32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; zs: ptr ImS32; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_S32Ptr".}
proc ImPlot3D_PlotSurface_U32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; zs: ptr ImU32; x_count: cint; y_count: cint; scale_min: cdouble; scale_max: cdouble; flags: ImPlot3DSurfaceFlags; offset: cint; stride: cint): void {.cdecl, importc: "ImPlot3D_PlotSurface_U32Ptr".}
...
proc ImPlot3D_GetColormapCount*(): cint {.cdecl, importc: "ImPlot3D_GetColormapCount".}
proc ImPlot3D_GetColormapName*(cmap: ImPlot3DColormap): cstring {.cdecl, importc: "ImPlot3D_GetColormapName".}
proc ImPlot3D_GetColormapIndex*(name: cstring): ImPlot3DColormap {.cdecl, importc: "ImPlot3D_GetColormapIndex".}
...
proc SpinnerRainbowMixEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; ang_min: cfloat; ang_max: cfloat; arcs: cint; mode: cint): void {.cdecl, importc: "SpinnerRainbowMixEx".}
proc SpinnerRotatingHeart*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerRotatingHeart".}
proc SpinnerRotatingHeartEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; ang_min: cfloat): void {.cdecl, importc: "SpinnerRotatingHeartEx".}
proc SpinnerAng*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAng".}
proc SpinnerAngEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; angle: cfloat; mode: cint): void {.cdecl, importc: "SpinnerAngEx".}
proc SpinnerAng8*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAng8".}
proc SpinnerAng8Ex*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; angle: cfloat; mode: cint; rkoef: cfloat): void {.cdecl, importc: "SpinnerAng8Ex".}
proc SpinnerAngMix*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAngMix".}
proc SpinnerAngMixEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; angle: cfloat; arcs: cint; mode: cint): void {.cdecl, importc: "SpinnerAngMixEx".}
proc SpinnerLoadingRing*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerLoadingRing".}
proc SpinnerLoadingRingEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; segments: cint): void {.cdecl, importc: "SpinnerLoadingRingEx".}
proc SpinnerClock*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerClock".}
proc SpinnerClockEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerClockEx".}
proc SpinnerPulsar*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPulsar".}
proc SpinnerPulsarEx*(label: cstring; radius: cfloat; thickness: cfloat; bg: ImColor; speed: cfloat; sequence: bool; angle: cfloat; mode: cint): void {.cdecl, importc: "SpinnerPulsarEx".}
proc SpinnerDoubleFadePulsar*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerDoubleFadePulsar".}
proc SpinnerDoubleFadePulsarEx*(label: cstring; radius: cfloat; thickness: cfloat; bg: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerDoubleFadePulsarEx".}
proc SpinnerTwinPulsar*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerTwinPulsar".}
proc SpinnerTwinPulsarEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; rings: cint; mode: cint): void {.cdecl, importc: "SpinnerTwinPulsarEx".}
proc SpinnerFadePulsar*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerFadePulsar".}
proc SpinnerFadePulsarEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; rings: cint; mode: cint): void {.cdecl, importc: "SpinnerFadePulsarEx".}
proc SpinnerFadePulsarSquare*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerFadePulsarSquare".}
proc SpinnerFadePulsarSquareEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; rings: cint; mode: cint): void {.cdecl, importc: "SpinnerFadePulsarSquareEx".}
proc SpinnerCircularLines*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerCircularLines".}
proc SpinnerCircularLinesEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; lines: cint; mode: cint): void {.cdecl, importc: "SpinnerCircularLinesEx".}
proc SpinnerDots*(label: cstring; nextdot: ptr cfloat; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerDots".}
proc SpinnerDotsEx*(label: cstring; nextdot: ptr cfloat; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t; minth: cfloat; mode: cint): void {.cdecl, importc: "SpinnerDotsEx".}
proc SpinnerVDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerVDots".}
proc SpinnerVDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bgcolor: ImColor; speed: cfloat; dots: csize_t; mdots: csize_t; mode: cint): void {.cdecl, importc: "SpinnerVDotsEx".}
proc SpinnerBounceDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerBounceDots".}
proc SpinnerBounceDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t; mode: cint): void {.cdecl, importc: "SpinnerBounceDotsEx".}
proc SpinnerZipDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerZipDots".}
proc SpinnerZipDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t): void {.cdecl, importc: "SpinnerZipDotsEx".}
proc SpinnerDotsToPoints*(label: cstring; radius: cfloat; thickness: cfloat; offset_k: cfloat): void {.cdecl, importc: "SpinnerDotsToPoints".}
proc SpinnerDotsToPointsEx*(label: cstring; radius: cfloat; thickness: cfloat; offset_k: cfloat; color: ImColor; speed: cfloat; dots: csize_t): void {.cdecl, importc: "SpinnerDotsToPointsEx".}
proc SpinnerDotsToBar*(label: cstring; radius: cfloat; thickness: cfloat; offset_k: cfloat): void {.cdecl, importc: "SpinnerDotsToBar".}
proc SpinnerDotsToBarEx*(label: cstring; radius: cfloat; thickness: cfloat; offset_k: cfloat; color: ImColor; speed: cfloat; dots: csize_t): void {.cdecl, importc: "SpinnerDotsToBarEx".}
proc SpinnerWaveDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerWaveDots".}
proc SpinnerWaveDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint): void {.cdecl, importc: "SpinnerWaveDotsEx".}
proc SpinnerFadeDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerFadeDots".}
proc SpinnerFadeDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint; mode: cint): void {.cdecl, importc: "SpinnerFadeDotsEx".}
proc SpinnerThreeDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerThreeDots".}
proc SpinnerThreeDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint): void {.cdecl, importc: "SpinnerThreeDotsEx".}
proc SpinnerFiveDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerFiveDots".}
proc SpinnerFiveDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint): void {.cdecl, importc: "SpinnerFiveDotsEx".}
proc Spinner4Caleidospcope*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "Spinner4Caleidospcope".}
proc Spinner4CaleidospcopeEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint): void {.cdecl, importc: "Spinner4CaleidospcopeEx".}
proc SpinnerMultiFadeDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerMultiFadeDots".}
proc SpinnerMultiFadeDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint): void {.cdecl, importc: "SpinnerMultiFadeDotsEx".}
proc SpinnerThickToSin*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerThickToSin".}
proc SpinnerThickToSinEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; nt: cint; lt: cint; mode: cint): void {.cdecl, importc: "SpinnerThickToSinEx".}
proc SpinnerScaleDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerScaleDots".}
proc SpinnerScaleDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint): void {.cdecl, importc: "SpinnerScaleDotsEx".}
proc SpinnerSquareSpins*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSquareSpins".}
proc SpinnerSquareSpinsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSquareSpinsEx".}
proc SpinnerMovingDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerMovingDots".}
proc SpinnerMovingDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t): void {.cdecl, importc: "SpinnerMovingDotsEx".}
proc SpinnerRotateDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRotateDots".}
proc SpinnerRotateDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: cint; mode: cint): void {.cdecl, importc: "SpinnerRotateDotsEx".}
proc SpinnerOrionDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerOrionDots".}
proc SpinnerOrionDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: cint): void {.cdecl, importc: "SpinnerOrionDotsEx".}
proc SpinnerGalaxyDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerGalaxyDots".}
proc SpinnerGalaxyDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: cint): void {.cdecl, importc: "SpinnerGalaxyDotsEx".}
proc SpinnerTwinAng*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerTwinAng".}
proc SpinnerTwinAngEx*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat; color1: ImColor; color2: ImColor; speed: cfloat; angle: cfloat; mode: cint): void {.cdecl, importc: "SpinnerTwinAngEx".}
proc SpinnerFilling*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerFilling".}
proc SpinnerFillingEx*(label: cstring; radius: cfloat; thickness: cfloat; color1: ImColor; color2: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerFillingEx".}
proc SpinnerFillingMem*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; colorbg: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerFillingMem".}
proc SpinnerTopup*(label: cstring; radius1: cfloat; radius2: cfloat): void {.cdecl, importc: "SpinnerTopup".}
proc SpinnerTopupEx*(label: cstring; radius1: cfloat; radius2: cfloat; color: ImColor; fg: ImColor; bg: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerTopupEx".}
proc SpinnerTwinAng180*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerTwinAng180".}
proc SpinnerTwinAng180Ex*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat; color1: ImColor; color2: ImColor; speed: cfloat; angle: cfloat; mode: cint): void {.cdecl, importc: "SpinnerTwinAng180Ex".}
proc SpinnerTwinAng360*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerTwinAng360".}
proc SpinnerTwinAng360Ex*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat; color1: ImColor; color2: ImColor; speed1: cfloat; speed2: cfloat; mode: cint): void {.cdecl, importc: "SpinnerTwinAng360Ex".}
proc SpinnerIncDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerIncDots".}
proc SpinnerIncDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t): void {.cdecl, importc: "SpinnerIncDotsEx".}
proc SpinnerIncFullDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerIncFullDots".}
proc SpinnerIncFullDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t): void {.cdecl, importc: "SpinnerIncFullDotsEx".}
proc SpinnerFadeBars*(label: cstring; w: cfloat): void {.cdecl, importc: "SpinnerFadeBars".}
proc SpinnerFadeBarsEx*(label: cstring; w: cfloat; color: ImColor; speed: cfloat; bars: csize_t; scale: bool): void {.cdecl, importc: "SpinnerFadeBarsEx".}
proc SpinnerFadeTris*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerFadeTris".}
proc SpinnerFadeTrisEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; dim: csize_t; scale: bool; mode: cint): void {.cdecl, importc: "SpinnerFadeTrisEx".}
proc SpinnerBarsRotateFade*(label: cstring; rmin: cfloat; rmax: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerBarsRotateFade".}
proc SpinnerBarsRotateFadeEx*(label: cstring; rmin: cfloat; rmax: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; bars: csize_t): void {.cdecl, importc: "SpinnerBarsRotateFadeEx".}
proc SpinnerBarsScaleMiddle*(label: cstring; w: cfloat): void {.cdecl, importc: "SpinnerBarsScaleMiddle".}
proc SpinnerBarsScaleMiddleEx*(label: cstring; w: cfloat; color: ImColor; speed: cfloat; bars: csize_t): void {.cdecl, importc: "SpinnerBarsScaleMiddleEx".}
proc SpinnerAngTwin*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAngTwin".}
proc SpinnerAngTwinEx*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; angle: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerAngTwinEx".}
proc SpinnerArcRotation*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerArcRotation".}
proc SpinnerArcRotationEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerArcRotationEx".}
proc SpinnerArcFade*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerArcFade".}
proc SpinnerArcFadeEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerArcFadeEx".}
proc SpinnerSimpleArcFade*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSimpleArcFade".}
proc SpinnerSimpleArcFadeEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSimpleArcFadeEx".}
proc SpinnerSquareStrokeFade*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSquareStrokeFade".}
proc SpinnerSquareStrokeFadeEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSquareStrokeFadeEx".}
proc SpinnerAsciiSymbolPoints*(label: cstring; text: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAsciiSymbolPoints".}
proc SpinnerAsciiSymbolPointsEx*(label: cstring; text: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerAsciiSymbolPointsEx".}
proc SpinnerTextFading*(label: cstring; text: cstring; radius: cfloat; fsize: cfloat): void {.cdecl, importc: "SpinnerTextFading".}
proc SpinnerTextFadingEx*(label: cstring; text: cstring; radius: cfloat; fsize: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerTextFadingEx".}
proc SpinnerSevenSegments*(label: cstring; text: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSevenSegments".}
proc SpinnerSevenSegmentsEx*(label: cstring; text: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSevenSegmentsEx".}
proc SpinnerSquareStrokeFill*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSquareStrokeFill".}
proc SpinnerSquareStrokeFillEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSquareStrokeFillEx".}
proc SpinnerSquareStrokeLoading*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSquareStrokeLoading".}
proc SpinnerSquareStrokeLoadingEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSquareStrokeLoadingEx".}
proc SpinnerSquareLoading*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSquareLoading".}
proc SpinnerSquareLoadingEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSquareLoadingEx".}
proc SpinnerFilledArcFade*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerFilledArcFade".}
proc SpinnerFilledArcFadeEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerFilledArcFadeEx".}
proc SpinnerPointsRoller*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPointsRoller".}
proc SpinnerPointsRollerEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; points: csize_t; circles: cint; rspeed: cfloat): void {.cdecl, importc: "SpinnerPointsRollerEx".}
proc SpinnerPointsArcBounce*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPointsArcBounce".}
proc SpinnerPointsArcBounceEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; points: csize_t; circles: cint; rspeed: cfloat): void {.cdecl, importc: "SpinnerPointsArcBounceEx".}
proc SpinnerFilledArcColor*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerFilledArcColor".}
proc SpinnerFilledArcColorEx*(label: cstring; radius: cfloat; color: ImColor; bg: ImColor; speed: cfloat; arcs: csize_t): void {.cdecl, importc: "SpinnerFilledArcColorEx".}
proc SpinnerFilledArcRing*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerFilledArcRing".}
proc SpinnerFilledArcRingEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; arcs: csize_t): void {.cdecl, importc: "SpinnerFilledArcRingEx".}
proc SpinnerArcWedges*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerArcWedges".}
proc SpinnerArcWedgesEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerArcWedgesEx".}
proc SpinnerTwinBall*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat; b_thickness: cfloat): void {.cdecl, importc: "SpinnerTwinBall".}
proc SpinnerTwinBallEx*(label: cstring; radius1: cfloat; radius2: cfloat; thickness: cfloat; b_thickness: cfloat; ball: ImColor; bg: ImColor; speed: cfloat; balls: csize_t; mode: cint): void {.cdecl, importc: "SpinnerTwinBallEx".}
proc SpinnerSolarBalls*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSolarBalls".}
proc SpinnerSolarBallsEx*(label: cstring; radius: cfloat; thickness: cfloat; ball: ImColor; bg: ImColor; speed: cfloat; balls: csize_t): void {.cdecl, importc: "SpinnerSolarBallsEx".}
proc SpinnerSolarScaleBalls*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSolarScaleBalls".}
proc SpinnerSolarScaleBallsEx*(label: cstring; radius: cfloat; thickness: cfloat; ball: ImColor; speed: cfloat; balls: csize_t): void {.cdecl, importc: "SpinnerSolarScaleBallsEx".}
proc SpinnerSolarArcs*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSolarArcs".}
proc SpinnerSolarArcsEx*(label: cstring; radius: cfloat; thickness: cfloat; ball: ImColor; bg: ImColor; speed: cfloat; balls: csize_t): void {.cdecl, importc: "SpinnerSolarArcsEx".}
proc SpinnerMovingArcs*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerMovingArcs".}
proc SpinnerMovingArcsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t): void {.cdecl, importc: "SpinnerMovingArcsEx".}
proc SpinnerRainbowCircle*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRainbowCircle".}
proc SpinnerRainbowCircleEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cfloat): void {.cdecl, importc: "SpinnerRainbowCircleEx".}
proc SpinnerBounceBall*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerBounceBall".}
proc SpinnerBounceBallEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: cint; shadow: bool): void {.cdecl, importc: "SpinnerBounceBallEx".}
proc SpinnerPulsarBall*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPulsarBall".}
proc SpinnerPulsarBallEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; shadow: bool; mode: cint): void {.cdecl, importc: "SpinnerPulsarBallEx".}
proc SpinnerIncScaleDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerIncScaleDots".}
proc SpinnerIncScaleDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t; angle: cfloat; mode: cint): void {.cdecl, importc: "SpinnerIncScaleDotsEx".}
proc SpinnerSomeScaleDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSomeScaleDots".}
proc SpinnerSomeScaleDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t; mode: cint): void {.cdecl, importc: "SpinnerSomeScaleDotsEx".}
proc SpinnerAngTriple*(label: cstring; radius1: cfloat; radius2: cfloat; radius3: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAngTriple".}
proc SpinnerAngTripleEx*(label: cstring; radius1: cfloat; radius2: cfloat; radius3: cfloat; thickness: cfloat; c1: ImColor; c2: ImColor; c3: ImColor; speed: cfloat; angle: cfloat): void {.cdecl, importc: "SpinnerAngTripleEx".}
proc SpinnerAngEclipse*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAngEclipse".}
proc SpinnerAngEclipseEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; angle: cfloat): void {.cdecl, importc: "SpinnerAngEclipseEx".}
proc SpinnerIngYang*(label: cstring; radius: cfloat; thickness: cfloat; reverse: bool; yang_detlta_r: cfloat): void {.cdecl, importc: "SpinnerIngYang".}
proc SpinnerIngYangEx*(label: cstring; radius: cfloat; thickness: cfloat; reverse: bool; yang_detlta_r: cfloat; colorI: ImColor; colorY: ImColor; speed: cfloat; angle: cfloat; mode: cint): void {.cdecl, importc: "SpinnerIngYangEx".}
proc SpinnerGooeyBalls*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerGooeyBalls".}
proc SpinnerGooeyBallsEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; mode: cint): void {.cdecl, importc: "SpinnerGooeyBallsEx".}
proc SpinnerDotsLoading*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerDotsLoading".}
proc SpinnerRotateGooeyBalls*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; balls: cint): void {.cdecl, importc: "SpinnerRotateGooeyBalls".}
proc SpinnerRotateGooeyBallsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; balls: cint; mode: cint): void {.cdecl, importc: "SpinnerRotateGooeyBallsEx".}
proc SpinnerHerbertBalls*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; balls: cint): void {.cdecl, importc: "SpinnerHerbertBalls".}
proc SpinnerHerbertBalls3D*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerHerbertBalls3D".}
proc SpinnerRotateTriangles*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; tris: cint): void {.cdecl, importc: "SpinnerRotateTriangles".}
proc SpinnerRotateTrianglesEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; tris: cint; mode: cint): void {.cdecl, importc: "SpinnerRotateTrianglesEx".}
proc SpinnerRotateShapes*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; shapes: cint; pnt: cint): void {.cdecl, importc: "SpinnerRotateShapes".}
proc SpinnerSinSquares*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSinSquares".}
proc SpinnerSinSquaresEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; mode: cint): void {.cdecl, importc: "SpinnerSinSquaresEx".}
proc SpinnerMoonLine*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerMoonLine".}
proc SpinnerMoonLineEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; angle: cfloat): void {.cdecl, importc: "SpinnerMoonLineEx".}
proc SpinnerCircleDrop*(label: cstring; radius: cfloat; thickness: cfloat; thickness_drop: cfloat): void {.cdecl, importc: "SpinnerCircleDrop".}
proc SpinnerCircleDropEx*(label: cstring; radius: cfloat; thickness: cfloat; thickness_drop: cfloat; color: ImColor; bg: ImColor; speed: cfloat; angle: cfloat): void {.cdecl, importc: "SpinnerCircleDropEx".}
proc SpinnerSurroundedIndicator*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSurroundedIndicator".}
proc SpinnerSurroundedIndicatorEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSurroundedIndicatorEx".}
proc SpinnerWifiIndicator*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerWifiIndicator".}
...
proc SpinnerRotateSegmentsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; layers: csize_t; mode: cint): void {.cdecl, importc: "SpinnerRotateSegmentsEx".}
proc SpinnerLemniscate*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerLemniscate".}
proc SpinnerLemniscateEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; angle: cfloat): void {.cdecl, importc: "SpinnerLemniscateEx".}
proc SpinnerRotateGear*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRotateGear".}
proc SpinnerRotateGearEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; pins: csize_t): void {.cdecl, importc: "SpinnerRotateGearEx".}
proc SpinnerRotateWheel*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRotateWheel".}
proc SpinnerRotateWheelEx*(label: cstring; radius: cfloat; thickness: cfloat; bg_color: ImColor; color: ImColor; speed: cfloat; pins: csize_t): void {.cdecl, importc: "SpinnerRotateWheelEx".}
proc SpinnerAtom*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerAtom".}
proc SpinnerAtomEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; elipses: cint): void {.cdecl, importc: "SpinnerAtomEx".}
proc SpinnerPatternRings*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPatternRings".}
proc SpinnerPatternRingsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; elipses: cint): void {.cdecl, importc: "SpinnerPatternRingsEx".}
proc SpinnerPatternEclipse*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPatternEclipse".}
proc SpinnerPatternEclipseEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; elipses: cint; delta_a: cfloat; delta_y: cfloat): void {.cdecl, importc: "SpinnerPatternEclipseEx".}
proc SpinnerPatternSphere*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPatternSphere".}
proc SpinnerPatternSphereEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; elipses: cint): void {.cdecl, importc: "SpinnerPatternSphereEx".}
proc SpinnerRingSynchronous*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRingSynchronous".}
proc SpinnerRingSynchronousEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; elipses: cint): void {.cdecl, importc: "SpinnerRingSynchronousEx".}
proc SpinnerRingWatermarks*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRingWatermarks".}
proc SpinnerRingWatermarksEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; elipses: cint): void {.cdecl, importc: "SpinnerRingWatermarksEx".}
proc SpinnerRotatedAtom*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRotatedAtom".}
proc SpinnerRotatedAtomEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; elipses: cint; mode: cint): void {.cdecl, importc: "SpinnerRotatedAtomEx".}
proc SpinnerRainbowBalls*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerRainbowBalls".}
proc SpinnerRainbowBallsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; balls: cint; mode: cint; rings: cint; mx: cint): void {.cdecl, importc: "SpinnerRainbowBallsEx".}
proc SpinnerRainbowShot*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerRainbowShot".}
proc SpinnerRainbowShotEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; balls: cint; mode: cint): void {.cdecl, importc: "SpinnerRainbowShotEx".}
proc SpinnerSpiral*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSpiral".}
proc SpinnerSpiralEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t): void {.cdecl, importc: "SpinnerSpiralEx".}
proc SpinnerSpiralEye*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSpiralEye".}
proc SpinnerSpiralEyeEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSpiralEyeEx".}
proc SpinnerBarChartSine*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerBarChartSine".}
proc SpinnerBarChartSineEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; bars: cint; mode: cint): void {.cdecl, importc: "SpinnerBarChartSineEx".}
proc SpinnerBarChartAdvSine*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerBarChartAdvSine".}
proc SpinnerBarChartAdvSineEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; mode: cint): void {.cdecl, importc: "SpinnerBarChartAdvSineEx".}
proc SpinnerBarChartAdvSineFade*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerBarChartAdvSineFade".}
proc SpinnerBarChartAdvSineFadeEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; mode: cint): void {.cdecl, importc: "SpinnerBarChartAdvSineFadeEx".}
proc SpinnerBarChartRainbow*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerBarChartRainbow".}
proc SpinnerBarChartRainbowEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; bars: cint; mode: cint): void {.cdecl, importc: "SpinnerBarChartRainbowEx".}
proc SpinnerBlocks*(label: cstring; radius: cfloat; thickness: cfloat; bg: ImColor; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerBlocks".}
proc SpinnerTwinBlocks*(label: cstring; radius: cfloat; thickness: cfloat; bg: ImColor; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerTwinBlocks".}
proc SpinnerSquareRandomDots*(label: cstring; radius: cfloat; thickness: cfloat; bg: ImColor; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSquareRandomDots".}
proc SpinnerScaleBlocks*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerScaleBlocks".}
proc SpinnerScaleBlocksEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; mode: cint): void {.cdecl, importc: "SpinnerScaleBlocksEx".}
proc SpinnerScaleSquares*(label: cstring; radius: cfloat; thikness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerScaleSquares".}
proc SpinnerSquishSquare*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSquishSquare".}
proc SpinnerFluid*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerFluid".}
proc SpinnerFluidEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; bars: cint): void {.cdecl, importc: "SpinnerFluidEx".}
proc SpinnerFluidPoints*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerFluidPoints".}
proc SpinnerFluidPointsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; dots: csize_t; delta: cfloat): void {.cdecl, importc: "SpinnerFluidPointsEx".}
proc SpinnerArcPolarFade*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerArcPolarFade".}
proc SpinnerArcPolarFadeEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerArcPolarFadeEx".}
proc SpinnerArcPolarRadius*(label: cstring; radius: cfloat): void {.cdecl, importc: "SpinnerArcPolarRadius".}
proc SpinnerArcPolarRadiusEx*(label: cstring; radius: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerArcPolarRadiusEx".}
proc SpinnerCaleidoscope*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerCaleidoscope".}
proc SpinnerCaleidoscopeEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; mode: cint): void {.cdecl, importc: "SpinnerCaleidoscopeEx".}
proc SpinnerHboDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerHboDots".}
proc SpinnerHboDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; minfade: cfloat; ryk: cfloat; speed: cfloat; dots: csize_t; mode: cint): void {.cdecl, importc: "SpinnerHboDotsEx".}
proc SpinnerMoonDots*(label: cstring; radius: cfloat; thickness: cfloat; first: ImColor; second: ImColor): void {.cdecl, importc: "SpinnerMoonDots".}
proc SpinnerMoonDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; first: ImColor; second: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerMoonDotsEx".}
proc SpinnerTwinHboDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerTwinHboDots".}
proc SpinnerTwinHboDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; minfade: cfloat; ryk: cfloat; speed: cfloat; dots: csize_t; delta: cfloat): void {.cdecl, importc: "SpinnerTwinHboDotsEx".}
proc SpinnerThreeDotsStar*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerThreeDotsStar".}
proc SpinnerThreeDotsStarEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; minfade: cfloat; ryk: cfloat; speed: cfloat; delta: cfloat): void {.cdecl, importc: "SpinnerThreeDotsStarEx".}
proc SpinnerSineArcs*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSineArcs".}
proc SpinnerSineArcsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSineArcsEx".}
proc SpinnerTrianglesShift*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerTrianglesShift".}
proc SpinnerTrianglesShiftEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; bars: csize_t): void {.cdecl, importc: "SpinnerTrianglesShiftEx".}
proc SpinnerPointsShift*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerPointsShift".}
proc SpinnerPointsShiftEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; bars: csize_t): void {.cdecl, importc: "SpinnerPointsShiftEx".}
proc SpinnerSwingDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSwingDots".}
proc SpinnerSwingDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat): void {.cdecl, importc: "SpinnerSwingDotsEx".}
proc SpinnerCircularPoints*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerCircularPoints".}
proc SpinnerCircularPointsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lines: cint): void {.cdecl, importc: "SpinnerCircularPointsEx".}
proc SpinnerCurvedCircle*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerCurvedCircle".}
proc SpinnerCurvedCircleEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; circles: csize_t): void {.cdecl, importc: "SpinnerCurvedCircleEx".}
proc SpinnerModCircle*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerModCircle".}
proc SpinnerModCircleEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; ang_min: cfloat; ang_max: cfloat; speed: cfloat): void {.cdecl, importc: "SpinnerModCircleEx".}
proc SpinnerDnaDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerDnaDots".}
proc SpinnerDnaDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint; delta: cfloat; mode: bool): void {.cdecl, importc: "SpinnerDnaDotsEx".}
proc Spinner3SmuggleDots*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "Spinner3SmuggleDots".}
proc Spinner3SmuggleDotsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint; delta: cfloat; mode: bool): void {.cdecl, importc: "Spinner3SmuggleDotsEx".}
proc SpinnerRotateSegmentsPulsar*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerRotateSegmentsPulsar".}
proc SpinnerRotateSegmentsPulsarEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; arcs: csize_t; layers: csize_t): void {.cdecl, importc: "SpinnerRotateSegmentsPulsarEx".}
proc SpinnerSplineAng*(label: cstring; radius: cfloat; thickness: cfloat): void {.cdecl, importc: "SpinnerSplineAng".}
proc SpinnerSplineAngEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; bg: ImColor; speed: cfloat; angle: cfloat; mode: cint): void {.cdecl, importc: "SpinnerSplineAngEx".}
...
proc TextEditor_IsShowWhitespacesEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsShowWhitespacesEnabled".}
proc TextEditor_SetShowSpacesEnabled*(self: ptr TextEditor; value: bool): void {.cdecl, importc: "TextEditor_SetShowSpacesEnabled".}
proc TextEditor_IsShowSpacesEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsShowSpacesEnabled".}
proc TextEditor_SetShowTabsEnabled*(self: ptr TextEditor; value: bool): void {.cdecl, importc: "TextEditor_SetShowTabsEnabled".}
...
proc TextEditor_IsShowPanScrollIndicatorEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsShowPanScrollIndicatorEnabled".}
proc TextEditor_SetShowMatchingBrackets*(self: ptr TextEditor; value: bool): void {.cdecl, importc: "TextEditor_SetShowMatchingBrackets".}
...
proc TextEditor_Paste*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_Paste".}
proc TextEditor_Undo*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_Undo".}
proc TextEditor_Redo*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_Redo".}
...
proc TextEditor_AllCursorsHaveSelection*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_AllCursorsHaveSelection".}
...
proc TextEditor_ReplaceTextInCurrentCursor*(self: ptr TextEditor; text: cstring): void {.cdecl, importc: "TextEditor_ReplaceTextInCurrentCursor".}
proc TextEditor_ReplaceTextInAllCursors*(self: ptr TextEditor; text: cstring): void {.cdecl, importc: "TextEditor_ReplaceTextInAllCursors".}
proc TextEditor_OpenFindReplaceWindow*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_OpenFindReplaceWindow".}
proc TextEditor_CloseFindReplaceWindow*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_CloseFindReplaceWindow".}
proc TextEditor_SetFindButtonLabel*(self: ptr TextEditor; label: cstring): void {.cdecl, importc: "TextEditor_SetFindButtonLabel".}
proc TextEditor_SetFindAllButtonLabel*(self: ptr TextEditor; label: cstring): void {.cdecl, importc: "TextEditor_SetFindAllButtonLabel".}
proc TextEditor_SetReplaceButtonLabel*(self: ptr TextEditor; label: cstring): void {.cdecl, importc: "TextEditor_SetReplaceButtonLabel".}
proc TextEditor_SetReplaceAllButtonLabel*(self: ptr TextEditor; label: cstring): void {.cdecl, importc: "TextEditor_SetReplaceAllButtonLabel".}
...
proc TextEditor_MoveDownLines*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_MoveDownLines".}
proc TextEditor_ToggleComments*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_ToggleComments".}
proc TextEditor_FilterSelections*(self: ptr TextEditor; cb: proc (a0: cstring): cstring {.cdecl.}): void {.cdecl, importc: "TextEditor_FilterSelections".}
proc TextEditor_SelectionToLowerCase*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_SelectionToLowerCase".}
proc TextEditor_SelectionToUpperCase*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_SelectionToUpperCase".}
proc TextEditor_StripTrailingWhitespaces*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_StripTrailingWhitespaces".}
...
proc TextEditor_GetDefaultPalette*(): ptr Palette {.cdecl, importc: "TextEditor_GetDefaultPalette".}
proc TextEditor_GetDarkPalette*(): ptr Palette {.cdecl, importc: "TextEditor_GetDarkPalette".}
proc TextEditor_GetLightPalette*(): ptr Palette {.cdecl, importc: "TextEditor_GetLightPalette".}
proc Glyph_Glyph_Nil*(): ptr Glyph {.cdecl, importc: "Glyph_Glyph_Nil".}
...
proc Language_AngelScript*(): ptr Language {.cdecl, importc: "Language_AngelScript".}
proc Language_Lua*(): ptr Language {.cdecl, importc: "Language_Lua".}
proc Language_Python*(): ptr Language {.cdecl, importc: "Language_Python".}
proc Language_Glsl*(): ptr Language {.cdecl, importc: "Language_Glsl".}
proc Language_Hlsl*(): ptr Language {.cdecl, importc: "Language_Hlsl".}
...
proc CodePoint_isWord*(codepoint: ImWchar): bool {.cdecl, importc: "CodePoint_isWord".}
proc CodePoint_isWhiteSpace*(codepoint: ImWchar): bool {.cdecl, importc: "CodePoint_isWhiteSpace".}
proc CodePoint_isXidStart*(codepoint: ImWchar): bool {.cdecl, importc: "CodePoint_isXidStart".}
...
proc CodePoint_isPairCloser*(ch: ImWchar): bool {.cdecl, importc: "CodePoint_isPairCloser".}
proc CodePoint_toPairCloser*(ch: ImWchar): ImWchar {.cdecl, importc: "CodePoint_toPairCloser".}
proc CodePoint_toPairOpener*(ch: ImWchar): ImWchar {.cdecl, importc: "CodePoint_toPairOpener".}
proc CodePoint_isMatchingPair*(open: ImWchar; close: ImWchar): bool {.cdecl, importc: "CodePoint_isMatchingPair".}
...
proc LinkDetachWithModifierClick_destroy*(self: ptr LinkDetachWithModifierClick): void {.cdecl, importc: "LinkDetachWithModifierClick_destroy".}
proc MultipleSelectModifier_MultipleSelectModifier*(): ptr MultipleSelectModifier {.cdecl, importc: "MultipleSelectModifier_MultipleSelectModifier".}
proc MultipleSelectModifier_destroy*(self: ptr MultipleSelectModifier): void {.cdecl, importc: "MultipleSelectModifier_destroy".}
proc ImNodesIO_ImNodesIO*(): ptr ImNodesIO {.cdecl, importc: "ImNodesIO_ImNodesIO".}
proc ImNodesIO_destroy*(self: ptr ImNodesIO): void {.cdecl, importc: "ImNodesIO_destroy".}
proc ImNodesStyle_ImNodesStyle*(): ptr ImNodesStyle {.cdecl, importc: "ImNodesStyle_ImNodesStyle".}
proc ImNodesStyle_destroy*(self: ptr ImNodesStyle): void {.cdecl, importc: "ImNodesStyle_destroy".}
proc imnodes_SetImGuiContext*(ctx: ptr ImGuiContext): void {.cdecl, importc: "imnodes_SetImGuiContext".}
proc imnodes_CreateContext*(): ptr ImNodesContext {.cdecl, importc: "imnodes_CreateContext".}
proc imnodes_DestroyContext*(ctx: ptr ImNodesContext): void {.cdecl, importc: "imnodes_DestroyContext".}
proc imnodes_GetCurrentContext*(): ptr ImNodesContext {.cdecl, importc: "imnodes_GetCurrentContext".}
proc imnodes_SetCurrentContext*(ctx: ptr ImNodesContext): void {.cdecl, importc: "imnodes_SetCurrentContext".}
proc imnodes_EditorContextCreate*(): ptr ImNodesEditorContext {.cdecl, importc: "imnodes_EditorContextCreate".}
proc imnodes_EditorContextFree*(noname1: ptr ImNodesEditorContext): void {.cdecl, importc: "imnodes_EditorContextFree".}
proc imnodes_EditorContextSet*(noname1: ptr ImNodesEditorContext): void {.cdecl, importc: "imnodes_EditorContextSet".}
proc imnodes_EditorContextGetPanning*(): ImVec2_c {.cdecl, importc: "imnodes_EditorContextGetPanning".}
proc imnodes_EditorContextResetPanning*(pos: ImVec2_c): void {.cdecl, importc: "imnodes_EditorContextResetPanning".}
proc imnodes_EditorContextMoveToNode*(node_id: cint): void {.cdecl, importc: "imnodes_EditorContextMoveToNode".}
...
proc imnodes_StyleColorsDark*(dest: ptr ImNodesStyle): void {.cdecl, importc: "imnodes_StyleColorsDark".}
proc imnodes_StyleColorsClassic*(dest: ptr ImNodesStyle): void {.cdecl, importc: "imnodes_StyleColorsClassic".}
proc imnodes_StyleColorsLight*(dest: ptr ImNodesStyle): void {.cdecl, importc: "imnodes_StyleColorsLight".}
proc imnodes_BeginNodeEditor*(): void {.cdecl, importc: "imnodes_BeginNodeEditor".}
proc imnodes_EndNodeEditor*(): void {.cdecl, importc: "imnodes_EndNodeEditor".}
proc imnodes_MiniMap*(minimap_size_fraction: cfloat; location: ImNodesMiniMapLocation; node_hovering_callback: ImNodesMiniMapNodeHoveringCallback; node_hovering_callback_data: ImNodesMiniMapNodeHoveringCallbackUserData): void {.cdecl, importc: "imnodes_MiniMap".}
proc imnodes_PushColorStyle*(item: ImNodesCol; color: cuint): void {.cdecl, importc: "imnodes_PushColorStyle".}
proc imnodes_PopColorStyle*(): void {.cdecl, importc: "imnodes_PopColorStyle".}
proc imnodes_PushStyleVar_Float*(style_item: ImNodesStyleVar; value: cfloat): void {.cdecl, importc: "imnodes_PushStyleVar_Float".}
proc imnodes_PushStyleVar_Vec2*(style_item: ImNodesStyleVar; value: ImVec2_c): void {.cdecl, importc: "imnodes_PushStyleVar_Vec2".}
proc imnodes_PopStyleVar*(count: cint): void {.cdecl, importc: "imnodes_PopStyleVar".}
...
proc imnodes_GetNodeDimensions*(id: cint): ImVec2_c {.cdecl, importc: "imnodes_GetNodeDimensions".}
proc imnodes_BeginNodeTitleBar*(): void {.cdecl, importc: "imnodes_BeginNodeTitleBar".}
proc imnodes_EndNodeTitleBar*(): void {.cdecl, importc: "imnodes_EndNodeTitleBar".}
proc imnodes_BeginInputAttribute*(id: cint; shape: ImNodesPinShape): void {.cdecl, importc: "imnodes_BeginInputAttribute".}
proc imnodes_EndInputAttribute*(): void {.cdecl, importc: "imnodes_EndInputAttribute".}
proc imnodes_BeginOutputAttribute*(id: cint; shape: ImNodesPinShape): void {.cdecl, importc: "imnodes_BeginOutputAttribute".}
proc imnodes_EndOutputAttribute*(): void {.cdecl, importc: "imnodes_EndOutputAttribute".}
proc imnodes_BeginStaticAttribute*(id: cint): void {.cdecl, importc: "imnodes_BeginStaticAttribute".}
proc imnodes_EndStaticAttribute*(): void {.cdecl, importc: "imnodes_EndStaticAttribute".}
proc imnodes_PushAttributeFlag*(flag: ImNodesAttributeFlags): void {.cdecl, importc: "imnodes_PushAttributeFlag".}
proc imnodes_PopAttributeFlag*(): void {.cdecl, importc: "imnodes_PopAttributeFlag".}
proc imnodes_Link*(id: cint; start_attribute_id: cint; end_attribute_id: cint): void {.cdecl, importc: "imnodes_Link".}
proc imnodes_SetNodeDraggable*(node_id: cint; draggable: bool): void {.cdecl, importc: "imnodes_SetNodeDraggable".}
proc imnodes_SetNodeScreenSpacePos*(node_id: cint; screen_space_pos: ImVec2_c): void {.cdecl, importc: "imnodes_SetNodeScreenSpacePos".}
proc imnodes_SetNodeEditorSpacePos*(node_id: cint; editor_space_pos: ImVec2_c): void {.cdecl, importc: "imnodes_SetNodeEditorSpacePos".}
proc imnodes_SetNodeGridSpacePos*(node_id: cint; grid_pos: ImVec2_c): void {.cdecl, importc: "imnodes_SetNodeGridSpacePos".}
proc imnodes_GetNodeScreenSpacePos*(node_id: cint): ImVec2_c {.cdecl, importc: "imnodes_GetNodeScreenSpacePos".}
proc imnodes_GetNodeEditorSpacePos*(node_id: cint): ImVec2_c {.cdecl, importc: "imnodes_GetNodeEditorSpacePos".}
proc imnodes_GetNodeGridSpacePos*(node_id: cint): ImVec2_c {.cdecl, importc: "imnodes_GetNodeGridSpacePos".}
proc imnodes_SnapNodeToGrid*(node_id: cint): void {.cdecl, importc: "imnodes_SnapNodeToGrid".}
proc imnodes_IsEditorHovered*(): bool {.cdecl, importc: "imnodes_IsEditorHovered".}
proc imnodes_IsNodeHovered*(node_id: ptr cint): bool {.cdecl, importc: "imnodes_IsNodeHovered".}
proc imnodes_IsLinkHovered*(link_id: ptr cint): bool {.cdecl, importc: "imnodes_IsLinkHovered".}
proc imnodes_IsPinHovered*(attribute_id: ptr cint): bool {.cdecl, importc: "imnodes_IsPinHovered".}
proc imnodes_NumSelectedNodes*(): cint {.cdecl, importc: "imnodes_NumSelectedNodes".}
proc imnodes_NumSelectedLinks*(): cint {.cdecl, importc: "imnodes_NumSelectedLinks".}
proc imnodes_GetSelectedNodes*(node_ids: ptr cint): void {.cdecl, importc: "imnodes_GetSelectedNodes".}
proc imnodes_GetSelectedLinks*(link_ids: ptr cint): void {.cdecl, importc: "imnodes_GetSelectedLinks".}
proc imnodes_ClearNodeSelection_Nil*(): void {.cdecl, importc: "imnodes_ClearNodeSelection_Nil".}
proc imnodes_ClearLinkSelection_Nil*(): void {.cdecl, importc: "imnodes_ClearLinkSelection_Nil".}
proc imnodes_SelectNode*(node_id: cint): void {.cdecl, importc: "imnodes_SelectNode".}
proc imnodes_ClearNodeSelection_Int*(node_id: cint): void {.cdecl, importc: "imnodes_ClearNodeSelection_Int".}
proc imnodes_IsNodeSelected*(node_id: cint): bool {.cdecl, importc: "imnodes_IsNodeSelected".}
proc imnodes_SelectLink*(link_id: cint): void {.cdecl, importc: "imnodes_SelectLink".}
proc imnodes_ClearLinkSelection_Int*(link_id: cint): void {.cdecl, importc: "imnodes_ClearLinkSelection_Int".}
proc imnodes_IsLinkSelected*(link_id: cint): bool {.cdecl, importc: "imnodes_IsLinkSelected".}
proc imnodes_IsAttributeActive*(): bool {.cdecl, importc: "imnodes_IsAttributeActive".}
proc imnodes_IsAnyAttributeActive*(attribute_id: ptr cint): bool {.cdecl, importc: "imnodes_IsAnyAttributeActive".}
proc imnodes_IsLinkStarted*(started_at_attribute_id: ptr cint): bool {.cdecl, importc: "imnodes_IsLinkStarted".}
proc imnodes_IsLinkDropped*(started_at_attribute_id: ptr cint; including_detached_links: bool): bool {.cdecl, importc: "imnodes_IsLinkDropped".}
proc imnodes_IsLinkCreated_BoolPtr*(started_at_attribute_id: ptr cint; ended_at_attribute_id: ptr cint; created_from_snap: ptr bool): bool {.cdecl, importc: "imnodes_IsLinkCreated_BoolPtr".}
proc imnodes_IsLinkCreated_IntPtr*(started_at_node_id: ptr cint; started_at_attribute_id: ptr cint; ended_at_node_id: ptr cint; ended_at_attribute_id: ptr cint; created_from_snap: ptr bool): bool {.cdecl, importc: "imnodes_IsLinkCreated_IntPtr".}
proc imnodes_IsLinkDestroyed*(link_id: ptr cint): bool {.cdecl, importc: "imnodes_IsLinkDestroyed".}
proc imnodes_SaveCurrentEditorStateToIniString*(data_size: ptr csize_t): cstring {.cdecl, importc: "imnodes_SaveCurrentEditorStateToIniString".}
proc imnodes_SaveEditorStateToIniString*(editor: ptr ImNodesEditorContext; data_size: ptr csize_t): cstring {.cdecl, importc: "imnodes_SaveEditorStateToIniString".}
proc imnodes_LoadCurrentEditorStateFromIniString*(data: cstring; data_size: csize_t): void {.cdecl, importc: "imnodes_LoadCurrentEditorStateFromIniString".}
proc imnodes_LoadEditorStateFromIniString*(editor: ptr ImNodesEditorContext; data: cstring; data_size: csize_t): void {.cdecl, importc: "imnodes_LoadEditorStateFromIniString".}
proc imnodes_SaveCurrentEditorStateToIniFile*(file_name: cstring): void {.cdecl, importc: "imnodes_SaveCurrentEditorStateToIniFile".}
proc imnodes_SaveEditorStateToIniFile*(editor: ptr ImNodesEditorContext; file_name: cstring): void {.cdecl, importc: "imnodes_SaveEditorStateToIniFile".}
proc imnodes_LoadCurrentEditorStateFromIniFile*(file_name: cstring): void {.cdecl, importc: "imnodes_LoadCurrentEditorStateFromIniFile".}
proc imnodes_LoadEditorStateFromIniFile*(editor: ptr ImNodesEditorContext; file_name: cstring): void {.cdecl, importc: "imnodes_LoadEditorStateFromIniFile".}
proc getIOKeyCtrlPtr*(): ptr bool {.cdecl, importc: "getIOKeyCtrlPtr".}
proc ImGuizmo_SetDrawlist*(drawlist: ptr ImDrawList): void {.cdecl, importc: "ImGuizmo_SetDrawlist".}
proc ImGuizmo_BeginFrame*(): void {.cdecl, importc: "ImGuizmo_BeginFrame".}
proc ImGuizmo_SetImGuiContext*(ctx: ptr ImGuiContext): void {.cdecl, importc: "ImGuizmo_SetImGuiContext".}
proc ImGuizmo_IsOver_Nil*(): bool {.cdecl, importc: "ImGuizmo_IsOver_Nil".}
proc ImGuizmo_IsUsing*(): bool {.cdecl, importc: "ImGuizmo_IsUsing".}
proc ImGuizmo_IsUsingViewManipulate*(): bool {.cdecl, importc: "ImGuizmo_IsUsingViewManipulate".}
proc ImGuizmo_IsViewManipulateHovered*(): bool {.cdecl, importc: "ImGuizmo_IsViewManipulateHovered".}
...
proc ImGuizmo_DecomposeMatrixToComponents*(matrix: ptr cfloat; translation: ptr cfloat; rotation: ptr cfloat; scale: ptr cfloat): void {.cdecl, importc: "ImGuizmo_DecomposeMatrixToComponents".}
proc ImGuizmo_RecomposeMatrixFromComponents*(translation: ptr cfloat; rotation: ptr cfloat; scale: ptr cfloat; matrix: ptr cfloat): void {.cdecl, importc: "ImGuizmo_RecomposeMatrixFromComponents".}
proc ImGuizmo_SetRect*(x: cfloat; y: cfloat; width: cfloat; height: cfloat): void {.cdecl, importc: "ImGuizmo_SetRect".}
proc ImGuizmo_SetOrthographic*(isOrthographic: bool): void {.cdecl, importc: "ImGuizmo_SetOrthographic".}
proc ImGuizmo_DrawAxes*(view: ptr cfloat; projection: ptr cfloat; matrices: ptr cfloat; matrixCount: cint): void {.cdecl, importc: "ImGuizmo_DrawAxes".}
proc ImGuizmo_DrawCubes*(view: ptr cfloat; projection: ptr cfloat; matrices: ptr cfloat; matrixCount: cint): void {.cdecl, importc: "ImGuizmo_DrawCubes".}
proc ImGuizmo_DrawGrid*(view: ptr cfloat; projection: ptr cfloat; matrix: ptr cfloat; gridSize: cfloat): void {.cdecl, importc: "ImGuizmo_DrawGrid".}
proc ImGuizmo_DrawGridCustom*(view: ptr cfloat; projection: ptr cfloat; matrix: ptr cfloat; gridSize: cfloat; majorStep: cfloat; subdivision: cuint): void {.cdecl, importc: "ImGuizmo_DrawGridCustom".}
proc ImGuizmo_DrawGridCustomColor*(view: ptr cfloat; projection: ptr cfloat; matrix: ptr cfloat; gridSize: cfloat; majorStep: cfloat; subdivision: cuint; majorCol: ImU32; minorCol: ImU32; centerCol: ImU32): void {.cdecl, importc: "ImGuizmo_DrawGridCustomColor".}
proc ImGuizmo_Manipulate*(view: ptr cfloat; projection: ptr cfloat; operation: OPERATION; mode: MODE; matrix: ptr cfloat; deltaMatrix: ptr cfloat; snap: ptr cfloat; localBounds: ptr cfloat; boundsSnap: ptr cfloat): bool {.cdecl, importc: "ImGuizmo_Manipulate".}
proc ImGuizmo_ViewManipulate_Float*(view: ptr cfloat; length: cfloat; position: ImVec2_c; size: ImVec2_c; backgroundColor: ImU32): void {.cdecl, importc: "ImGuizmo_ViewManipulate_Float".}
proc ImGuizmo_ViewManipulate_FloatPtr*(view: ptr cfloat; projection: ptr cfloat; operation: OPERATION; mode: MODE; matrix: ptr cfloat; length: cfloat; position: ImVec2_c; size: ImVec2_c; backgroundColor: ImU32): void {.cdecl, importc: "ImGuizmo_ViewManipulate_FloatPtr".}
proc ImGuizmo_SetAlternativeWindow*(window: ptr ImGuiWindow): void {.cdecl, importc: "ImGuizmo_SetAlternativeWindow".}
proc ImGuizmo_SetID*(id: cint): void {.cdecl, importc: "ImGuizmo_SetID".}
proc ImGuizmo_PushID_Str*(str_id: cstring): void {.cdecl, importc: "ImGuizmo_PushID_Str".}
proc ImGuizmo_PushID_StrStr*(str_id_begin: cstring; str_id_end: cstring): void {.cdecl, importc: "ImGuizmo_PushID_StrStr".}
proc ImGuizmo_PushID_Ptr*(ptr_id: pointer): void {.cdecl, importc: "ImGuizmo_PushID_Ptr".}
proc ImGuizmo_PushID_Int*(int_id: cint): void {.cdecl, importc: "ImGuizmo_PushID_Int".}
proc ImGuizmo_PopID*(): void {.cdecl, importc: "ImGuizmo_PopID".}
proc ImGuizmo_GetID_Str*(str_id: cstring): ImGuiID {.cdecl, importc: "ImGuizmo_GetID_Str".}
proc ImGuizmo_GetID_StrStr*(str_id_begin: cstring; str_id_end: cstring): ImGuiID {.cdecl, importc: "ImGuizmo_GetID_StrStr".}
proc ImGuizmo_GetID_Ptr*(ptr_id: pointer): ImGuiID {.cdecl, importc: "ImGuizmo_GetID_Ptr".}
proc ImGuizmo_IsOver_OPERATION*(op: OPERATION): bool {.cdecl, importc: "ImGuizmo_IsOver_OPERATION".}
proc ImGuizmo_SetGizmoSizeClipSpace*(value: cfloat): void {.cdecl, importc: "ImGuizmo_SetGizmoSizeClipSpace".}
proc ImGuizmo_GetActiveHandleType*(): MOVETYPE {.cdecl, importc: "ImGuizmo_GetActiveHandleType".}
proc ImGuizmo_GetHoveredHandleType*(): MOVETYPE {.cdecl, importc: "ImGuizmo_GetHoveredHandleType".}
proc ImGuizmo_GetActiveMoveType*(): MOVETYPE {.cdecl, importc: "ImGuizmo_GetActiveMoveType".}
proc ImGuizmo_GetHoveredMoveType*(): MOVETYPE {.cdecl, importc: "ImGuizmo_GetHoveredMoveType".}
proc ImGuizmo_AllowAxisFlip*(value: bool): void {.cdecl, importc: "ImGuizmo_AllowAxisFlip".}
proc ImGuizmo_SetAxisLimit*(value: cfloat): void {.cdecl, importc: "ImGuizmo_SetAxisLimit".}
...
proc IgKnobFloat*(label: cstring; p_value: ptr cfloat; v_min: cfloat; v_max: cfloat; speed: cfloat; format: cstring; variant: IgKnobVariant; size: cfloat; flags: IgKnobFlags; steps: cint; angle_min: cfloat; angle_max: cfloat): bool {.cdecl, importc: "IgKnobFloat".}
proc IgKnobInt*(label: cstring; p_value: ptr cint; v_min: cint; v_max: cint; speed: cfloat; format: cstring; variant: IgKnobVariant; size: cfloat; flags: IgKnobFlags; steps: cint; angle_min: cfloat; angle_max: cfloat): bool {.cdecl, importc: "IgKnobInt".}
proc IGFD_FileDialog_Config_Get*(): struct_IGFD_FileDialog_Config {.cdecl, importc: "IGFD_FileDialog_Config_Get".}
proc IGFD_Selection_Pair_Get*(): IGFD_Selection_Pair {.cdecl, importc: "IGFD_Selection_Pair_Get".}
proc IGFD_Selection_Pair_DestroyContent*(vSelection_Pair: ptr IGFD_Selection_Pair): void {.cdecl, importc: "IGFD_Selection_Pair_DestroyContent".}
proc IGFD_Selection_Get*(): IGFD_Selection {.cdecl, importc: "IGFD_Selection_Get".}
proc IGFD_Selection_DestroyContent*(vSelection: ptr IGFD_Selection): void {.cdecl, importc: "IGFD_Selection_DestroyContent".}
proc IGFD_Create*(): ptr ImGuiFileDialog {.cdecl, importc: "IGFD_Create".}
proc IGFD_Destroy*(vContextPtr: ptr ImGuiFileDialog): void {.cdecl, importc: "IGFD_Destroy".}
proc IGFD_OpenDialog*(vContextPtr: ptr ImGuiFileDialog; vKey: cstring; vTitle: cstring; vFilters: cstring; vConfig: struct_IGFD_FileDialog_Config): void {.cdecl, importc: "IGFD_OpenDialog".}
proc IGFD_DisplayDialog*(vContextPtr: ptr ImGuiFileDialog; vKey: cstring; vFlags: ImGuiWindowFlags; vMinSize: ImVec2; vMaxSize: ImVec2): bool {.cdecl, importc: "IGFD_DisplayDialog".}
proc IGFD_CloseDialog*(vContextPtr: ptr ImGuiFileDialog): void {.cdecl, importc: "IGFD_CloseDialog".}
proc IGFD_IsOk*(vContextPtr: ptr ImGuiFileDialog): bool {.cdecl, importc: "IGFD_IsOk".}
proc IGFD_WasKeyOpenedThisFrame*(vContextPtr: ptr ImGuiFileDialog; vKey: cstring): bool {.cdecl, importc: "IGFD_WasKeyOpenedThisFrame".}
proc IGFD_WasOpenedThisFrame*(vContextPtr: ptr ImGuiFileDialog): bool {.cdecl, importc: "IGFD_WasOpenedThisFrame".}
proc IGFD_IsKeyOpened*(vContextPtr: ptr ImGuiFileDialog; vCurrentOpenedKey: cstring): bool {.cdecl, importc: "IGFD_IsKeyOpened".}
proc IGFD_IsOpened*(vContextPtr: ptr ImGuiFileDialog): bool {.cdecl, importc: "IGFD_IsOpened".}
proc IGFD_GetSelection*(vContextPtr: ptr ImGuiFileDialog; vMode: IGFD_ResultMode): IGFD_Selection {.cdecl, importc: "IGFD_GetSelection".}
proc IGFD_GetFilePathName*(vContextPtr: ptr ImGuiFileDialog; vMode: IGFD_ResultMode): cstring {.cdecl, importc: "IGFD_GetFilePathName".}
proc IGFD_GetCurrentFileName*(vContextPtr: ptr ImGuiFileDialog; vMode: IGFD_ResultMode): cstring {.cdecl, importc: "IGFD_GetCurrentFileName".}
proc IGFD_GetCurrentPath*(vContextPtr: ptr ImGuiFileDialog): cstring {.cdecl, importc: "IGFD_GetCurrentPath".}
proc IGFD_GetCurrentFilter*(vContextPtr: ptr ImGuiFileDialog): cstring {.cdecl, importc: "IGFD_GetCurrentFilter".}
proc IGFD_GetUserDatas*(vContextPtr: ptr ImGuiFileDialog): pointer {.cdecl, importc: "IGFD_GetUserDatas".}
proc IGFD_SetFileStyle*(vContextPtr: ptr ImGuiFileDialog; vFileStyleFlags: IGFD_FileStyleFlags; vFilter: cstring; vColor: ImVec4; vIconText: cstring; vFont: ptr ImFont): void {.cdecl, importc: "IGFD_SetFileStyle".}
proc IGFD_SetFileStyle2*(vContextPtr: ptr ImGuiFileDialog; vFileStyleFlags: IGFD_FileStyleFlags; vFilter: cstring; vR: cfloat; vG: cfloat; vB: cfloat; vA: cfloat; vIconText: cstring; vFont: ptr ImFont): void {.cdecl, importc: "IGFD_SetFileStyle2".}
proc IGFD_GetFileStyle*(vContextPtr: ptr ImGuiFileDialog; vFileStyleFlags: IGFD_FileStyleFlags; vFilter: cstring; vOutColor: ptr ImVec4; vOutIconText: ptr cstring; vOutFont: ptr ptr ImFont): bool {.cdecl, importc: "IGFD_GetFileStyle".}
proc IGFD_ClearFilesStyle*(vContextPtr: ptr ImGuiFileDialog): void {.cdecl, importc: "IGFD_ClearFilesStyle".}
proc SetLocales*(vContextPtr: ptr ImGuiFileDialog; vCategory: cint; vBeginLocale: cstring; vEndLocale: cstring): void {.cdecl, importc: "SetLocales".}
proc ImOffsetRect_GetAverage*(self: ptr ImOffsetRect): cfloat {.cdecl, importc: "ImOffsetRect_GetAverage".}
proc Toggle*(label: cstring; v: ptr bool; size: ImVec2): bool {.cdecl, importc: "Toggle".}
proc ToggleFlag*(label: cstring; v: ptr bool; flags: ImGuiToggleFlags; size: ImVec2): bool {.cdecl, importc: "ToggleFlag".}
proc ToggleAnim*(label: cstring; v: ptr bool; flags: ImGuiToggleFlags; animation_duration: cfloat; size: ImVec2): bool {.cdecl, importc: "ToggleAnim".}
proc ToggleCfg*(label: cstring; v: ptr bool; config: ImGuiToggleConfig): bool {.cdecl, importc: "ToggleCfg".}
proc ToggleRound*(label: cstring; v: ptr bool; flags: ImGuiToggleFlags; frame_rounding: cfloat; knob_rounding: cfloat; size: ImVec2): bool {.cdecl, importc: "ToggleRound".}
proc ToggleAnimRound*(label: cstring; v: ptr bool; flags: ImGuiToggleFlags; animation_duration: cfloat; frame_rounding: cfloat; knob_rounding: cfloat; size: ImVec2): bool {.cdecl, importc: "ToggleAnimRound".}
proc ImGuiTogglePresets_DefaultStyle*(): ImGuiToggleConfig {.cdecl, importc: "ImGuiTogglePresets_DefaultStyle".}
proc ImGuiTogglePresets_RectangleStyle*(): ImGuiToggleConfig {.cdecl, importc: "ImGuiTogglePresets_RectangleStyle".}
proc ImGuiTogglePresets_GlowingStyle*(): ImGuiToggleConfig {.cdecl, importc: "ImGuiTogglePresets_GlowingStyle".}
proc ImGuiTogglePresets_iOSStyle*(size_scale: cfloat; light_mode: bool): ImGuiToggleConfig {.cdecl, importc: "ImGuiTogglePresets_iOSStyle".}
...
proc ImGuiImage_Zoomable*(texRef: ImTextureRef; displaySize: ptr ImVec2; state: ptr ImGuiImageState): void {.cdecl, importc: "ImGuiImage_Zoomable".}
proc ImGuiImage_ZoomableUV*(texRef: ImTextureRef; displaySize: ptr ImVec2; uv0: ptr ImVec2; uv1: ptr ImVec2; state: ptr ImGuiImageState): void {.cdecl, importc: "ImGuiImage_ZoomableUV".}
proc ImGuiImage_ZoomableFull*(texRef: ImTextureRef; displaySize: ptr ImVec2; uv0: ptr ImVec2; uv1: ptr ImVec2; bgColor: ptr ImVec4; tintColor: ptr ImVec4; state: ptr ImGuiImageState): void {.cdecl, importc: "ImGuiImage_ZoomableFull".}
