...
type
  enum_PaletteId* {.size: sizeof(cuint).} = enum
    Dark = 0, Light = 1, Mariana = 2, RetroBlue = 3
type
  enum_LanguageDefinitionId* {.size: sizeof(cuint).} = enum
    None = 0, Cpp = 1, C = 2, Cs = 3, Python = 4, Lua = 5, Json = 6, Sql = 7,
    AngelScript = 8, Glsl = 9, Hlsl = 10
type
  enum_SetViewAtLineMode* {.size: sizeof(cuint).} = enum
    FirstVisibleLine = 0, Centered = 1, LastVisibleLine = 2
type
...
proc igSetWindowFontScale*(scale: cfloat): void {.cdecl, importc: "igSetWindowFontScale".}
...
proc igTextLinkOpenURL*(label: cstring; url: cstring): void {.cdecl, importc: "igTextLinkOpenURL".}
proc igImage*(user_texture_id: ImTextureID; image_size: ImVec2; uv0: ImVec2; uv1: ImVec2; tint_col: ImVec4; border_col: ImVec4): void {.cdecl, importc: "igImage".}
proc igImageButton*(str_id: cstring; user_texture_id: ImTextureID; image_size: ImVec2; uv0: ImVec2; uv1: ImVec2; bg_col: ImVec4; tint_col: ImVec4): bool {.cdecl, importc: "igImageButton".}
...
proc igSetItemKeyOwner_Nil*(key: ImGuiKey): void {.cdecl, importc: "igSetItemKeyOwner_Nil".}
...
proc ImDrawList_PushTextureID*(self: ptr ImDrawList; texture_id: ImTextureID): void {.cdecl, importc: "ImDrawList_PushTextureID".}
proc ImDrawList_PopTextureID*(self: ptr ImDrawList): void {.cdecl, importc: "ImDrawList_PopTextureID".}
...
proc ImDrawList_AddImage*(self: ptr ImDrawList; user_texture_id: ImTextureID; p_min: ImVec2; p_max: ImVec2; uv_min: ImVec2; uv_max: ImVec2; col: ImU32): void {.cdecl, importc: "ImDrawList_AddImage".}
proc ImDrawList_AddImageQuad*(self: ptr ImDrawList; user_texture_id: ImTextureID; p1: ImVec2; p2: ImVec2; p3: ImVec2; p4: ImVec2; uv1: ImVec2; uv2: ImVec2; uv3: ImVec2; uv4: ImVec2; col: ImU32): void {.cdecl, importc: "ImDrawList_AddImageQuad".}
proc ImDrawList_AddImageRounded*(self: ptr ImDrawList; user_texture_id: ImTextureID; p_min: ImVec2; p_max: ImVec2; uv_min: ImVec2; uv_max: ImVec2; col: ImU32; rounding: cfloat; flags: ImDrawFlags): void {.cdecl, importc: "ImDrawList_AddImageRounded".}
...
proc ImDrawList_OnChangedTextureID*(self: ptr ImDrawList): void {.cdecl, importc: "ImDrawList__OnChangedTextureID".}
proc ImDrawList_OnChangedVtxOffset*(self: ptr ImDrawList): void {.cdecl, importc: "ImDrawList__OnChangedVtxOffset".}
proc ImDrawList_SetTextureID*(self: ptr ImDrawList; texture_id: ImTextureID): void {.cdecl, importc: "ImDrawList__SetTextureID".}
...
proc ImFontAtlasCustomRect_ImFontAtlasCustomRect*(): ptr ImFontAtlasCustomRect {.cdecl, importc: "ImFontAtlasCustomRect_ImFontAtlasCustomRect".}
proc ImFontAtlasCustomRect_destroy*(self: ptr ImFontAtlasCustomRect): void {.cdecl, importc: "ImFontAtlasCustomRect_destroy".}
proc ImFontAtlasCustomRect_IsPacked*(self: ptr ImFontAtlasCustomRect): bool {.cdecl, importc: "ImFontAtlasCustomRect_IsPacked".}
...
proc ImFontAtlas_Build*(self: ptr ImFontAtlas): bool {.cdecl, importc: "ImFontAtlas_Build".}
proc ImFontAtlas_GetTexDataAsAlpha8*(self: ptr ImFontAtlas; out_pixels: ptr ptr uint8; out_width: ptr cint; out_height: ptr cint; out_bytes_per_pixel: ptr cint): void {.cdecl, importc: "ImFontAtlas_GetTexDataAsAlpha8".}
proc ImFontAtlas_GetTexDataAsRGBA32*(self: ptr ImFontAtlas; out_pixels: ptr ptr uint8; out_width: ptr cint; out_height: ptr cint; out_bytes_per_pixel: ptr cint): void {.cdecl, importc: "ImFontAtlas_GetTexDataAsRGBA32".}
proc ImFontAtlas_IsBuilt*(self: ptr ImFontAtlas): bool {.cdecl, importc: "ImFontAtlas_IsBuilt".}
proc ImFontAtlas_SetTexID*(self: ptr ImFontAtlas; id: ImTextureID): void {.cdecl, importc: "ImFontAtlas_SetTexID".}
proc ImFontAtlas_GetGlyphRangesDefault*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesDefault".}
proc ImFontAtlas_GetGlyphRangesGreek*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesGreek".}
proc ImFontAtlas_GetGlyphRangesKorean*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesKorean".}
proc ImFontAtlas_GetGlyphRangesJapanese*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesJapanese".}
proc ImFontAtlas_GetGlyphRangesChineseFull*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesChineseFull".}
proc ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon".}
proc ImFontAtlas_GetGlyphRangesCyrillic*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesCyrillic".}
proc ImFontAtlas_GetGlyphRangesThai*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesThai".}
proc ImFontAtlas_GetGlyphRangesVietnamese*(self: ptr ImFontAtlas): ptr ImWchar {.cdecl, importc: "ImFontAtlas_GetGlyphRangesVietnamese".}
proc ImFontAtlas_AddCustomRectRegular*(self: ptr ImFontAtlas; width: cint; height: cint): cint {.cdecl, importc: "ImFontAtlas_AddCustomRectRegular".}
proc ImFontAtlas_AddCustomRectFontGlyph*(self: ptr ImFontAtlas; font: ptr ImFont; id: ImWchar; width: cint; height: cint; advance_x: cfloat; offset: ImVec2): cint {.cdecl, importc: "ImFontAtlas_AddCustomRectFontGlyph".}
proc ImFontAtlas_GetCustomRectByIndex*(self: ptr ImFontAtlas; index: cint): ptr ImFontAtlasCustomRect {.cdecl, importc: "ImFontAtlas_GetCustomRectByIndex".}
proc ImFontAtlas_CalcCustomRectUV*(self: ptr ImFontAtlas; rect: ptr ImFontAtlasCustomRect; out_uv_min: ptr ImVec2; out_uv_max: ptr ImVec2): void {.cdecl, importc: "ImFontAtlas_CalcCustomRectUV".}
proc ImFontAtlas_GetMouseCursorTexData*(self: ptr ImFontAtlas; cursor: ImGuiMouseCursor; out_offset: ptr ImVec2; out_size: ptr ImVec2; out_uv_border: array[2'i64, ImVec2]; out_uv_fill: array[2'i64, ImVec2]): bool {.cdecl, importc: "ImFontAtlas_GetMouseCursorTexData".}
...
proc ImFont_FindGlyph*(self: ptr ImFont; c: ImWchar): ptr ImFontGlyph {.cdecl, importc: "ImFont_FindGlyph".}
proc ImFont_FindGlyphNoFallback*(self: ptr ImFont; c: ImWchar): ptr ImFontGlyph {.cdecl, importc: "ImFont_FindGlyphNoFallback".}
proc ImFont_GetCharAdvance*(self: ptr ImFont; c: ImWchar): cfloat {.cdecl, importc: "ImFont_GetCharAdvance".}
...
proc ImFont_CalcWordWrapPositionA*(self: ptr ImFont; scale: cfloat; text: cstring; text_end: cstring; wrap_width: cfloat): cstring {.cdecl, importc: "ImFont_CalcWordWrapPositionA".}
proc ImFont_RenderChar*(self: ptr ImFont; draw_list: ptr ImDrawList; size: cfloat; pos: ImVec2; col: ImU32; c: ImWchar): void {.cdecl, importc: "ImFont_RenderChar".}
...
proc ImFont_BuildLookupTable*(self: ptr ImFont): void {.cdecl, importc: "ImFont_BuildLookupTable".}
proc ImFont_ClearOutputData*(self: ptr ImFont): void {.cdecl, importc: "ImFont_ClearOutputData".}
proc ImFont_GrowIndex*(self: ptr ImFont; new_size: cint): void {.cdecl, importc: "ImFont_GrowIndex".}
proc ImFont_AddGlyph*(self: ptr ImFont; src_cfg: ptr ImFontConfig; c: ImWchar; x0: cfloat; y0: cfloat; x1: cfloat; y1: cfloat; u0: cfloat; v0: cfloat; u1: cfloat; v1: cfloat; advance_x: cfloat): void {.cdecl, importc: "ImFont_AddGlyph".}
proc ImFont_AddRemapChar*(self: ptr ImFont; dst: ImWchar; src: ImWchar; overwrite_dst: bool): void {.cdecl, importc: "ImFont_AddRemapChar".}
proc ImFont_SetGlyphVisible*(self: ptr ImFont; c: ImWchar; visible: bool): void {.cdecl, importc: "ImFont_SetGlyphVisible".}
...
proc igImTextCharToUtf8*(out_buf: array[5'i64, cschar]; c: cuint): cstring {.cdecl, importc: "igImTextCharToUtf8".}
...
proc ImGuiDataVarInfo_GetVarPtr*(self: ptr ImGuiDataVarInfo; parent: pointer): pointer {.cdecl, importc: "ImGuiDataVarInfo_GetVarPtr".}
...
proc ImGuiWindow_CalcFontSize*(self: ptr ImGuiWindow): cfloat {.cdecl, importc: "ImGuiWindow_CalcFontSize".}
...
proc igGetIOEx*(ctx: ptr ImGuiContext): ptr ImGuiIO {.cdecl, importc: "igGetIOEx".}
proc igGetPlatformIOEx*(ctx: ptr ImGuiContext): ptr ImGuiPlatformIO {.cdecl, importc: "igGetPlatformIOEx".}
...
proc igSetCurrentFont*(font: ptr ImFont): void {.cdecl, importc: "igSetCurrentFont".}
...
proc igUpdateHoveredWindowAndCaptureFlags*(): void {.cdecl, importc: "igUpdateHoveredWindowAndCaptureFlags".}
...
proc igShrinkWidths*(items: ptr ImGuiShrinkWidthItem; count: cint; width_excess: cfloat): void {.cdecl, importc: "igShrinkWidths".}
proc igGetStyleVarInfo*(idx: ImGuiStyleVar): ptr ImGuiDataVarInfo {.cdecl, importc: "igGetStyleVarInfo".}
...
proc igSetItemKeyOwner_InputFlags*(key: ImGuiKey; flags: ImGuiInputFlags): void {.cdecl, importc: "igSetItemKeyOwner_InputFlags".}
...
proc igRenderTextEllipsis*(draw_list: ptr ImDrawList; pos_min: ImVec2; pos_max: ImVec2; clip_max_x: cfloat; ellipsis_max_x: cfloat; text: cstring; text_end: cstring; text_size_if_known: ptr ImVec2): void {.cdecl, importc: "igRenderTextEllipsis".}
...
proc igImageButtonEx*(id: ImGuiID; user_texture_id: ImTextureID; image_size: ImVec2; uv0: ImVec2; uv1: ImVec2; bg_col: ImVec4; tint_col: ImVec4; flags: ImGuiButtonFlags): bool {.cdecl, importc: "igImageButtonEx".}
...
proc igImFontAtlasGetBuilderForStbTruetype*(): ptr ImFontBuilderIO {.cdecl, importc: "igImFontAtlasGetBuilderForStbTruetype".}
proc igImFontAtlasUpdateConfigDataPointers*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igImFontAtlasUpdateConfigDataPointers".}
proc igImFontAtlasBuildInit*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igImFontAtlasBuildInit".}
proc igImFontAtlasBuildSetupFont*(atlas: ptr ImFontAtlas; font: ptr ImFont; font_config: ptr ImFontConfig; ascent: cfloat; descent: cfloat): void {.cdecl, importc: "igImFontAtlasBuildSetupFont".}
proc igImFontAtlasBuildPackCustomRects*(atlas: ptr ImFontAtlas; stbrp_context_opaque: pointer): void {.cdecl, importc: "igImFontAtlasBuildPackCustomRects".}
proc igImFontAtlasBuildFinish*(atlas: ptr ImFontAtlas): void {.cdecl, importc: "igImFontAtlasBuildFinish".}
proc igImFontAtlasBuildRender8bppRectFromString*(atlas: ptr ImFontAtlas; x: cint; y: cint; w: cint; h: cint; in_str: cstring; in_marker_char: cschar; in_marker_pixel_value: uint8): void {.cdecl, importc: "igImFontAtlasBuildRender8bppRectFromString".}
proc igImFontAtlasBuildRender32bppRectFromString*(atlas: ptr ImFontAtlas; x: cint; y: cint; w: cint; h: cint; in_str: cstring; in_marker_char: cschar; in_marker_pixel_value: cuint): void {.cdecl, importc: "igImFontAtlasBuildRender32bppRectFromString".}
proc igImFontAtlasBuildMultiplyCalcLookupTable*(out_table: array[256'i64, uint8]; in_multiply_factor: cfloat): void {.cdecl, importc: "igImFontAtlasBuildMultiplyCalcLookupTable".}
proc igImFontAtlasBuildMultiplyRectAlpha8*(table: array[256'i64, uint8]; pixels: ptr uint8; x: cint; y: cint; w: cint; h: cint; stride: cint): void {.cdecl, importc: "igImFontAtlasBuildMultiplyRectAlpha8".}
proc igImFontAtlasBuildGetOversampleFactors*(cfg: ptr ImFontConfig; out_oversample_h: ptr cint; out_oversample_v: ptr cint): void {.cdecl, importc: "igImFontAtlasBuildGetOversampleFactors".}
...
proc ImPlot_PlotHistogram_FloatPtr*(label_id: cstring; values: ptr cfloat; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_FloatPtr".}
proc ImPlot_PlotHistogram_doublePtr*(label_id: cstring; values: ptr cdouble; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_doublePtr".}
proc ImPlot_PlotHistogram_S8Ptr*(label_id: cstring; values: cstring; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_S8Ptr".}
proc ImPlot_PlotHistogram_U8Ptr*(label_id: cstring; values: ptr ImU8; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_U8Ptr".}
proc ImPlot_PlotHistogram_S16Ptr*(label_id: cstring; values: ptr ImS16; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_S16Ptr".}
proc ImPlot_PlotHistogram_U16Ptr*(label_id: cstring; values: ptr ImU16; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_U16Ptr".}
proc ImPlot_PlotHistogram_S32Ptr*(label_id: cstring; values: ptr ImS32; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_S32Ptr".}
proc ImPlot_PlotHistogram_U32Ptr*(label_id: cstring; values: ptr ImU32; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_U32Ptr".}
proc ImPlot_PlotHistogram_S64Ptr*(label_id: cstring; values: ptr ImS64; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_S64Ptr".}
proc ImPlot_PlotHistogram_U64Ptr*(label_id: cstring; values: ptr ImU64; count: cint; bins: cint; bar_scale: cdouble; range_arg: ImPlotRange; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram_U64Ptr".}
proc ImPlot_PlotHistogram2D_FloatPtr*(label_id: cstring; xs: ptr cfloat; ys: ptr cfloat; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_FloatPtr".}
proc ImPlot_PlotHistogram2D_doublePtr*(label_id: cstring; xs: ptr cdouble; ys: ptr cdouble; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_doublePtr".}
proc ImPlot_PlotHistogram2D_S8Ptr*(label_id: cstring; xs: cstring; ys: cstring; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_S8Ptr".}
proc ImPlot_PlotHistogram2D_U8Ptr*(label_id: cstring; xs: ptr ImU8; ys: ptr ImU8; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_U8Ptr".}
proc ImPlot_PlotHistogram2D_S16Ptr*(label_id: cstring; xs: ptr ImS16; ys: ptr ImS16; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_S16Ptr".}
proc ImPlot_PlotHistogram2D_U16Ptr*(label_id: cstring; xs: ptr ImU16; ys: ptr ImU16; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_U16Ptr".}
proc ImPlot_PlotHistogram2D_S32Ptr*(label_id: cstring; xs: ptr ImS32; ys: ptr ImS32; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_S32Ptr".}
proc ImPlot_PlotHistogram2D_U32Ptr*(label_id: cstring; xs: ptr ImU32; ys: ptr ImU32; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_U32Ptr".}
proc ImPlot_PlotHistogram2D_S64Ptr*(label_id: cstring; xs: ptr ImS64; ys: ptr ImS64; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_S64Ptr".}
proc ImPlot_PlotHistogram2D_U64Ptr*(label_id: cstring; xs: ptr ImU64; ys: ptr ImU64; count: cint; x_bins: cint; y_bins: cint; range_arg: ImPlotRect; flags: ImPlotHistogramFlags): cdouble {.cdecl, importc: "ImPlot_PlotHistogram2D_U64Ptr".}
...
proc ImPlotAxis_SetRange_PlotRange*(self: ptr ImPlotAxis; range_arg: ImPlotRange): void {.cdecl, importc: "ImPlotAxis_SetRange_PlotRange".}
...
proc ImPlot_CalculateBins_FloatPtr*(values: ptr cfloat; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_FloatPtr".}
proc ImPlot_CalculateBins_doublePtr*(values: ptr cdouble; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_doublePtr".}
proc ImPlot_CalculateBins_S8Ptr*(values: cstring; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_S8Ptr".}
proc ImPlot_CalculateBins_U8Ptr*(values: ptr ImU8; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_U8Ptr".}
proc ImPlot_CalculateBins_S16Ptr*(values: ptr ImS16; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_S16Ptr".}
proc ImPlot_CalculateBins_U16Ptr*(values: ptr ImU16; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_U16Ptr".}
proc ImPlot_CalculateBins_S32Ptr*(values: ptr ImS32; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_S32Ptr".}
proc ImPlot_CalculateBins_U32Ptr*(values: ptr ImU32; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_U32Ptr".}
proc ImPlot_CalculateBins_S64Ptr*(values: ptr ImS64; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_S64Ptr".}
proc ImPlot_CalculateBins_U64Ptr*(values: ptr ImU64; count: cint; meth: ImPlotBin; range_arg: ImPlotRange; bins_out: ptr cint; width_out: ptr cdouble): void {.cdecl, importc: "ImPlot_CalculateBins_U64Ptr".}
...
proc ImPlot_Locator_Default*(ticker: ptr ImPlotTicker; range_arg: ImPlotRange; pixels: cfloat; vertical: bool; formatter: ImPlotFormatter; formatter_data: pointer): void {.cdecl, importc: "ImPlot_Locator_Default".}
proc ImPlot_Locator_Time*(ticker: ptr ImPlotTicker; range_arg: ImPlotRange; pixels: cfloat; vertical: bool; formatter: ImPlotFormatter; formatter_data: pointer): void {.cdecl, importc: "ImPlot_Locator_Time".}
proc ImPlot_Locator_Log10*(ticker: ptr ImPlotTicker; range_arg: ImPlotRange; pixels: cfloat; vertical: bool; formatter: ImPlotFormatter; formatter_data: pointer): void {.cdecl, importc: "ImPlot_Locator_Log10".}
proc ImPlot_Locator_SymLog*(ticker: ptr ImPlotTicker; range_arg: ImPlotRange; pixels: cfloat; vertical: bool; formatter: ImPlotFormatter; formatter_data: pointer): void {.cdecl, importc: "ImPlot_Locator_SymLog".}
...
proc ImPlot3D_SetupAxisFormat*(idx: ImAxis3D; formatter: ImPlot3DFormatter; data: pointer): void {.cdecl, importc: "ImPlot3D_SetupAxisFormat".}
...
proc ImPlot3DStyle_ImPlot3DStyle*(): ptr ImPlot3DStyle {.cdecl, importc: "ImPlot3DStyle_ImPlot3DStyle".}
...
proc SpinnerThickToSinEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; lt: cint; mode: cint): void {.cdecl, importc: "SpinnerThickToSinEx".}
...
proc SpinnerRainbowBallsEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; balls: cint; mode: cint): void {.cdecl, importc: "SpinnerRainbowBallsEx".}
...
proc SpinnerRainbowShotEx*(label: cstring; radius: cfloat; thickness: cfloat; color: ImColor; speed: cfloat; balls: cint): void {.cdecl, importc: "SpinnerRainbowShotEx".}
...
proc TextEditor_SetReadOnlyEnabled*(self: ptr TextEditor; aValue: bool): void {.cdecl, importc: "TextEditor_SetReadOnlyEnabled".}
proc TextEditor_IsReadOnlyEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsReadOnlyEnabled".}
proc TextEditor_SetAutoIndentEnabled*(self: ptr TextEditor; aValue: bool): void {.cdecl, importc: "TextEditor_SetAutoIndentEnabled".}
proc TextEditor_IsAutoIndentEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsAutoIndentEnabled".}
proc TextEditor_SetShowWhitespacesEnabled*(self: ptr TextEditor; aValue: bool): void {.cdecl, importc: "TextEditor_SetShowWhitespacesEnabled".}
proc TextEditor_IsShowWhitespacesEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsShowWhitespacesEnabled".}
proc TextEditor_SetShowLineNumbersEnabled*(self: ptr TextEditor; aValue: bool): void {.cdecl, importc: "TextEditor_SetShowLineNumbersEnabled".}
proc TextEditor_IsShowLineNumbersEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsShowLineNumbersEnabled".}
proc TextEditor_SetShortTabsEnabled*(self: ptr TextEditor; aValue: bool): void {.cdecl, importc: "TextEditor_SetShortTabsEnabled".}
proc TextEditor_IsShortTabsEnabled*(self: ptr TextEditor): bool {.cdecl, importc: "TextEditor_IsShortTabsEnabled".}
...
proc TextEditor_SetPalette*(self: ptr TextEditor; aValue: PaletteId): void {.cdecl, importc: "TextEditor_SetPalette".}
proc TextEditor_GetPalette*(self: ptr TextEditor): PaletteId {.cdecl, importc: "TextEditor_GetPalette".}
proc TextEditor_SetLanguageDefinition*(self: ptr TextEditor; aValue: LanguageDefinitionId): void {.cdecl, importc: "TextEditor_SetLanguageDefinition".}
proc TextEditor_GetLanguageDefinition*(self: ptr TextEditor): LanguageDefinitionId {.cdecl, importc: "TextEditor_GetLanguageDefinition".}
proc TextEditor_GetLanguageDefinitionName*(self: ptr TextEditor): cstring {.cdecl, importc: "TextEditor_GetLanguageDefinitionName".}
proc TextEditor_SetTabSize*(self: ptr TextEditor; aValue: cint): void {.cdecl, importc: "TextEditor_SetTabSize".}
proc TextEditor_GetTabSize*(self: ptr TextEditor): cint {.cdecl, importc: "TextEditor_GetTabSize".}
proc TextEditor_SetLineSpacing*(self: ptr TextEditor; aValue: cfloat): void {.cdecl, importc: "TextEditor_SetLineSpacing".}
proc TextEditor_GetLineSpacing*(self: ptr TextEditor): cfloat {.cdecl, importc: "TextEditor_GetLineSpacing".}
proc TextEditor_SetDefaultPalette*(aValue: PaletteId): void {.cdecl, importc: "TextEditor_SetDefaultPalette".}
proc TextEditor_GetDefaultPalette*(): PaletteId {.cdecl, importc: "TextEditor_GetDefaultPalette".}
proc TextEditor_SelectAll*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_SelectAll".}
proc TextEditor_SelectLine*(self: ptr TextEditor; aLine: cint): void {.cdecl, importc: "TextEditor_SelectLine".}
proc TextEditor_SelectRegion*(self: ptr TextEditor; aStartLine: cint; aStartChar: cint; aEndLine: cint; aEndChar: cint): void {.cdecl, importc: "TextEditor_SelectRegion".}
proc TextEditor_SelectNextOccurrenceOf*(self: ptr TextEditor; aText: cstring; aTextSize: cint; aCaseSensitive: bool): void {.cdecl, importc: "TextEditor_SelectNextOccurrenceOf".}
proc TextEditor_SelectAllOccurrencesOf*(self: ptr TextEditor; aText: cstring; aTextSize: cint; aCaseSensitive: bool): void {.cdecl, importc: "TextEditor_SelectAllOccurrencesOf".}
...
proc TextEditor_ClearExtraCursors*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_ClearExtraCursors".}
proc TextEditor_ClearSelections*(self: ptr TextEditor): void {.cdecl, importc: "TextEditor_ClearSelections".}
proc TextEditor_SetCursorPosition*(self: ptr TextEditor; aLine: cint; aCharIndex: cint): void {.cdecl, importc: "TextEditor_SetCursorPosition".}
proc TextEditor_GetCursorPosition*(self: ptr TextEditor; outLine: ptr cint; outColumn: ptr cint): void {.cdecl, importc: "TextEditor_GetCursorPosition".}
...
proc TextEditor_SetViewAtLine*(self: ptr TextEditor; aLine: cint; aMode: SetViewAtLineMode): void {.cdecl, importc: "TextEditor_SetViewAtLine".}
...
proc TextEditor_Undo*(self: ptr TextEditor; aSteps: cint): void {.cdecl, importc: "TextEditor_Undo".}
proc TextEditor_Redo*(self: ptr TextEditor; aSteps: cint): void {.cdecl, importc: "TextEditor_Redo".}
...
proc imnodes_EditorContextGetPanning*(pOut: ptr ImVec2): void {.cdecl, importc: "imnodes_EditorContextGetPanning".}
proc imnodes_EditorContextResetPanning*(pos: ImVec2): void {.cdecl, importc: "imnodes_EditorContextResetPanning".}
...
proc imnodes_PushStyleVar_Vec2*(style_item: ImNodesStyleVar; value: ImVec2): void {.cdecl, importc: "imnodes_PushStyleVar_Vec2".}
...
proc imnodes_GetNodeDimensions*(pOut: ptr ImVec2; id: cint): void {.cdecl, importc: "imnodes_GetNodeDimensions".}
...
proc imnodes_SetNodeScreenSpacePos*(node_id: cint; screen_space_pos: ImVec2): void {.cdecl, importc: "imnodes_SetNodeScreenSpacePos".}
proc imnodes_SetNodeEditorSpacePos*(node_id: cint; editor_space_pos: ImVec2): void {.cdecl, importc: "imnodes_SetNodeEditorSpacePos".}
proc imnodes_SetNodeGridSpacePos*(node_id: cint; grid_pos: ImVec2): void {.cdecl, importc: "imnodes_SetNodeGridSpacePos".}
proc imnodes_GetNodeScreenSpacePos*(pOut: ptr ImVec2; node_id: cint): void {.cdecl, importc: "imnodes_GetNodeScreenSpacePos".}
proc imnodes_GetNodeEditorSpacePos*(pOut: ptr ImVec2; node_id: cint): void {.cdecl, importc: "imnodes_GetNodeEditorSpacePos".}
proc imnodes_GetNodeGridSpacePos*(pOut: ptr ImVec2; node_id: cint): void {.cdecl, importc: "imnodes_GetNodeGridSpacePos".}
...
proc ImGuizmo_ViewManipulate_Float*(view: ptr cfloat; length: cfloat; position: ImVec2; size: ImVec2; backgroundColor: ImU32): void {.cdecl, importc: "ImGuizmo_ViewManipulate_Float".}
proc ImGuizmo_ViewManipulate_FloatPtr*(view: ptr cfloat; projection: ptr cfloat; operation: OPERATION; mode: MODE; matrix: ptr cfloat; length: cfloat; position: ImVec2; size: ImVec2; backgroundColor: ImU32): void {.cdecl, importc: "ImGuizmo_ViewManipulate_FloatPtr".}
