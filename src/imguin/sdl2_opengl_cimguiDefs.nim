...
type
  ...
  File_93324242 = structiobuf_93324603 ## Generated based on D:/msys32/mingw32/include/stdio.h:47:25
  ...
  Sdlwindow_93324596 = structsdlwindow ## Generated based on C:\00nim-d\imguin\src\private\cimgui/generator/output/cimgui_impl.h:48:27
  Sdlrenderer_93324598 = structsdlrenderer ## Generated based on C:\00nim-d\imguin\src\private\cimgui/generator/output/cimgui_impl.h:49:29
  Sdlevent_93324600 = unionsdlevent ## Generated based on C:\00nim-d\imguin\src\private\cimgui/generator/output/cimgui_impl.h:52:25
  structiobuf_93324602 {.pure, inheritable, bycopy.} = object
  ...
  Sdlwindow_93324597 = (when declared(Sdlwindow):
    Sdlwindow
   else:
    Sdlwindow_93324596)
  ...
  Sdlevent_93324601 = (when declared(Sdlevent):
    Sdlevent
   else:
    Sdlevent_93324600)
  ...
  structiobuf_93324603 = (when declared(structiobuf):
    structiobuf
   else:
    structiobuf_93324602)
  ...
  Sdlrenderer_93324599 = (when declared(Sdlrenderer):
    Sdlrenderer
   else:
    Sdlrenderer_93324598)
...
when not declared(structiobuf):
  type
    structiobuf* = structiobuf_93324602
else:
  static :
...
when not declared(Sdlrenderer):
  type
    Sdlrenderer* = Sdlrenderer_93324598
else:
  static :
...
when not declared(Imguiimplsdl2initforopengl):
  proc Imguiimplsdl2initforopengl*(window: ptr Sdlwindow_93324597;
...
when not declared(Imguiimplsdl2initforvulkan):
  proc Imguiimplsdl2initforvulkan*(window: ptr Sdlwindow_93324597): bool {.
...
when not declared(Imguiimplsdl2initford3d):
  proc Imguiimplsdl2initford3d*(window: ptr Sdlwindow_93324597): bool {.cdecl,
...
when not declared(Imguiimplsdl2initformetal):
  proc Imguiimplsdl2initformetal*(window: ptr Sdlwindow_93324597): bool {.cdecl,
...
when not declared(Imguiimplsdl2initforsdlrenderer):
  proc Imguiimplsdl2initforsdlrenderer*(window: ptr Sdlwindow_93324597;
                                        renderer: ptr Sdlrenderer_93324599): bool {.
...
when not declared(Imguiimplsdl2processevent):
  proc Imguiimplsdl2processevent*(event: ptr Sdlevent_93324601): bool {.cdecl,
